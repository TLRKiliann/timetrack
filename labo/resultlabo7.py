...
from labo.recorderesult.recrslt7 import checkerecord7
from labo.uploadreclab.uploadrslt7 import uploadata7

from labo.funcplatform.resultfunc7 import funcOsLab7
from labo.funcplatform.resultfunc7 import funcOsMicrobio7
from labo.funcplatform.resultfunc7 import callingOsRslt7
...
def callLabo7(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest7.py', check=True)
