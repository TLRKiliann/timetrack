...
from labo.recorderesult.recrslt5 import checkerecord5
from labo.uploadreclab.uploadrslt5 import uploadata5

from labo.funcplatform.resultfunc5 import funcOsLab5
from labo.funcplatform.resultfunc5 import funcOsMicrobio5
from labo.funcplatform.resultfunc5 import callingOsRslt5
...
def callLabo5(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest5.py', check=True)
