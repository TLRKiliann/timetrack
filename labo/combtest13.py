...
def recordOption():
    ...
    with open('./need/doc_suivi13/patient13_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result13.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if proc.stderr == b'':
        print("+ File patient13_14b.txt uploaded !")
        messagebox.showinfo("INFO", "patient13_14b.txt uploaded...")
    else:
    ...
    if secproc.stderr == b'':
        print("+ File result13.txt uploaded !")
        messagebox.showinfo("INFO", "result13.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result13.txt to upload...")
