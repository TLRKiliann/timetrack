...
def recordOption():
    ...
    with open('./need/doc_suivi20/patient20_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result20.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if secproc.stderr == b'':
        print("+ File result20.txt uploaded !")
        messagebox.showinfo("INFO", "result20.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result20.txt to upload...")
