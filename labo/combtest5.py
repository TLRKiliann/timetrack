...
def recordOption():
    ...
    with open('./need/doc_suivi5/patient5_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result5.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if proc.stderr == b'':
        print("+ File patient5_14b.txt uploaded !")
        messagebox.showinfo("INFO", "patient5_14b.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No patient5_14b.txt to upload...")
    ...
    if secproc.stderr == b'':
        print("+ File result5.txt uploaded !")
        messagebox.showinfo("INFO", "result5.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result5.txt to upload...")
