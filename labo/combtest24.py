...
def recordOption():
    ...
    with open('./need/doc_suivi24/patient24_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result24.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if proc.stderr == b'':
        print("+ File patient24_14b.txt uploaded !")
        messagebox.showinfo("INFO", "patient24_14b.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No patient24_14b.txt to upload...")
    ...
    if secproc.stderr == b'':
        print("+ File result24.txt uploaded !")
        messagebox.showinfo("INFO", "result24.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result24.txt to upload...")
