...
from labo.recorderesult.recrslt10 import checkerecord10
from labo.uploadreclab.uploadrslt10 import uploadata10

from labo.funcplatform.resultfunc10 import funcOsLab10
from labo.funcplatform.resultfunc10 import funcOsMicrobio10
from labo.funcplatform.resultfunc10 import callingOsRslt10
...
def callLabo10(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest10.py', check=True)
