...
from labo.recorderesult.recrslt24 import checkerecord24
from labo.uploadreclab.uploadrslt24 import uploadata24

from labo.funcplatform.resultfunc24 import funcOsLab24
from labo.funcplatform.resultfunc24 import funcOsMicrobio24
from labo.funcplatform.resultfunc24 import callingOsRslt24
...
def callLabo24(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest24.py', check=True)
