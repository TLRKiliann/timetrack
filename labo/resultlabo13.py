...
from labo.recorderesult.recrslt13 import checkerecord13
from labo.uploadreclab.uploadrslt13 import uploadata13

from labo.funcplatform.resultfunc13 import funcOsLab13
from labo.funcplatform.resultfunc13 import funcOsMicrobio13
from labo.funcplatform.resultfunc13 import callingOsRslt13
...
def callLabo13(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest13.py', check=True)
