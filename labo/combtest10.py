...
def recordOption():
    ...
    with open('./need/doc_suivi10/patient10_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result10.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if proc.stderr == b'':
        print("+ File patient10_14b.txt uploaded !")
        messagebox.showinfo("INFO", "patient10_14b.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No patient10_14b.txt to upload...")
    ...
    if secproc.stderr == b'':
        print("+ File result10.txt uploaded !")
        messagebox.showinfo("INFO", "result10.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result10.txt to upload...")
