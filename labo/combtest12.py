...
def recordOption():
    ...
    with open('./need/doc_suivi12/patient12_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result12.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if proc.stderr == b'':
        print("+ File patient12_14b.txt uploaded !")
        messagebox.showinfo("INFO", "patient12_14b.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No patient12_14b.txt to upload...")
    ...
    if secproc.stderr == b'':
        print("+ File result12.txt uploaded !")
        messagebox.showinfo("INFO", "result12.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result12.txt to upload...")
