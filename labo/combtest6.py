...
def recordOption():
    ...
    with open('./need/doc_suivi6/patient6_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result6.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if proc.stderr == b'':
        print("+ File patient6_14b.txt uploaded !")
        messagebox.showinfo("INFO", "patient6_14b.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No patient6_14b.txt to upload...")
    ...
    if secproc.stderr == b'':
        print("+ File result6.txt uploaded !")
        messagebox.showinfo("INFO", "result6.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result6.txt to upload...")
