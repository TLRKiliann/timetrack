...
def recordOption():
    ...
    with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result16.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if proc.stderr == b'':
        print("+ File patient16_14b.txt uploaded !")
        messagebox.showinfo("INFO", "patient16_14b.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No patient16_14b.txt to upload...")
    ...
    if secproc.stderr == b'':
        print("+ File result16.txt uploaded !")
        messagebox.showinfo("INFO", "result16.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result16.txt to upload...")
