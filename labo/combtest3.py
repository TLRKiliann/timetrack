...
def recordOption():
    ...
    with open('./need/doc_suivi3/patient3_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result3.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if proc.stderr == b'':
        print("+ File patient3_14b.txt uploaded !")
        messagebox.showinfo("INFO", "patient3_14b.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No patient3_14b.txt to upload...")
    ...
    if secproc.stderr == b'':
        print("+ File result3.txt uploaded !")
        messagebox.showinfo("INFO", "result3.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result3.txt to upload...")
