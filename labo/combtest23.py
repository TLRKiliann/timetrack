...
def recordOption():
    ...
    with open('./need/doc_suivi23/patient23_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result23.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if proc.stderr == b'':
        print("+ File patient23_14b.txt uploaded !")
        messagebox.showinfo("INFO", "patient23_14b.txt uploaded...")
    else:
    ...
    if secproc.stderr == b'':
        print("+ File result23.txt uploaded !")
        messagebox.showinfo("INFO", "result23.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result23.txt to upload...")
