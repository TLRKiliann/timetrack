...
from labo.recorderesult.recrslt9 import checkerecord9
from labo.uploadreclab.uploadrslt9 import uploadata9

from labo.funcplatform.resultfunc9 import funcOsLab9
from labo.funcplatform.resultfunc9 import funcOsMicrobio9
from labo.funcplatform.resultfunc9 import callingOsRslt9
...
def callLabo9(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest9.py', check=True)
