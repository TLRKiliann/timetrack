...
def recordOption():
    ...
    with open('./need/doc_suivi14/patient14_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result14.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if proc.stderr == b'':
        print("+ File patient14_14b.txt uploaded !")
        messagebox.showinfo("INFO", "patient14_14b.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No patient14_14b.txt to upload...")
    ...
    if secproc.stderr == b'':
        print("+ File result14.txt uploaded !")
        messagebox.showinfo("INFO", "result14.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result14.txt to upload...")
