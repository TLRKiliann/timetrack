...
from labo.recorderesult.recrslt12 import checkerecord12
from labo.uploadreclab.uploadrslt12 import uploadata12

from labo.funcplatform.resultfunc12 import funcOsLab12
from labo.funcplatform.resultfunc12 import funcOsMicrobio12
from labo.funcplatform.resultfunc12 import callingOsRslt12
...
def callLabo12(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest12.py', check=True)
