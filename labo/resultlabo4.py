...
from labo.recorderesult.recrslt4 import checkerecord4
from labo.uploadreclab.uploadrslt4 import uploadata4

from labo.funcplatform.resultfunc4 import funcOsLab4
from labo.funcplatform.resultfunc4 import funcOsMicrobio4
from labo.funcplatform.resultfunc4 import callingOsRslt4
...
def callLabo4(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest4.py', check=True)
