...
from labo.recorderesult.recrslt15 import checkerecord15
from labo.uploadreclab.uploadrslt15 import uploadata15

from labo.funcplatform.resultfunc15 import funcOsLab15
from labo.funcplatform.resultfunc15 import funcOsMicrobio15
from labo.funcplatform.resultfunc15 import callingOsRslt15
...
def callLabo15(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest15.py', check=True)
