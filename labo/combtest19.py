...
def recordOption():
    ...
    with open('./need/doc_suivi19/patient19_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result19.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if proc.stderr == b'':
        print("+ File patient19_14b.txt uploaded !")
        messagebox.showinfo("INFO", "patient19_14b.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No patient19_14b.txt to upload...")
    ...
    if secproc.stderr == b'':
        print("+ File result19.txt uploaded !")
        messagebox.showinfo("INFO", "result19.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result19.txt to upload...")
