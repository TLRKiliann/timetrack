...
from labo.recorderesult.recrslt20 import checkerecord20
from labo.uploadreclab.uploadrslt20 import uploadata20

from labo.funcplatform.resultfunc20 import funcOsLab20
from labo.funcplatform.resultfunc20 import funcOsMicrobio20
from labo.funcplatform.resultfunc20 import callingOsRslt20
...
def callLabo20(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest20.py', check=True)
