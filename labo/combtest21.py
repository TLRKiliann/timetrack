...
def recordOption():
    ...
    with open('./need/doc_suivi21/patient21_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result21.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if secproc.stderr == b'':
        print("+ File result21.txt uploaded !")
        messagebox.showinfo("INFO", "result21.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result21.txt to upload...")
