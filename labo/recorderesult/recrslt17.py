...
def checkerecord17(self):
    ...
    with open('./need/doc_suivi17/patient17_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result17.txt', 'a+') as file2:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    with open('./need/doc_suivi17/patient17_14b.txt', 'a+') as endfile:
        with open('./labo/doc_labo/result17.txt', 'a+') as endfile2:
            endfile.write("---------------------------------------------------------\n\n")
            endfile2.write("---------------------------------------------------------\n\n")
