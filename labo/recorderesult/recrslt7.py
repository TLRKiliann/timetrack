...
def checkerecord7(self):
    """
        To upload data on server after creating files
    """
    print("[+] Date : " + time.strftime("%d/%m/%Y"))
    print("[+] Nom du patient : ", self.entrytext.get())
    with open('./need/doc_suivi7/patient7_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result7.txt', 'a+') as file2:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    with open('./need/doc_suivi7/patient7_14b.txt', 'a+') as endfile:
        with open('./labo/doc_labo/result7.txt', 'a+') as endfile2:
            endfile.write("---------------------------------------------------------\n\n")
            endfile2.write("---------------------------------------------------------\n\n")
