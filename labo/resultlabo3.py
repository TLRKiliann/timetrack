...
from labo.recorderesult.recrslt3 import checkerecord3
from labo.uploadreclab.uploadrslt3 import uploadata3

from labo.funcplatform.resultfunc3 import funcOsLab3
from labo.funcplatform.resultfunc3 import funcOsMicrobio3
from labo.funcplatform.resultfunc3 import callingOsRslt3
...
def callLabo3(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest3.py', check=True)
