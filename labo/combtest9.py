...
def recordOption():
    ...
    with open('./need/doc_suivi9/patient9_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result9.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if secproc.stderr == b'':
        print("+ File result9.txt uploaded !")
        messagebox.showinfo("INFO", "result9.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result9.txt to upload...")
