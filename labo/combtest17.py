...
def recordOption():
    ...
    with open('./need/doc_suivi17/patient17_14b.txt', 'a+') as file:
        with open('./labo/doc_labo/result17.txt', 'a+') as file_2:
            file.write("\n***************************************"\
                "************************************\n")
            file.write("Date : ")
...
def uploadata():
    ...
    if proc.stderr == b'':
        print("+ File patient17_14b.txt uploaded !")
        messagebox.showinfo("INFO", "patient17_14b.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No patient17_14b.txt to upload...")
    ...
    if secproc.stderr == b'':
        print("+ File result17.txt uploaded !")
        messagebox.showinfo("INFO", "result17.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result17.txt to upload...")
