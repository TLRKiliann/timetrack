...
from labo.recorderesult.recrslt8 import checkerecord8
from labo.uploadreclab.uploadrslt8 import uploadata8

from labo.funcplatform.resultfunc8 import funcOsLab8
from labo.funcplatform.resultfunc8 import funcOsMicrobio8
from labo.funcplatform.resultfunc8 import callingOsRslt8
...
def callLabo8(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest8.py', check=True)
