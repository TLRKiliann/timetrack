...
from labo.recorderesult.recrslt2 import checkerecord2
from labo.uploadreclab.uploadrslt2 import uploadata2

from labo.funcplatform.resultfunc2 import funcOsLab2
from labo.funcplatform.resultfunc2 import funcOsMicrobio2
from labo.funcplatform.resultfunc2 import callingOsRslt2
...
def callLabo2(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest2.py', check=True)
