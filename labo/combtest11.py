...
def recordOption():
    ...
    with open('./need/doc_suivi11/patient11_14b.txt', 'a+') as file:
...
def uploadata():
    ...
    if proc.stderr == b'':
        print("+ File patient11_14b.txt uploaded !")
        messagebox.showinfo("INFO", "patient11_14b.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No patient11_14b.txt to upload...")
    ...
    if secproc.stderr == b'':
        print("+ File result11.txt uploaded !")
        messagebox.showinfo("INFO", "result11.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No result11.txt to upload...")
