...
from labo.recorderesult.recrslt1 import checkerecord
from labo.uploadreclab.uploadrslt1 import uploadata

from labo.funcplatform.resultfunc1 import funcOsLab
from labo.funcplatform.resultfunc1 import funcOsMicrobio
from labo.funcplatform.resultfunc1 import callingOsRslt
...
def callLabo1(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest.py', check=True)
