...
def callingOsRslt20():
    ...
    if callplatform == 'Linux':
        os.system('gio open "./labo/doc_labo/result20.txt"') # Linux
    elif callplatform =='Darwin':
        subprocess.call('open', './labo/doc_labo/result20.txt') # Mac
    else:
        os.startfile('./labo/doc_labo/result20.txt') # Windows
