...
def callingOsRslt22():
    ...
    if callplatform == 'Linux':
        os.system('gio open "./labo/doc_labo/result22.txt"') # Linux
    elif callplatform =='Darwin':
        subprocess.call('open', './labo/doc_labo/result22.txt') # Mac
    else:
        os.startfile('./labo/doc_labo/result22.txt') # Windows
