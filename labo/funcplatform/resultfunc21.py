...
def callingOsRslt21():
    ...
    if callplatform == 'Linux':
        os.system('gio open "./labo/doc_labo/result21.txt"') # Linux
    elif callplatform =='Darwin':
        subprocess.call('open', './labo/doc_labo/result21.txt') # Mac
    else:
        os.startfile('./labo/doc_labo/result21.txt') # Windows
