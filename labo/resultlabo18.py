...
from labo.recorderesult.recrslt18 import checkerecord18
from labo.uploadreclab.uploadrslt18 import uploadata18

from labo.funcplatform.resultfunc18 import funcOsLab18
from labo.funcplatform.resultfunc18 import funcOsMicrobio18
from labo.funcplatform.resultfunc18 import callingOsRslt18
...
def callLabo18(self):
    ...
    def comburTips():
        ...
        self.master.update()
        subprocess.run('./labo/combtest18.py', check=True)
