...
def Window5(self):
    ...
    def allInData():
        ...
        try:
            ...
            with open('./contact/conpact5/contact1.txt', 'w') as testf:
        ...
        try:
            if os.path.exists('./contact/conpact5/contact1.txt'):
                with open('./contact/conpact5/contact1.txt', 'r') as policyfile:
    ...
    def recorderData(namentry, birthvar, native, nativaentry, txtphone, phonentry,
        ...
        try:
            with open('./contact/conpact5/contact1.txt', 'w') as iofile:
        ...
        try:
            ...
            with open('./contact/conpact5/finalfile1.txt', 'a+'):
                print("+ finalfile1.txt exist!")
        try:
            with open('./contact/conpact5/finalfile1.txt', 'w') as terminfile:
    ...
    try:
        with open('./contact/conpact5/contact1.txt', 'r') as namefile:
