...
def homecsWind5(self):
    ...
    def recorderData(namentry, txtphone, phonentry, txtmobile,
        ...
        try:
            with open('./contact/conpact5/hcscontact1.txt', 'w') as iofile:
        ...
        try:
            ...
            with open('./contact/conpact5/finalhcs1.txt', 'a+'):
                print("+ finalhcs1.txt exist!")

        try:
            with open('./contact/conpact5/finalhcs1.txt', 'w') as terminfile:
    ...
    def recordersecData(name_twoentry, txt_twophone, twophonentry,
        ...
        try:
            with open('./contact/conpact5/hcscontact2.txt', 'w') as copyfile:
        ...
        try:
            ...
            with open('./contact/conpact5/finalhcs2.txt', 'a+'):
                print("+ finalhcs2.txt exist!")

        try:
            with open('./contact/conpact5/finalhcs2.txt', 'w') as secterfile:
    ...
    def recorderthirdData(name_thirdentry, txt_thirdphone, thirdphonentry,
        ...
        try:
            with open('./contact/conpact5/hcscontact3.txt', 'w') as copyfile:
        ...
        try:
            ...
            with open('./contact/conpact5/finalhcs3.txt', 'a+'):
                print("+ finalhcs3.txt exist!")

        try:
            with open('./contact/conpact5/finalhcs3.txt', 'w') as secterfile:
