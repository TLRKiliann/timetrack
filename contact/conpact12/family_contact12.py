...
import os
from contact.conpact12.writerfiles.writefam12 import recorderFam
...
def famWind12(self):
    ...
    def familyData():
        ...
        def readerFamily():
            try:
                if os.path.exists('./contact/conpact12/famycontact12.txt'):
                    with open('./contact/conpact12/famycontact12.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact12.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact12/famycontact12.txt', 'r') as namefile:
        ...
        print("[!] File famycontact12.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact12.txt not created !", ub_error1)
