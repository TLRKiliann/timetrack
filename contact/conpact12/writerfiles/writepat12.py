...
def recorderData(self, birthvar):
    ...
    try:
        with open('./contact/conpact12/contact12.txt', 'w') as iofile:
    ...
    try:
        ...
        print("[!] finalfile12.txt not found !(Error3)", err_termin)
        with open('./contact/conpact12/finalfile12.txt', 'a+'):
            print("[+] File finalfile12.txt exist!")

    try:
        with open('./contact/conpact12/finalfile12.txt', 'w') as terminfile:
        ...
        print("[!] finalfile12.txt not created (Error4)", err2_final)
