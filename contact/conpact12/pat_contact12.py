...
import os
from contact.conpact12.writerfiles.writepat12 import recorderData
...
def Window12(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            try:
                ...
                print("[!] File contact12.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact12/contact12.txt', 'r') as namefile:
        ...
        print("[!] File contact12.txt doesn't exist ! (Error_2)", callfile)
