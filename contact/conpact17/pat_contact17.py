...
import os
from contact.conpact17.writerfiles.writepat17 import recorderData
...
def Window17(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact17/contact17.txt'):
                    print("[+] Ok, contact17.txt exist")
            except FileNotFoundError as errfnf:
                print("[!] File contact17.txt doesn't exist (Error_2)", errfnf)
                with open('./contact/conpact17/contact17.txt', 'w') as testf:
                    print("[+] File contact17.txt created !")

            try:
                if os.path.exists('./contact/conpact17/contact17.txt'):
                    with open('./contact/conpact17/contact17.txt', 'r') as policyfile:
                ...
                print("[!] File contact17.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact17/contact17.txt', 'r') as namefile:
        ...
        print("[!] File contact17.txt doesn't exist ! (Error_2)", callfile)
