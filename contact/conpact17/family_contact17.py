...
import os
from contact.conpact17.writerfiles.writefam17 import recorderFam
...
def famWind17(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact17/famycontact17.txt'):
                    print("[+] Ok, famycontact17.txt exist (t2)")
            except FileNotFoundError as err_fnf:
                print("[!] No file famycontact17.txt exist", err_fnf)
                with open('./contact/conpact17/famycontact17.txt', 'w') as testf:
                    print("[+] File famycontact17.txt created !")

            try:
                if os.path.exists('./contact/conpact17/famycontact17.txt'):
                    with open('./contact/conpact17/famycontact17.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact17.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact17/famycontact17.txt', 'r') as namefile:
        ...
        print("[!] File famycontact17.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact17.txt not created !", ub_error1)
