...
import os
from contact.conpact18.writerfiles.writefam18 import recorderFam
...
def famWind18(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact18/famycontact18.txt'):
                    print("[+] Ok, famycontact18.txt exist (t2)")
            except FileNotFoundError as err_fnf:
                print("[!] No file famycontact18.txt exist", err_fnf)
                with open('./contact/conpact18/famycontact18.txt', 'w') as testf:
                    print("[+] File famycontact18.txt created !")

            try:
                if os.path.exists('./contact/conpact18/famycontact18.txt'):
                    with open('./contact/conpact18/famycontact18.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact18.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact18/famycontact18.txt', 'r') as namefile:
        ...
        print("[!] File famycontact18.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact18.txt not created !", ub_error1)
