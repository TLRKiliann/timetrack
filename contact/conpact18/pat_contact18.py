...
import os
from contact.conpact18.writerfiles.writepat18 import recorderData
...
def Window18(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact18/contact18.txt'):
                    print("[+] Ok, contact18.txt exist")
            except FileNotFoundError as errfnf:
                print("[!] File contact18.txt doesn't exist (Error_2)", errfnf)
                with open('./contact/conpact18/contact18.txt', 'w') as testf:
                    print("[+] File contact18.txt created !")

            try:
                if os.path.exists('./contact/conpact18/contact18.txt'):
                    with open('./contact/conpact18/contact18.txt', 'r') as policyfile:
                ...
                print("[!] File contact18.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact18/contact18.txt', 'r') as namefile:
        ...
        print("[!] File contact18.txt doesn't exist ! (Error_2)", callfile)
