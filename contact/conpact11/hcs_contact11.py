...
def homecsWind11(self):
    ...
    def allInData():
        ...
        try:
            ...
            with open('./contact/conpact11/hcscontact1.txt', 'w') as testf:
        ...
        try:
            if os.path.exists('./contact/conpact11/hcscontact1.txt'):
                with open('./contact/conpact11/hcscontact1.txt', 'r') as policyfile:
        ...
        try:
            ...
            with open('./contact/conpact11/hcscontact2.txt', 'w') as testf:
        ...
        try:
            if os.path.exists('./contact/conpact11/hcscontact2.txt'):
                with open('./contact/conpact11/hcscontact2.txt', 'r') as secondfile:
        ...
        try:
            ...
            with open('./contact/conpact11/hcscontact3.txt', 'w') as testf:
        ...
        try:
            if os.path.exists('./contact/conpact11/hcscontact3.txt'):
                with open('./contact/conpact11/hcscontact3.txt', 'r') as secondfile:
    ...
    def recorderData(namentry, txtphone, phonentry, txtmobile,
        ...
        try:
            with open('./contact/conpact11/hcscontact1.txt', 'w') as iofile:
        ...
        try:
            ...
            with open('./contact/conpact11/finalhcs1.txt', 'a+'):
                print("+ finalhcs1.txt exist!")

        try:
            with open('./contact/conpact11/finalhcs1.txt', 'w') as terminfile:
    ...
    def recordersecData(name_twoentry, txt_twophone, twophonentry,
        ...
        try:
            with open('./contact/conpact11/hcscontact2.txt', 'w') as copyfile:
        ...
        try:
            ...
            with open('./contact/conpact11/finalhcs2.txt', 'a+'):
                print("+ finalhcs2.txt exist!")

        try:
            with open('./contact/conpact11/finalhcs2.txt', 'w') as secterfile:
    ...
    def recorderthirdData(name_thirdentry, txt_thirdphone, thirdphonentry,
        ...
        try:
            with open('./contact/conpact11/hcscontact3.txt', 'w') as copyfile:
        ...
        try:
            ...
            with open('./contact/conpact11/finalhcs3.txt', 'a+'):
                print("+ finalhcs3.txt exist!")

        try:
            with open('./contact/conpact11/finalhcs3.txt', 'w') as secterfile:
    ...
    try:
        with open('./contact/conpact11/hcscontact1.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact11/hcscontact2.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact11/hcscontact3.txt', 'r') as namefile3:
