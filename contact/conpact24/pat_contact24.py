...
import os
from contact.conpact24.writerfiles.writepat24 import recorderData
...
def Window24(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact24/contact24.txt'):
                    print("[+] Ok, contact24.txt exist")
            except FileNotFoundError as errfnf:
                print("[!] File contact24.txt doesn't exist (Error_2)", errfnf)
                with open('./contact/conpact24/contact24.txt', 'w') as testf:
                    print("[+] File contact24.txt created !")

            try:
                if os.path.exists('./contact/conpact24/contact24.txt'):
                    with open('./contact/conpact24/contact24.txt', 'r') as policyfile:
                ...
                print("[!] File contact24.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact24/contact24.txt', 'r') as namefile:
        ...
        print("[!] File contact24.txt doesn't exist ! (Error_2)", callfile)
