...
def Window24(self):
    ...
    def allInData():
        ...
        try:
            ...
            with open('./contact/conpact24/contact1.txt', 'w') as testf:
        ...
        try:
            if os.path.exists('./contact/conpact24/contact1.txt'):
                with open('./contact/conpact24/contact1.txt', 'r') as policyfile:
    ...
    def recorderData(namentry, birthvar, native, nativaentry, txtphone, phonentry,
        ...
        try:
            with open('./contact/conpact24/contact1.txt', 'w') as iofile:
        ...
        try:
            if os.path.getsize('./contact/conpact24/finalfile1.txt'):
                os.remove('./contact/conpact24/finalfile1.txt')
        except FileNotFoundError as err_termin:
            print("+ finalfile1 not found !(Error3)", err_termin)
            with open('./contact/conpact24/finalfile1.txt', 'a+'):
                print("+ finalfile1.txt exist!")
        try:
            with open('./contact/conpact24/finalfile1.txt', 'w') as terminfile:
    ...
    try:
        with open('./contact/conpact24/contact1.txt', 'r') as namefile:
