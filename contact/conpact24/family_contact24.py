...
import os
from contact.conpact24.writerfiles.writefam24 import recorderFam
...
def famWind24(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact24/famycontact24.txt'):
                    print("[+] Ok, famycontact24.txt exist (t2)")
            except FileNotFoundError as err_fnf:
                print("[!] No file famycontact24.txt exist", err_fnf)
                with open('./contact/conpact24/famycontact24.txt', 'w') as testf:
                    print("[+] File famycontact24.txt created !")

            try:
                if os.path.exists('./contact/conpact24/famycontact24.txt'):
                    with open('./contact/conpact24/famycontact24.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact24.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact24/famycontact24.txt', 'r') as namefile:
        ...
        print("[!] File famycontact24.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact24.txt not created !", ub_error1)
