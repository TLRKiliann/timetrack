...
def doctorWind22(self):
    ...
    def allInData():
        ...
        try:
            ...
            with open('./contact/conpact22/contactdoc1.txt', 'w') as testf:
        ...
        try:
            if os.path.exists('./contact/conpact22/contactdoc1.txt'):
                with open('./contact/conpact22/contactdoc1.txt', 'r') as policyfile:
        ...
        try:
            ...
            with open('./contact/conpact22/contactdoc2.txt', 'w') as testfd2:
        ...
        try:
            if os.path.exists('./contact/conpact22/contactdoc2.txt'):
                with open('./contact/conpact22/contactdoc2.txt', 'r') as policydoc:
        ...
        try:
            ...
            with open('./contact/conpact22/contactdoc3.txt', 'w') as testfd3:
        ...
        try:
            if os.path.exists('./contact/conpact22/contactdoc3.txt'):
                with open('./contact/conpact22/contactdoc3.txt', 'r') as policydoc3:
    ...
    def recorderData(namentry, txtspec1, specentry1, txtphone,
        ...
        try:
            with open('./contact/conpact22/contactdoc1.txt', 'w') as iofile:
        ...
        try:
            if os.path.getsize('./contact/conpact22/finaldoc1.txt'):
                os.remove('./contact/conpact22/finaldoc1.txt')
        except FileNotFoundError as err_termin:
            print("+ finaldoc1 not found !(Error8)", err_termin)
            with open('./contact/conpact22/finaldoc1.txt', 'a+'):
                print("+ finaldoc1.txt exist!")
        try:
            with open('./contact/conpact22/finaldoc1.txt', 'w') as terminfile:
    ...
    def recorderDoc2(namentry2, txtspec2, specentry2, txtphone2,
        ...
        try:
            ...
            with open('./contact/conpact22/contactdoc2.txt', 'w') as testf2:
                print("+ File contactdoc2.txt created !", testf2)

        try:
            with open('./contact/conpact22/contactdoc2.txt', 'w') as datadoc:
        ...
        try:
            ...
            with open('./contact/conpact22/finaldoc2.txt', 'a+'):
                print("+ finaldoc2.txt exist!")
        try:
            with open('./contact/conpact22/finaldoc2.txt', 'w') as finalf:
    ...
    def recorderDoc3(namentry3, txtspec3, specentry3, txtphone3,
        ...
        try:
            ...
            with open('./contact/conpact22/contactdoc3.txt', 'w') as testf3:
                print("+ File contactdoc3.txt created !", testf3)

        try:
            with open('./contact/conpact22/contactdoc3.txt', 'w') as datadoc3:
        ...
        try:
            ...
            with open('./contact/conpact22/finaldoc3.txt', 'a+'):
                print("+ finaldoc3.txt exist!")
        try:
            with open('./contact/conpact22/finaldoc3.txt', 'w') as finalf3:
    ...
    try:
        with open('./contact/conpact22/contactdoc1.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact22/contactdoc2.txt', 'r') as docfile2:
    ...
    try:
        with open('./contact/conpact22/contactdoc3.txt', 'r') as docfile3:
