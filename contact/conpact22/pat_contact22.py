...
import os
from contact.conpact22.writerfiles.writepat22 import recorderData
...
def Window22(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact22/contact22.txt'):
                    print("[+] Ok, contact22.txt exist")
            except FileNotFoundError as errfnf:
                print("[!] File contact22.txt doesn't exist (Error_2)", errfnf)
                with open('./contact/conpact22/contact22.txt', 'w') as testf:
                    print("[+] File contact22.txt created !")

            try:
                if os.path.exists('./contact/conpact22/contact22.txt'):
                    with open('./contact/conpact22/contact22.txt', 'r') as policyfile:
                ...
                print("[!] File contact22.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact22/contact22.txt', 'r') as namefile:
        ...
        print("[!] File contact22.txt doesn't exist ! (Error_2)", callfile)
