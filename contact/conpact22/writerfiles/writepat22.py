...
def recorderData(self, birthvar):
    ...
    """
    try:
        with open('./contact/conpact22/contact22.txt', 'w') as iofile:
    ...
    try:
        ...
        print("[!] finalfile22.txt not found !(Error_3)", err_termin)
        with open('./contact/conpact22/finalfile22.txt', 'a+'):
            print("[+] File finalfile22.txt created!")

    try:
        with open('./contact/conpact22/finalfile22.txt', 'w') as terminfile:
        ...
        print("[!] finalfile22.txt not created (Error_4)", err2_final)
