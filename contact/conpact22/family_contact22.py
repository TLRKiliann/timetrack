...
import os
from contact.conpact22.writerfiles.writefam22 import recorderFam
...
def famWind22(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact22/famycontact22.txt'):
                    print("[+] Ok, famycontact22.txt exist (t2)")
            except FileNotFoundError as err_fnf:
                print("[!] No file famycontact22.txt exist", err_fnf)
                with open('./contact/conpact22/famycontact22.txt', 'w') as testf:
                    print("[+] File famycontact22.txt created !")

            try:
                if os.path.exists('./contact/conpact22/famycontact22.txt'):
                    with open('./contact/conpact22/famycontact22.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact22.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact22/famycontact22.txt', 'r') as namefile:
        ...
        print("[!] File famycontact22.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact22.txt not created !", ub_error1)
