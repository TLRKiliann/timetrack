...
import os
from contact.conpact23.writerfiles.writefam23 import recorderFam
...
def famWind23(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact23/famycontact23.txt'):
                    print("[+] Ok, famycontact23.txt exist (t2)")
            except FileNotFoundError as err_fnf:
                print("[!] No file famycontact23.txt exist", err_fnf)
                with open('./contact/conpact23/famycontact23.txt', 'w') as testf:
                    print("[+] File famycontact23.txt created !")

            try:
                if os.path.exists('./contact/conpact23/famycontact23.txt'):
                    with open('./contact/conpact23/famycontact23.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact23.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact23/famycontact23.txt', 'r') as namefile:
        ...
        print("[!] File famycontact23.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact23.txt not created !", ub_error1)
