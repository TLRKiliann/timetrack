...
import os
from contact.conpact23.writerfiles.writepat23 import recorderData
...
def Window23(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact23/contact23.txt'):
                    print("[+] Ok, contact23.txt exist")
            except FileNotFoundError as errfnf:
                print("[!] File contact23.txt doesn't exist (Error_2)", errfnf)
                with open('./contact/conpact23/contact23.txt', 'w') as testf:
                    print("[+] File contact23.txt created !")

            try:
                if os.path.exists('./contact/conpact23/contact23.txt'):
                    with open('./contact/conpact23/contact23.txt', 'r') as policyfile:
                ...
                print("[!] File contact23.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact23/contact23.txt', 'r') as namefile:
        ...
        print("[!] File contact23.txt doesn't exist ! (Error_2)", callfile)
