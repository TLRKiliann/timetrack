...
def doctorWind(self):
    ...
    try:
        with open('./contact/conpact/contactdoc1.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact/contactdoc2.txt', 'r') as docfile2:
    ...
    try:
        with open('./contact/conpact/contactdoc3.txt', 'r') as docfile3:
