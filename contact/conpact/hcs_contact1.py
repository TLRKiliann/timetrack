...
def homecsWind(self):
    ...
    def allInData():
        ...
        try:
            if os.path.exists('./contact/conpact/hcscontact1.txt'):
                with open('./contact/conpact/hcscontact1.txt', 'r') as policyfile:
        ...
        try:
            ...
            with open('./contact/conpact/hcscontact3.txt', 'w') as testf:
        ...
        try:
            if os.path.exists('./contact/conpact/hcscontact3.txt'):
                with open('./contact/conpact/hcscontact3.txt', 'r') as secondfile:
    ...
    def recorderData(namentry, txtphone, phonentry, txtmobile,
        ...
        try:
            with open('./contact/conpact/hcscontact1.txt', 'w') as iofile:
        ...
        try:
            with open('./contact/conpact/finalhcs1.txt', 'w') as terminfile:
    ...
    def recorderthirdData(name_thirdentry, txt_thirdphone, thirdphonentry,
        ...
        try:
            with open('./contact/conpact/hcscontact3.txt', 'w') as copyfile:
        ...
        try:
            ...
            with open('./contact/conpact/finalhcs3.txt', 'a+'):
                print("+ finalhcs3.txt exist!")

        try:
            with open('./contact/conpact/finalhcs3.txt', 'w') as secterfile:
    ...
    try:
        with open('./contact/conpact/hcscontact3.txt', 'r') as namefile3:
