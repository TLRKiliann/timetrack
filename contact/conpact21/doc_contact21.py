...
def doctorWind21(self):
    ...
    def allInData():
        ...
        try:
            ...
            with open('./contact/conpact21/contactdoc2.txt', 'w') as testfd2:
        ...
        try:
            ...
            with open('./contact/conpact21/contactdoc3.txt', 'w') as testfd3:
    ...
    def recorderData(namentry, txtspec1, specentry1, txtphone,
        ...
        try:
            with open('./contact/conpact21/contactdoc1.txt', 'w') as iofile:
        ...
        try:
            ...
            with open('./contact/conpact21/finaldoc1.txt', 'a+'):
                print("+ finaldoc1.txt exist!")
        try:
            with open('./contact/conpact21/finaldoc1.txt', 'w') as terminfile:
    ...
    def recorderDoc2(namentry2, txtspec2, specentry2, txtphone2,
        ...
        try:
            with open('./contact/conpact21/contactdoc2.txt', 'w') as datadoc:
        ...
        try:
            ...
            with open('./contact/conpact21/finaldoc2.txt', 'a+'):
                print("+ finaldoc2.txt exist!")
        try:
            with open('./contact/conpact21/finaldoc2.txt', 'w') as finalf:
    ...
    def recorderDoc3(namentry3, txtspec3, specentry3, txtphone3,
        ...
        try:
            with open('./contact/conpact21/contactdoc3.txt', 'w') as datadoc3:
        ...
        try:
            ...
            with open('./contact/conpact21/finaldoc3.txt', 'a+'):
                print("+ finaldoc3.txt exist!")
        try:
            with open('./contact/conpact21/finaldoc3.txt', 'w') as finalf3:
