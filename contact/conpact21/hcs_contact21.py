...
import os
from contact.conpact21.writerfiles.writehcs21 import careOneRec
from contact.conpact21.writerfiles.writehcs21 import careTwoRec
from contact.conpact21.writerfiles.writehcs21 import careThreeRec


def homecsWind21(self):
    """
    ...
    def careInSys():
        ...
        def sysCareOne():
            try:
                ...
                with open('./contact/conpact21/hcscontact1.txt', 'w') as testf:
                    print("[+] File hcscontact1.txt created !")

            try:
                if os.path.exists('./contact/conpact21/hcscontact1.txt'):
                    with open('./contact/conpact21/hcscontact1.txt', 'r') as policyfile:
        ...
        def sysCareSec():
            try:
                ...
                with open('./contact/conpact21/hcscontact2.txt', 'w') as testf:
                    print("[+] File hcscontact2.txt created !")

            try:
                if os.path.exists('./contact/conpact21/hcscontact2.txt'):
                    with open('./contact/conpact21/hcscontact2.txt', 'r') as secondfile:
        ...
        def sysCareThird():
            try:
                ...
                with open('./contact/conpact21/hcscontact3.txt', 'w') as testf:
                    print("[+] File hcscontact3.txt created !")

            try:
                if os.path.exists('./contact/conpact21/hcscontact3.txt'):
                    with open('./contact/conpact21/hcscontact3.txt', 'r') as secondfile:
    ...
    try:
        with open('./contact/conpact21/hcscontact1.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact21/hcscontact2.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact21/hcscontact3.txt', 'r') as namefile3:
