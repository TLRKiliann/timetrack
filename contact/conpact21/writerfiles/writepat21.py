...
def recorderData(self, birthvar):
    ...
    """
    try:
        with open('./contact/conpact21/contact21.txt', 'w') as iofile:
    ...
    try:
        ...
        print("[!] finalfile21.txt not found !(Error_3)", err_termin)
        with open('./contact/conpact21/finalfile21.txt', 'a+'):
            print("[+] File finalfile21.txt created!")

    try:
        with open('./contact/conpact21/finalfile21.txt', 'w') as terminfile:
        ...
        print("[!] finalfile21.txt not created (Error_4)", err2_final)
