...
import os
from contact.conpact21.writerfiles.writepat21 import recorderData
...
def Window21(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact21/contact21.txt'):
                    print("[+] Ok, contact21.txt exist")
            except FileNotFoundError as errfnf:
                print("[!] File contact21.txt doesn't exist (Error_2)", errfnf)
                with open('./contact/conpact21/contact21.txt', 'w') as testf:
                    print("[+] File contact21.txt created !")

            try:
                if os.path.exists('./contact/conpact21/contact21.txt'):
                    with open('./contact/conpact21/contact21.txt', 'r') as policyfile:
                ...
                print("[!] File contact21.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact21/contact21.txt', 'r') as namefile:
        ...
        print("[!] File contact21.txt doesn't exist ! (Error_2)", callfile)
