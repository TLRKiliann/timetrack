...
import os
from contact.conpact21.writerfiles.writefam21 import recorderFam
...
def famWind21(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact21/famycontact21.txt'):
                    print("[+] Ok, famycontact21.txt exist (t2)")
            except FileNotFoundError as err_fnf:
                print("[!] No file famycontact21.txt exist", err_fnf)
                with open('./contact/conpact21/famycontact21.txt', 'w') as testf:
                    print("[+] File famycontact21.txt created !")

            try:
                if os.path.exists('./contact/conpact21/famycontact21.txt'):
                    with open('./contact/conpact21/famycontact21.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact21.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact21/famycontact21.txt', 'r') as namefile:
        ...
        print("[!] File famycontact21.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact21.txt not created !", ub_error1)
