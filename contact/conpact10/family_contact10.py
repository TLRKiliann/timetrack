...
import os
from contact.conpact10.writerfiles.writefam10 import recorderFam
...
def famWind10(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            try:
                if os.path.exists('./contact/conpact10/famycontact10.txt'):
                    with open('./contact/conpact10/famycontact10.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact10.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact10/famycontact10.txt', 'r') as namefile:
        ...
        print("[!] File famycontact10.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact10.txt not created !", ub_error1)
