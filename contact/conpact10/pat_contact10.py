...
import os
from contact.conpact10.writerfiles.writepat10 import recorderData
...
def Window10(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            try:
                if os.path.exists('./contact/conpact10/contact10.txt'):
                    with open('./contact/conpact10/contact10.txt', 'r') as policyfile:
                ...
                print("[!] File contact10.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact10/contact10.txt', 'r') as namefile:
        ...
        print("[!] File contact10.txt doesn't exist ! (Error_2)", callfile)
