...
import os
from contact.conpact3.writerfiles.writepat3 import recorderData
...
def Window3(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            try:
                ...
                print("[!] File contact3.txt doesn't exist (Error1)", err_r)
    ...
    try:
        with open('./contact/conpact3/contact3.txt', 'r') as namefile:
        ...
        print("[!] File contact3.txt doesn't exist ! (Error5)", callfile)
