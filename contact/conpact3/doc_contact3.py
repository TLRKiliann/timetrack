...
import os
from contact.conpact3.writerfiles.writedoc3 import docRecord
from contact.conpact3.writerfiles.writedoc3 import docTwoRecord
from contact.conpact3.writerfiles.writedoc3 import docThreeRecord


def doctorWind3(self):
    """
    ...
    def docData():
        ...
        def numberOneDox():
            ...
            try:
                if os.path.exists('./contact/conpact3/contactdoc1.txt'):
                    with open('./contact/conpact3/contactdoc1.txt', 'r') as policyfile:
        ...
        def numberTwoDox():
            ...
            try:
                if os.path.exists('./contact/conpact3/contactdoc2.txt'):
                    with open('./contact/conpact3/contactdoc2.txt', 'r') as policydoc:
        ...
        def numbThreeDox():
            ...
            try:
                if os.path.exists('./contact/conpact3/contactdoc3.txt'):
                    with open('./contact/conpact3/contactdoc3.txt', 'r') as policydoc3:
    ...
    try:
        with open('./contact/conpact3/contactdoc1.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact3/contactdoc2.txt', 'r') as docfile2:
    ...
    try:
        with open('./contact/conpact3/contactdoc3.txt', 'r') as docfile3:
