...
import os
from contact.conpact3.writerfiles.writefam3 import recorderFam
...
def famWind3(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            try:
                if os.path.exists('./contact/conpact3/famycontact3.txt'):
                    with open('./contact/conpact3/famycontact3.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact3.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact3/famycontact3.txt', 'r') as namefile:
        ...
        print("[!] File famycontact3.txt doesn't exist !", callfile)
