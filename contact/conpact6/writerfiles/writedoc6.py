...
def docRecord(self):
    ...
    try:
        ...
        print("[!] File contactdoc1.txt not found (Error_6)", errfnf)
    ...
    try:
        ...
        print("[!] finaldoc1 not found (Error_7)", err_termin)
...
def docTwoRecord(self):
    ...
    try:
        ...
        print("[!] File contactdoc2.txt not found (Error_7)", errfnf2)
    ...
    try:
        ...
        print("[!] File contactdoc2.txt not found (Error_8)!", fn2)
    ...
    try:
        ...
        print("[!] finaldoc2 not found !(Error_9)", err_termin2)
    ...
    try:
        ...
        print("[!] finaldoc2.txt not created (Error_10)", err_final2)
...
def docThreeRecord(self):
    ...
    try:
        ...
        print("[!] File contactdoc3.txt not found (Error_11)", errfnf3)
    ...
    try:
        ...
        print("[!] File finaldoc3 not found (Error_12)", err_termin3)
    ...
    try:
        ...
        print("[!] finaldoc3.txt not created (Error_13)", err_final3)
