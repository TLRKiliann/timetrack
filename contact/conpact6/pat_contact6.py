...
import os
from contact.conpact6.writerfiles.writepat6 import recorderData
...
def Window6(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            try:
                if os.path.exists('./contact/conpact6/contact6.txt'):
                    with open('./contact/conpact6/contact6.txt', 'r') as policyfile:
                ...
                print("[!] File contact6.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact6/contact6.txt', 'r') as namefile:
        ...
        print("[!] File contact6.txt doesn't exist ! (Error_2)", callfile)
