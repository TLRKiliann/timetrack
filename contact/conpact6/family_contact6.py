...
import os
from contact.conpact6.writerfiles.writefam6 import recorderFam
...
def famWind6(self):
    ...
    def familyData():
        ...
        def readerFamily():
            try:
                if os.path.exists('./contact/conpact6/famycontact6.txt'):
                    with open('./contact/conpact6/famycontact6.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact6.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact6/famycontact6.txt', 'r') as namefile:
        ...
        print("[!] File famycontact6.txt doesn't exist !", callfile)
