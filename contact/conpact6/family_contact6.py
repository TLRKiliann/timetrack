...
def famWind6(self):
    ...
    def allInData():
        ...
        try:
            ...
            with open('./contact/conpact6/famycontact1.txt', 'w') as testf:
        ...
        try:
            if os.path.exists('./contact/conpact6/famycontact1.txt'):
                with open('./contact/conpact6/famycontact1.txt', 'r') as policyfile:
    ...
    def recorderData(namentry, txtphone, phonentry, txtmobile,
        ...
        try:
            with open('./contact/conpact6/famycontact1.txt', 'w') as iofile:
        ...
        try:
            ...
            with open('./contact/conpact6/finalfam1.txt', 'a+'):
                print("+ finalfam1.txt exist!")
        try:
            with open('./contact/conpact6/finalfam1.txt', 'w') as terminfile:
    ...
    try:
        with open('./contact/conpact6/famycontact1.txt', 'r') as namefile:
