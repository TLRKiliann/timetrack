...
import os
from contact.conpact6.writerfiles.writehcs6 import careOneRec
from contact.conpact6.writerfiles.writehcs6 import careTwoRec
from contact.conpact6.writerfiles.writehcs6 import careThreeRec


def homecsWind6(self):
    """
    ...
    def careInSys():
        ...
        def sysCareOne():
            try:
                ...
                with open('./contact/conpact6/hcscontact1.txt', 'w') as testf:
                    print("[+] File hcscontact1.txt created !")

            try:
                if os.path.exists('./contact/conpact6/hcscontact1.txt'):
                    with open('./contact/conpact6/hcscontact1.txt', 'r') as policyfile:
        ...
        def sysCareSec():
            try:
                ...
                with open('./contact/conpact6/hcscontact2.txt', 'w') as testf:
                    print("[+] File hcscontact2.txt created !")

            try:
                if os.path.exists('./contact/conpact6/hcscontact2.txt'):
                    with open('./contact/conpact6/hcscontact2.txt', 'r') as secondfile:
    ...
    try:
        with open('./contact/conpact6/hcscontact1.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact6/hcscontact2.txt', 'r') as namefile:
