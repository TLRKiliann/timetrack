...
def doctorWind16(self):
    ...
    def allInData():
        ...
        try:
            ...
            with open('./contact/conpact16/contactdoc1.txt', 'w') as testf:
        ...
        try:
            if os.path.exists('./contact/conpact16/contactdoc1.txt'):
                with open('./contact/conpact16/contactdoc1.txt', 'r') as policyfile:
        ...
        try:
            ...
            with open('./contact/conpact16/contactdoc2.txt', 'w') as testfd2:
        ...
        try:
            if os.path.exists('./contact/conpact16/contactdoc2.txt'):
                with open('./contact/conpact16/contactdoc2.txt', 'r') as policydoc:
        ...
        try:
            ...
            with open('./contact/conpact16/contactdoc3.txt', 'w') as testfd3:
        ...
        try:
            if os.path.exists('./contact/conpact16/contactdoc3.txt'):
                with open('./contact/conpact16/contactdoc3.txt', 'r') as policydoc3:
    ...
    def recorderDoc2(namentry2, txtspec2, specentry2, txtphone2,
        ...
        try:
            ...
            with open('./contact/conpact16/contactdoc2.txt', 'w') as testf2:
    ...
    def recorderDoc3(namentry3, txtspec3, specentry3, txtphone3,
        ...
        try:
            ...
            with open('./contact/conpact16/contactdoc3.txt', 'w') as testf3:
    ...
    try:
        with open('./contact/conpact16/contactdoc1.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact16/contactdoc2.txt', 'r') as docfile2:
    ...
    try:
        with open('./contact/conpact16/contactdoc3.txt', 'r') as docfile3:
