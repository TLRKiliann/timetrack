...
import os
from contact.conpact16.writerfiles.writefam16 import recorderFam
...
def famWind16(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact16/famycontact16.txt'):
                    print("[+] Ok, famycontact16.txt exist (t2)")
            except FileNotFoundError as err_fnf:
                print("[!] No file famycontact16.txt exist", err_fnf)
                with open('./contact/conpact16/famycontact16.txt', 'w') as testf:
                    print("[+] File famycontact16.txt created !")

            try:
                if os.path.exists('./contact/conpact16/famycontact16.txt'):
                    with open('./contact/conpact16/famycontact16.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact16.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact16/famycontact16.txt', 'r') as namefile:
        ...
        print("[!] File famycontact16.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact16.txt not created !", ub_error1)
