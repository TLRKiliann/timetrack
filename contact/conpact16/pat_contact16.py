...
import os
from contact.conpact16.writerfiles.writepat16 import recorderData
...
def Window16(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact16/contact16.txt'):
                    print("[+] Ok, contact16.txt exist")
            except FileNotFoundError as errfnf:
                print("[!] File contact16.txt doesn't exist (Error_2)", errfnf)
                with open('./contact/conpact16/contact16.txt', 'w') as testf:
                    print("[+] File contact16.txt created !")

            try:
                if os.path.exists('./contact/conpact16/contact16.txt'):
                    with open('./contact/conpact16/contact16.txt', 'r') as policyfile:
                ...
                print("[!] File contact16.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact16/contact16.txt', 'r') as namefile:
        ...
        print("[!] File contact16.txt doesn't exist ! (Error_2)", callfile)
