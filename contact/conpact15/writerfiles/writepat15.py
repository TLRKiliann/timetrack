...
def recorderData(self, birthvar):
    ...
    try:
        with open('./contact/conpact15/contact15.txt', 'w') as iofile:
    ...
    try:
        ...
        print("[!] finalfile15.txt not found !(Error3)", err_termin)
        with open('./contact/conpact15/finalfile15.txt', 'a+'):
            print("[+] File finalfile15.txt exist!")

    try:
        with open('./contact/conpact15/finalfile15.txt', 'w') as terminfile:
        ...
        print("[!] finalfile15.txt not created (Error4)", err2_final)
