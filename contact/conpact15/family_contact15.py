...
import os
from contact.conpact15.writerfiles.writefam15 import recorderFam
...
def famWind15(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            try:
                if os.path.exists('./contact/conpact15/famycontact15.txt'):
                    with open('./contact/conpact15/famycontact15.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact15.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact15/famycontact15.txt', 'r') as namefile:
        ...
        print("[!] File famycontact15.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact15.txt not created !", ub_error1)
