...
import os
from contact.conpact7.writerfiles.writefam7 import recorderFam
...
def famWind7(self):
    ...
    def familyData():
        ...
        def readerFamily():
            try:
                if os.path.exists('./contact/conpact7/famycontact7.txt'):
                    with open('./contact/conpact7/famycontact7.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact7.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact7/famycontact7.txt', 'r') as namefile:
        ...
        print("[!] File famycontact7.txt doesn't exist !", callfile)
