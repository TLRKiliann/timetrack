...
def homecsWind2(self):
    ...
    def allInData():
        ...
        try:
            ...
            with open('./contact/conpact2/hcscontact1.txt', 'w') as testf:
        ...
        try:
            if os.path.exists('./contact/conpact2/hcscontact1.txt'):
                with open('./contact/conpact2/hcscontact1.txt', 'r') as policyfile:
        ...
        try:
            ...
            with open('./contact/conpact2/hcscontact2.txt', 'w') as testf:
        ...
        try:
            if os.path.exists('./contact/conpact2/hcscontact2.txt'):
                with open('./contact/conpact2/hcscontact2.txt', 'r') as secondfile:
        ...
        try:
            ...
            with open('./contact/conpact2/hcscontact3.txt', 'w') as testf:
        ...
        try:
            if os.path.exists('./contact/conpact2/hcscontact3.txt'):
                with open('./contact/conpact2/hcscontact3.txt', 'r') as secondfile:
    ...
    def recorderData(namentry, txtphone, phonentry, txtmobile,
        ...
        try:
            with open('./contact/conpact2/hcscontact1.txt', 'w') as iofile:
                ...
                iofile.write("\n" + cityentry.get())
                iofile.write("\n" + entrymail.get())
        except FileNotFoundError as r_fn:
            print("+ File hcscontact1.txt not found (Error6) !", r_fn)
        ...
        try:
            ...
            with open('./contact/conpact2/finalhcs1.txt', 'a+'):
                print("+ finalhcs1.txt exist!")

        try:
            with open('./contact/conpact2/finalhcs1.txt', 'w') as terminfile:
    ...
    def recordersecData(name_twoentry, txt_twophone, twophonentry,
        ...
        try:
            with open('./contact/conpact2/hcscontact2.txt', 'w') as copyfile:
                ...
                copyfile.write("\n" + city_twoentry.get())
                copyfile.write("\n" + entry_twomail.get())
        except FileNotFoundError as r_fn2:
            print("+ File not found (Error10) !", r_fn2)
        ...
        try:
            ...
            with open('./contact/conpact2/finalhcs2.txt', 'a+'):
                print("+ finalhcs2.txt exist!")

        try:
            with open('./contact/conpact2/finalhcs2.txt', 'w') as secterfile:
    ...
    def recorderthirddata(name_thirdentry, txt_thirdphone, thirdphonentry,
        ...
        try:
            with open('./contact/conpact2/hcscontact3.txt', 'w') as copyfile:
                ...
                copyfile.write("\n" + city_thirdentry.get())
                copyfile.write("\n" + entry_thirdmail.get())
        except FileNotFoundError as r_fn3:
            print("+ File not found (Error14) !", r_fn3)
        ...
        try:
            ...
            with open('./contact/conpact2/finalhcs3.txt', 'a+'):
                print("+ finalhcs3.txt exist!")

        try:
            with open('./contact/conpact2/finalhcs3.txt', 'w') as secterfile:
    ...
    try:
        with open('./contact/conpact2/hcscontact1.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact2/hcscontact2.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact2/hcscontact3.txt', 'r') as namefile3:
