...
import os
from contact.conpact2.writerfiles.writepat2 import recorderData
...
def Window2(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            try:
                if os.path.exists('./contact/conpact2/contact2.txt'):
                    with open('./contact/conpact2/contact2.txt', 'r') as policyfile:
                ...
                print("[!] File contact2.txt doesn't exist (Error1)", err_r)
    ...
    try:
        with open('./contact/conpact2/contact2.txt', 'r') as namefile:
        ...
        print("[!] File contact2.txt doesn't exist ! (Error5)", callfile)
