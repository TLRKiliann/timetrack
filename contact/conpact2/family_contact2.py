...
import os
from contact.conpact2.writerfiles.writefam2 import recorderFam
...
def famWind2(self):
    ...
    def familyData():
        ...
        def readerFamily():
            try:
                if os.path.exists('./contact/conpact2/famycontact2.txt'):
                    with open('./contact/conpact2/famycontact2.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact2.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact2/famycontact2.txt', 'r') as namefile:
        ...
        print("[!] File famycontact2.txt doesn't exist !", callfile)
