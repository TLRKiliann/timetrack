...
import os
from contact.conpact14.writerfiles.writepat14 import recorderData
...
def Window14(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            try:
                if os.path.exists('./contact/conpact14/contact14.txt'):
                    with open('./contact/conpact14/contact14.txt', 'r') as policyfile:
                ...
                print("[!] File contact14.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact14/contact14.txt', 'r') as namefile:
        ...
        print("[!] File contact14.txt doesn't exist ! (Error_2)", callfile)
