...
import os
from contact.conpact14.writerfiles.writefam14 import recorderFam
...
def famWind14(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            try:
                if os.path.exists('./contact/conpact14/famycontact14.txt'):
                    with open('./contact/conpact14/famycontact14.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact14.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact14/famycontact14.txt', 'r') as namefile:
        ...
        print("[!] File famycontact14.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact14.txt not created !", ub_error1)
