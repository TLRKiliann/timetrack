...
def famWind14(self):
    ...
    def allInData():
        ...
        try:
            ...
            with open('./contact/conpact14/famycontact1.txt', 'w') as testf:
        ...
        try:
            if os.path.exists('./contact/conpact14/famycontact1.txt'):
                with open('./contact/conpact14/famycontact1.txt', 'r') as policyfile:
    ...
    def recorderData(namentry, txtphone, phonentry, txtmobile,
        ...
        try:
            with open('./contact/conpact14/famycontact1.txt', 'w') as iofile:
        ...
        try:
            if os.path.getsize('./contact/conpact14/finalfam1.txt'):
                os.remove('./contact/conpact14/finalfam1.txt')
        except FileNotFoundError as err_termin:
            print("+ finalfam1 not found !(t2)", err_termin)
            with open('./contact/conpact14/finalfam1.txt', 'a+'):
                print("+ finalfam1.txt exist!")
        try:
            with open('./contact/conpact14/finalfam1.txt', 'w') as terminfile:
    ...
    try:
        with open('./contact/conpact14/famycontact1.txt', 'r') as namefile:
