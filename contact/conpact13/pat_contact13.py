...
import os
from contact.conpact13.writerfiles.writepat13 import recorderData
...
def Window13(self):
    ...
    def allInData():
        ...
        def importationFile():
            try:
                if os.path.exists('./contact/conpact13/contact13.txt'):
                    with open('./contact/conpact13/contact13.txt', 'r') as policyfile:
                ...
                print("[!] File contact13.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact13/contact13.txt', 'r') as namefile:
        ...
        print("[!] File contact13.txt doesn't exist ! (Error_2)", callfile)
