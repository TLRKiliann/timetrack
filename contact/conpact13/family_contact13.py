...
import os
from contact.conpact13.writerfiles.writefam13 import recorderFam
...
def famWind13(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            try:
                if os.path.exists('./contact/conpact13/famycontact13.txt'):
                    with open('./contact/conpact13/famycontact13.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact13.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact13/famycontact13.txt', 'r') as namefile:
        ...
        print("[!] File famycontact13.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact13.txt not created !", ub_error1)
