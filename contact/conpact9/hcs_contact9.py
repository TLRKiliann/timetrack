...
def homecsWind9(self):
    ...
    try:
        with open('./contact/conpact9/hcscontact1.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact9/hcscontact2.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact9/hcscontact3.txt', 'r') as namefile3:
