...
import os
from contact.conpact9.writerfiles.writepat9 import recorderData
...
def Window9(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            try:
                if os.path.exists('./contact/conpact9/contact9.txt'):
                    with open('./contact/conpact9/contact9.txt', 'r') as policyfile:
                ...
                print("[!] File contact9.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact9/contact9.txt', 'r') as namefile:
        ...
        print("[!] File contact9.txt doesn't exist ! (Error_2)", callfile)
