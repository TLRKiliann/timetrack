...
import os
from contact.conpact9.writerfiles.writefam9 import recorderFam
...
def famWind9(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            try:
                if os.path.exists('./contact/conpact9/famycontact9.txt'):
                    with open('./contact/conpact9/famycontact9.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact9.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact9/famycontact9.txt', 'r') as namefile:
        ...
        print("[!] File famycontact9.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact9.txt not created !", ub_error1)
