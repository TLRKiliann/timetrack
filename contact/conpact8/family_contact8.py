...
import os
from contact.conpact8.writerfiles.writefam8 import recorderFam
...
def famWind8(self):
    ...
    def familyData():
        ...
        def readerFamily():
            try:
                if os.path.exists('./contact/conpact8/famycontact8.txt'):
                    with open('./contact/conpact8/famycontact8.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact8.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact8/famycontact8.txt', 'r') as namefile:
        ...
        print("[!] File famycontact8.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact8.txt not created !", ub_error1)
