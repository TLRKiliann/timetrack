...
import os
from contact.conpact8.writerfiles.writepat8 import recorderData
...
def Window8(self):
    ...
    def allInData():
        ...
        def importationFile():
            try:
                if os.path.getsize('./contact/conpact8/contact8.txt'):
                    print("[+] Ok, contact8.txt exist")
            except FileNotFoundError as errfnf:
                print("[!] File contact8.txt doesn't exist (Error2)", errfnf)
                with open('./contact/conpact8/contact8.txt', 'w') as testf:
                    print("[+] File contact8.txt created !")

            try:
                if os.path.exists('./contact/conpact8/contact8.txt'):
                    with open('./contact/conpact8/contact8.txt', 'r') as policyfile:
                ...
                print("[!] File contact8.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact8/contact8.txt', 'r') as namefile:
        ...
        print("[!] File contact8.txt doesn't exist ! (Error_2)", callfile)
