...
import os
from contact.conpact8.writerfiles.writedoc8 import docRecord
from contact.conpact8.writerfiles.writedoc8 import docTwoRecord
from contact.conpact8.writerfiles.writedoc8 import docThreeRecord


def doctorWind8(self):
    """
    ...
    def docData():
        ...
        def numberOneDox():
            try:
                if os.path.exists('./contact/conpact8/contactdoc1.txt'):
                    with open('./contact/conpact8/contactdoc1.txt', 'r') as policyfile:
        ...
        def numberTwoDox():
            try:
                if os.path.exists('./contact/conpact8/contactdoc2.txt'):
                    with open('./contact/conpact8/contactdoc2.txt', 'r') as policydoc:
        ...
        def numbThreeDox():
            try:
                if os.path.exists('./contact/conpact8/contactdoc3.txt'):
                    with open('./contact/conpact8/contactdoc3.txt', 'r') as policydoc3:
    ...
    try:
        with open('./contact/conpact8/contactdoc1.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact8/contactdoc2.txt', 'r') as docfile2:
    ...
    try:
        with open('./contact/conpact8/contactdoc3.txt', 'r') as docfile3:
