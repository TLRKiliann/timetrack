...
import os
from contact.conpact4.writerfiles.writepat4 import recorderData
...
def Window4(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            try:
                if os.path.exists('./contact/conpact4/contact4.txt'):
                    with open('./contact/conpact4/contact4.txt', 'r') as policyfile:
    ...
    try:
        with open('./contact/conpact4/contact4.txt', 'r') as namefile:
