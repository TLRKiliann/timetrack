...
import os
from contact.conpact4.writerfiles.writefam4 import recorderFam
...
def famWind4(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            try:
                if os.path.exists('./contact/conpact4/famycontact4.txt'):
                    with open('./contact/conpact4/famycontact4.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact4.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact4/famycontact4.txt', 'r') as namefile:
        ...
        print("[!] File famycontact4.txt doesn't exist !", callfile)
