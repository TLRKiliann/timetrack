...
def doctorWind4(self):
    ...
    def allInData():
        ...
        try:
            ...
            with open('./contact/conpact4/contactdoc1.txt', 'w') as testf:
        ...
        try:
            if os.path.exists('./contact/conpact4/contactdoc1.txt'):
                with open('./contact/conpact4/contactdoc1.txt', 'r') as policyfile:
        ...
        try:
            ...
            with open('./contact/conpact4/contactdoc2.txt', 'w') as testfd2:
        ...
        try:
            if os.path.exists('./contact/conpact4/contactdoc2.txt'):
                with open('./contact/conpact4/contactdoc2.txt', 'r') as policydoc:
        ...
        try:
            ...
            with open('./contact/conpact4/contactdoc3.txt', 'w') as testfd3:
        ...
        try:
            if os.path.exists('./contact/conpact4/contactdoc3.txt'):
                with open('./contact/conpact4/contactdoc3.txt', 'r') as policydoc3:
    ...
    def recorderData(namentry, txtspec1, specentry1, txtphone,
        ...
        try:
            with open('./contact/conpact4/contactdoc1.txt', 'w') as iofile:
        ...
        try:
            if os.path.getsize('./contact/conpact4/finaldoc1.txt'):
                os.remove('./contact/conpact4/finaldoc1.txt')
    ...
    def recorderDoc2(namentry2, txtspec2, specentry2, txtphone2,
        ...
        try:
            ...
            with open('./contact/conpact4/contactdoc2.txt', 'w') as testf2:
                print("+ File contactdoc2.txt created !", testf2)

        try:
            with open('./contact/conpact4/contactdoc2.txt', 'w') as datadoc:
    ...
    def recorderDoc3(namentry3, txtspec3, specentry3, txtphone3,
        ...
        try:
            ...
            with open('./contact/conpact4/contactdoc3.txt', 'w') as testf3:
                print("+ File contactdoc3.txt created !", testf3)

        try:
            with open('./contact/conpact4/contactdoc3.txt', 'w') as datadoc3:
    ...
    try:
        with open('./contact/conpact4/contactdoc1.txt', 'r') as namefile:
    ...
    try:
        with open('./contact/conpact4/contactdoc2.txt', 'r') as docfile2:
    ...
    try:
        with open('./contact/conpact4/contactdoc3.txt', 'r') as docfile3:
