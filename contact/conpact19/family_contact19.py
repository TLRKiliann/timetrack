...
import os
from contact.conpact19.writerfiles.writefam19 import recorderFam
...
def famWind19(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact19/famycontact19.txt'):
                    print("[+] Ok, famycontact19.txt exist (t2)")
            except FileNotFoundError as err_fnf:
                print("[!] No file famycontact19.txt exist", err_fnf)
                with open('./contact/conpact19/famycontact19.txt', 'w') as testf:
                    print("[+] File famycontact19.txt created !")

            try:
                if os.path.exists('./contact/conpact19/famycontact19.txt'):
                    with open('./contact/conpact19/famycontact19.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact19.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact19/famycontact19.txt', 'r') as namefile:
        ...
        print("[!] File famycontact19.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact19.txt not created !", ub_error1)
