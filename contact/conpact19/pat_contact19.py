...
import os
from contact.conpact19.writerfiles.writepat19 import recorderData
...
def Window19(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact19/contact19.txt'):
                    print("[+] Ok, contact19.txt exist")
            except FileNotFoundError as errfnf:
                print("[!] File contact19.txt doesn't exist (Error_2)", errfnf)
                with open('./contact/conpact19/contact19.txt', 'w') as testf:
                    print("[+] File contact19.txt created !")

            try:
                if os.path.exists('./contact/conpact19/contact19.txt'):
                    with open('./contact/conpact19/contact19.txt', 'r') as policyfile:
                ...
                print("[!] File contact19.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact19/contact19.txt', 'r') as namefile:
        ...
        print("[!] File contact19.txt doesn't exist ! (Error_2)", callfile)
