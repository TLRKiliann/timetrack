...
def recorderFam(self):
    ...
    """
    try:
        with open('./contact/conpact19/famycontact19.txt', 'w') as iofile:
        ...
        print("[!] File famycontact19.txt not found !", fn)
    ...
    try:
        ...
        print("[!] finalfam19.txt not found !(t2)", err_termin)
        with open('./contact/conpact19/finalfam19.txt', 'a+'):
            print("[+] finalfam19.txt exist!")

    try:
        with open('./contact/conpact19/finalfam19.txt', 'w') as terminfile:
        ...
        print("[!] finalfam19.txt not created (t2)", err2_final)
