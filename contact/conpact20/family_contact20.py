...
import os
from contact.conpact20.writerfiles.writefam20 import recorderFam
...
def famWind20(self):
    ...
    def familyData():
        ...
        def readerFamily():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact20/famycontact20.txt'):
                    print("[+] Ok, famycontact20.txt exist (t2)")
            except FileNotFoundError as err_fnf:
                print("[!] No file famycontact20.txt exist", err_fnf)
                with open('./contact/conpact20/famycontact20.txt', 'w') as testf:
                    print("[+] File famycontact20.txt created !")

            try:
                if os.path.exists('./contact/conpact20/famycontact20.txt'):
                    with open('./contact/conpact20/famycontact20.txt', 'r') as policyfile:
                ...
                print("[!] No file famycontact20.txt exist", err_r)
    ...
    try:
        with open('./contact/conpact20/famycontact20.txt', 'r') as namefile:
        ...
        print("[!] File famycontact20.txt doesn't exist !", callfile)
    ...
    try:
        ...
        print("[!] File famycontact20.txt not created !", ub_error1)
