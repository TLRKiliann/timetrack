...
import os
from contact.conpact20.writerfiles.writepat20 import recorderData
...
def Window20(self):
    ...
    def allInData():
        ...
        def importationFile():
            ...
            """
            try:
                if os.path.getsize('./contact/conpact20/contact20.txt'):
                    print("[+] Ok, contact20.txt exist")
            except FileNotFoundError as errfnf:
                print("[!] File contact20.txt doesn't exist (Error_2)", errfnf)
                with open('./contact/conpact20/contact20.txt', 'w') as testf:
                    print("[+] File contact20.txt created !")

            try:
                if os.path.exists('./contact/conpact20/contact20.txt'):
                    with open('./contact/conpact20/contact20.txt', 'r') as policyfile:
                ...
                print("[!] File contact20.txt doesn't exist (Error_1)", err_r)
    ...
    try:
        with open('./contact/conpact20/contact20.txt', 'r') as namefile:
        ...
        print("[!] File contact20.txt doesn't exist ! (Error_2)", callfile)
