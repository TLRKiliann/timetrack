...
def process_unknown_duration(root):
    time.sleep(1)
    proc = subprocess.run(["scp", "./need/doc_suivi18/main_14b.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt18/Files18/main_14b.txt"],
    ...
    secproc = subprocess.run(["scp", "./need/doc_suivi18/patient18_14b.txt",
