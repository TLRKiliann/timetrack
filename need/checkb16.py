...
def recordOption():
    ...
    with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as mfile:
    ...
    if CheckVar1.get() == 1:
        ...
        with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as respfile:
    ...
    if CheckVar2.get() == 1:
        ...
        with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as tempfile:
    ...
    if CheckVar3.get() == 1:
        ...
        with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as hydrafile:
    ...
    if CheckVar4.get() == 1:
        ...
        with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as elimfile:
    ...
    if CheckVar5.get() == 1:
        ...
        with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as somfile:
    ...
    if CheckVar6.get() == 1:
        ...
        with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as mobfile:
    ...
    if CheckVar7.get() == 1:
        ...
        with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as dangerfile:
    ...
    if CheckVar8.get() == 1:
        ...
        with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as skinfile:
    ...
    if CheckVar9.get() == 1:
        ...
        with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as wearfile:
    ...
    if CheckVar10.get() == 1:
        ...
        with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as speakfile:
    ...
    if CheckVar11.get() == 1:
        ...
        with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as prayfile:
    ...
    if CheckVar12.get() == 1:
        ...
        with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as devfile:
    ...
    if CheckVar13.get() == 1:
        ...
        with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as resortfile:
    ...
    if CheckVar14.get() == 1:
        ...
        with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as learnfile:
            learnfile.write("[+] Accompany or assist the person in learning - required\n")
    else:
        print("[---] Nothing to do")

    with open('./need/doc_suivi16/patient16_14b.txt', 'a+') as writefile:
        writefile.write("---\n")
...
def confRec():
    ...
    if proc.stderr == b'':
        ...
        print("[!] No file patient16_14b.txt to upload !")
