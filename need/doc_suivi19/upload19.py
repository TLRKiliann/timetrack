...
def process_unknown_duration(root):
    time.sleep(1)
    proc = subprocess.run(["scp", "./need/doc_suivi19/main_14b.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt19/Files19/main_14b.txt"],
    ...
    secproc = subprocess.run(["scp", "./need/doc_suivi19/patient19_14b.txt",
