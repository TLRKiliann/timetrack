...
class Application(tk.Frame):
    def __init__(self, boss=None):
        ...
        self.b2 = tk.Button(self.can, width=10, font=16, bg='RoyalBlue3', fg='gold',
            activebackground='pale turquoise', bd=3, highlightbackground='light sky blue', 
            text="Add", command=self.lienDirect)
        self.fb2 = self.can.create_window(self.x2, self.y2, window=self.b2)

        self.x3, self.y3 = 400, 250
        self.b3 = tk.Button(self.can, width=10, font=16, bg='RoyalBlue3', fg='gold',
            activebackground='pale turquoise', bd=3, highlightbackground='light sky blue', 
    ...
    def lienDirect(self):
        ...
        try:
            if os.path.getsize('./need/doc_suivi17/patient17_14b.txt'):
                ...
                subprocess.run('./need/doc_suivi17/patient17_write.py', check=True)
    ...
    def commentFileRecNeeds(self):
        self.MsgBox1msg = tk.messagebox.showinfo("Warning", "File '14 needs'"
