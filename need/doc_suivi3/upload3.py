...
def process_unknown_duration(root):
    time.sleep(1)
    proc = subprocess.run(["scp", "./need/doc_suivi3/main_14b.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt3/Files3/main_14b.txt"],
    ...
    if proc.stderr == b'':
        ...
        print("[!] No file main_14b.txt to upload !")
        tk.messagebox.showerror("Error", "No main_14b.txt to upload...")

    secproc = subprocess.run(["scp", "./need/doc_suivi3/patient3_14b.txt",
