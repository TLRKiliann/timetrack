    ...
    def lienDirect(self):
        ...
        try:
            if os.path.getsize('./vmed/doc_vmed15/resultvmed15.txt'):
                ...
                subprocess.run('./vmed/doc_vmed15/vmed_write.py', check=True)
        except FileNotFoundError as outmsg:
            print("+ Sorry, file 'VMED' not exist !", outmsg)
            print("+ File VMED created !!!")
            with open('./vmed/doc_vmed15/resultvmed15.txt', 'w') as file:
    ...
    def lectureFic(self):
        ...
        try:
            if os.path.getsize('./vmed/doc_vmed15/resultvmed15.txt'):
                ...
                subprocess.run('./vmed/doc_vmed15/vmed_read.py', check=True)
