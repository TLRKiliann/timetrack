...
def saveData():
    """
        ...
        it before.
    """
    with open('./vmed/doc_vmed23/resultvmed23.txt', 'a+') as filerecord:
...
def readerFile():
    ...
    """
    with open('./vmed/doc_vmed23/resultvmed23.txt', 'r') as filereader:
...
try:
    if os.path.getsize('./vmed/doc_vmed23/resultvmed23.txt'):
        importationFile('./vmed/doc_vmed23/resultvmed23.txt',
            encodage="Utf-8")
