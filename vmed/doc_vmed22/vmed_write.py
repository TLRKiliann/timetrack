...
def saveData():
    """
        ...
        it before.
    """
    with open('./vmed/doc_vmed22/resultvmed22.txt', 'a+') as filerecord:
...
def uploadfile():
    ...
    if proc.stderr == b'':
        print("+ File resultvmed22.txt uploaded !")
        #messagebox.showinfo("INFO", "resultvmed22.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No resultvmed22.txt to upload...")
...
def readerFile():
    ...
    """
    with open('./vmed/doc_vmed22/resultvmed22.txt', 'r') as filereader:
        print(filereader.read())
    subprocess.call('./vmed/doc_vmed22/vmed_read.py')
...
try:
    if os.path.getsize('./vmed/doc_vmed22/resultvmed22.txt'):
        importationFile('./vmed/doc_vmed22/resultvmed22.txt',
            encodage="Utf-8")
