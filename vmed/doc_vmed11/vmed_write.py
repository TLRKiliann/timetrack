...
def uploadfile():
    ...
    """
    proc = subprocess.run(["scp", "./vmed/doc_vmed11/resultvmed11.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt11/Files11/resultvmed11.txt"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    if proc.stderr == b'':
        print("+ File resultvmed11.txt uploaded !")
        #messagebox.showinfo("INFO", "resultvmed11.txt uploaded...")
    else:
        print("+ No file to upload !")
        messagebox.showerror("Error", "No resultvmed11.txt to upload...")
