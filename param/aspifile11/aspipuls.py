...
file = open('./param/aspifile11/puls.json')
data = json.load(file)
...
with open('./param/aspifile11/data_datepuls.json', 'a+') as datafile:
...
with open('./param/aspifile11/data_puls.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile11/puls.json",
...
subprocess.run('./param/aspifile11/plot/plot_puls.py', check=True)
