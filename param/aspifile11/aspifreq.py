...
file = open('./param/aspifile11/freq.json')
data = json.load(file)
...
with open('./param/aspifile11/data_datefr.json', 'a+') as datafile:
...
with open('./param/aspifile11/data_fr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile11/freq.json",
...
subprocess.run('./param/aspifile11/plot/plot_freq.py', check=True)
