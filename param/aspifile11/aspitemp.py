...
file = open('./param/aspifile11/temp.json')
data = json.load(file)
...
with open('./param/aspifile11/data_datetemp.json', 'a+') as datafile:
...
with open('./param/aspifile11/data_temp.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile11/temp.json",
...
subprocess.run('./param/aspifile11/plot/plot_temp.py', check=True)
