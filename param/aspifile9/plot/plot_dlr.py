...
print("\nListe1 = dates :")
print("--------------")
fileO = open('./param/aspifile9/data_datedlr.json')
...
fileO = open('./param/aspifile9/data_dlr.json')
...
try:
    os.remove('./param/aspifile9/data_datedlr.json')
    print("+ File data_datedlr.json removed !")
    os.remove('./param/aspifile9/data_dlr.json')
