...
file = open('./param/aspifile9/puls.json')
data = json.load(file)
...
with open('./param/aspifile9/data_datepuls.json', 'a+') as datafile:
...
with open('./param/aspifile9/data_puls.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile9/puls.json",
...
subprocess.run('./param/aspifile9/plot/plot_puls.py', check=True)
