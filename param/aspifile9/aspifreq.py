...
file = open('./param/aspifile9/freq.json')
data = json.load(file)
...
with open('./param/aspifile9/data_datefr.json', 'a+') as datafile:
...
with open('./param/aspifile9/data_fr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile9/freq.json",
...
subprocess.run('./param/aspifile9/plot/plot_freq.py', check=True)
