...
file = open('./param/aspifile1/gly.json')
data = json.load(file)
...
with open('./param/aspifile1/data_dategly.json', 'a+') as datafile:
...
with open('./param/aspifile1/data_gly.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile1/gly.json",
...
print("\nLoading 'plot_gly.py'...")
subprocess.run('./param/aspifile1/plot/plot_gly.py', check=True)
