...
file = open('./param/aspifile1/temp.json')
data = json.load(file)
...
with open('./param/aspifile1/data_datetemp.json', 'a+') as datafile:
...
with open('./param/aspifile1/data_temp.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile1/temp.json",
...
subprocess.run('./param/aspifile1/plot/plot_temp.py', check=True)
