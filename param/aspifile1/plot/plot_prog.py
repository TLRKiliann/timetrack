...
try:
    fileO = open('./param/aspifile1/data_date.json')
...
try:
    fileO = open('./param/aspifile1/data_Systol.json')
...
try:
    file3 = open('./param/aspifile1/data_dia.json')
...
try:
    file4 = open('./param/aspifile1/data_Diastol.json')
