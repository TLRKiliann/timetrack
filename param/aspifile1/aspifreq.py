...
file = open('./param/aspifile1/freq.json')
data = json.load(file)
...
with open('./param/aspifile1/data_datefr.json', 'a+') as datafile:
...
with open('./param/aspifile1/data_fr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile1/freq.json",
...
subprocess.run('./param/aspifile1/plot/plot_freq.py', check=True)
