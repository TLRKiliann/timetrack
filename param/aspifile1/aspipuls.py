...
file = open('./param/aspifile1/puls.json')
data = json.load(file)
...
with open('./param/aspifile1/data_datepuls.json', 'a+') as datafile:
...
with open('./param/aspifile1/data_puls.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile1/puls.json",
...
subprocess.run('./param/aspifile1/plot/plot_puls.py', check=True)
