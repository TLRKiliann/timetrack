...
file = open('./param/aspifile6/freq.json')
data = json.load(file)
...
with open('./param/aspifile6/data_datefr.json', 'a+') as datafile:
...
with open('./param/aspifile6/data_fr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile6/freq.json",
...
subprocess.run('./param/aspifile6/plot/plot_freq.py', check=True)
