...
file = open('./param/aspifile6/puls.json')
data = json.load(file)
...
with open('./param/aspifile6/data_datepuls.json', 'a+') as datafile:
...
with open('./param/aspifile6/data_puls.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile6/puls.json",
...
subprocess.run('./param/aspifile6/plot/plot_puls.py', check=True)
