...
file = open('./param/aspifile6/temp.json')
data = json.load(file)
...
with open('./param/aspifile6/data_datetemp.json', 'a+') as datafile:
...
with open('./param/aspifile6/data_temp.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile6/temp.json",
...
subprocess.run('./param/aspifile6/plot/plot_temp.py', check=True)
