...
def writeData(textDate, textHour, textName, textTa, textDia,
    ...
    try:
        ...
        print("[!] File : 'paramdata5.txt' doesn't exist !", info)
        print("[+] File 'paramdata5.txt' created !")
    finally:
        with open('./param/paramdata5.txt', 'a+') as file:
            file.write(str("Date : "))
    ...
    try:
        if os.path.getsize('./param/aspifile5/systol.json'):
            ...
            with open('./param/aspifile5/systol.json', 'r') as datafile:
            ...
            if textTa.get() == "":
                ...
                with open('./param/aspifile5/systol.json', 'w') as datafile2:
    ...
    try:
        if os.path.getsize('./param/aspifile5/diastol.json'):
            ...
            if textDia.get() == "":
                ...
                with open('./param/aspifile5/diastol.json', 'w') as datafile2:
        ...
        if textDia.get() == "":
            ...
            print("[rec] 'Diastol' saved !")
            with open('./param/aspifile5/diastol.json', 'w') as datafile:
                json.dump(dataDia, datafile, indent=4)

    try:
        if os.path.getsize('./param/aspifile5/puls.json'):
            print("[+] File 'puls' exist !")
            with open('./param/aspifile5/puls.json', 'r') as datapuls:
            ...
            if textPuls.get() == "":
                ...
                with open('./param/aspifile5/puls.json', 'w') as datapuls2:
        ...
        if textPuls.get() == "":
            ...
            print("[rec] 'Puls' saved !")
            with open('./param/aspifile5/puls.json', 'w') as datapuls3:
                json.dump(dataP, datapuls3, indent=4)

    try:
        if os.path.getsize('./param/aspifile5/sat.json'):
            print("[+] File 'sat' exist !")
            with open('./param/aspifile5/sat.json', 'r') as datasat:
            ...
            if textSa.get() == "":
                ...
                with open('./param/aspifile5/sat.json', 'w') as datasat2:
    ...
    try:
        if os.path.getsize('./param/aspifile5/freq.json'):
            ...
            if textFr.get() == "":
                ...
                print("[rec] 'FR' saved !")
                with open('./param/aspifile5/freq.json', 'w') as datafreq2:
        ...
        if textFr.get() == "":
            ...
            print("[rec] 'FR' saved !")
            with open('./param/aspifile5/freq.json', 'w') as datafreq3:
                json.dump(dataF, datafreq3, indent=4)

    try:
        if os.path.getsize('./param/aspifile5/temp.json'):
            print("[+] File 'temp' exist !")
            with open('./param/aspifile5/temp.json', 'r') as datatemp:
            ...
            if textTemp.get() == "":
                ...
                with open('./param/aspifile5/temp.json', 'w') as datatemp2:
    ...
    try:
        if os.path.getsize('./param/aspifile5/gly.json'):
            ...
            if textHgt.get() == "":
                ...
                with open('./param/aspifile5/gly.json', 'w') as datagly2:
    ...
    try:
        if os.path.getsize('./param/aspifile5/dlr.json'):
            ...
            if textDlrs.get() == "":
                ...
                with open('./param/aspifile5/dlr.json', 'w') as datadlr2:
        ...
        if textDlrs.get() == "":
            ...
            print("[rec] 'Douleurs' saved !")
            with open('./param/aspifile5/dlr.json', 'w') as datadlr3:
...
def mainRead():
    try:
        if os.path.getsize('./param/main_read5.py'):
...
def appelTens(textDate, textName, textTa, textDia):
    ...
    try:
        if os.path.getsize('./param/aspifile5/systol.json'):
            uploadcall()
            subprocess.run('./param/aspifile5/aspidata.py', check=True)
            label['text'] = ("Date: " + textDate.get() +
                "\nNom: " + textName.get() +
                "\nTension: " + textTa.get() + '/' + textDia.get())
...
def appelPuls(textDate, textName, textPuls):
    ...
    try:
        if os.path.getsize('./param/aspifile5/puls.json'):
            uploadcall()
            subprocess.run('./param/aspifile5/aspipuls.py', check=True)
            label['text'] = ("Date: " + textDate.get() +
                "\nNom: " + textName.get() +
...
def appelSat(textDate, textName, textSa):
    ...
    try:
        if os.path.getsize('./param/aspifile5/sat.json'):
            uploadcall()
            subprocess.run('./param/aspifile5/aspisat.py', check=True)
            label['text'] = ("Date: " + textDate.get() +
                "\nNom: " + textName.get() +
                "\nSaO2: " + textSa.get())
...
def appelFreq(textDate, textName, textFr):
    ...
    try:
        if os.path.getsize('./param/aspifile5/freq.json'):
            uploadcall()
            subprocess.run('./param/aspifile5/aspifreq.py', check=True)
            label['text'] = ("Date: " + textDate.get() +
                "\nNom: " + textName.get() +
...
def appelTemp(textDate, textName, textTemp):
    ...
    try:
        if os.path.getsize('./param/aspifile5/temp.json'):
            uploadcall()
            subprocess.run('./param/aspifile5/aspitemp.py', check=True)
            label['text'] = ("Date: " + textDate.get() +
                "\nNom: " + textName.get() +
                "\nTemperature: " + textTemp.get())
...
def appelGly(textDate, textName, textHgt):
    ...
    try:
        if os.path.getsize('./param/aspifile5/gly.json'):
            uploadcall()
            subprocess.run('./param/aspifile5/aspigly.py', check=True)
            label['text'] = ("Date: " + textDate.get() +
                "\nNom: " + textName.get() +
...
def appelDlr(textDate, textName, textDlrs):
    ...
    try:
        if os.path.getsize('./param/aspifile5/dlr.json'):
            uploadcall()
            subprocess.run('./param/aspifile5/aspidlr.py', check=True)
            label['text'] = ("Date: " + textDate.get() +
                "\nNom: " + textName.get() +
                "\nDouleurs: " + textDlrs.get())
...
def delMain():
    """
        To erase paramdata5.txt
    """
    Main_MsgBox = messagebox.askquestion("Confirm", "Are you sure ?\n"
        "It will delete paramdata5.txt with all data !!!")
    if Main_MsgBox == 'yes':
        try:
            if os.path.getsize('./param/paramdata5.txt'):
                os.remove('./param/paramdata5.txt')
                label['text'] = "File paramdata5.txt has been deleted !"
                print("[del] File paramdata5.txt has been deleted !")
...
def delSystolDia():
    ...
    try:
        if os.path.getsize('./param/aspifile5/systol.json'):
            ...
            for key, value in data.items():
                ...
                print(value[-1])
                del value[-1]
            with open('./param/aspifile5/systol.json', 'w') as file:
                json.dump(data, file, indent=4)
            label['text'] = "[del] Last 'systol.json' has been deleted !"
    ...
    try:
        if os.path.getsize('./param/aspifile5/diastol.json'):
            with open('./param/aspifile5/diastol.json', 'r') as filedia:
                data = json.load(filedia)
            for key, value in data.items():
                print("[del] Last diastol deleted")
                print(value[-1])
                del value[-1]
            with open('./param/aspifile5/diastol.json', 'w') as file:
                json.dump(data, file, indent=4)
            label['text'] = "[del] Last 'diastol.json' has been deleted !"
    ...
    try:
        if os.path.getsize('./param/aspifile5/puls.json'):
            ...
            for key, value in data.items():
                ...
                print(value[-1])
                del value[-1]
            with open('./param/aspifile5/puls.json', 'w') as file:
                json.dump(data, file, indent=4)
            label['text'] = "[del] Last 'puls.json' has been deleted !"
    ...
    try:
        if os.path.getsize('./param/aspifile5/sat.json'):
            ...
            for key, value in data.items():
                ...
                print(value[-1])
                del value[-1]
            with open('./param/aspifile5/sat.json', 'w') as file:
                json.dump(data, file, indent=4)
            label['text'] = "[del] Last 'sat.json' has been deleted !"
    ...
    try:
        if os.path.getsize('./param/aspifile5/freq.json'):
            ...
            for key, value in data.items():
                ...
                print(value[-1])
                del value[-1]
            with open('./param/aspifile5/freq.json', 'w') as file:
                json.dump(data, file, indent=4)
            label['text'] = "[del] Last 'freq.json' has been deleted !"
    ...
    try:
        if os.path.getsize('./param/aspifile5/temp.json'):
            ...
            for key, value in data.items():
                ...
                print(value[-1])
                del value[-1]
            with open('./param/aspifile5/temp.json', 'w') as file:
                json.dump(data, file, indent=4)
            label['text'] = "[del] Last 'temp.json' has been deleted !"
    ...
    try:
        if os.path.getsize('./param/aspifile5/gly.json'):
            ...
            for key, value in data.items():
                ...
                print(value[-1])
                del value[-1]
            with open('./param/aspifile5/gly.json', 'w') as file:
                json.dump(data, file, indent=4)
            label['text'] = "[del] Last 'gly.json' has been deleted !"
    ...
    try:
        if os.path.getsize('./param/aspifile5/dlr.json'):
            ...
            for key, value in data.items():
                ...
                print(value[-1])
                del value[-1]
            with open('./param/aspifile5/dlr.json', 'w') as file:
                json.dump(data, file, indent=4)
            label['text'] = "[del] Last 'dlr.json' has been deleted !"
