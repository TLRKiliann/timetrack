...
file = open('./param/aspifile5/gly.json')
data = json.load(file)
...
with open('./param/aspifile5/data_dategly.json', 'a+') as datafile:
...
with open('./param/aspifile5/data_gly.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile5/gly.json",
...
print("\nLoading 'plot_gly.py'...")
subprocess.run('./param/aspifile5/plot/plot_gly.py', check=True)
