...
file = open('./param/aspifile5/freq.json')
data = json.load(file)
...
with open('./param/aspifile5/data_datefr.json', 'a+') as datafile:
...
with open('./param/aspifile5/data_fr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile5/freq.json",
...
subprocess.run('./param/aspifile5/plot/plot_freq.py', check=True)
