...
file = open('./param/aspifile5/temp.json')
data = json.load(file)
...
with open('./param/aspifile5/data_datetemp.json', 'a+') as datafile:
...
with open('./param/aspifile5/data_temp.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile5/temp.json",
...
subprocess.run('./param/aspifile5/plot/plot_temp.py', check=True)
