...
file = open('./param/aspifile5/sat.json')
data = json.load(file)
...
with open('./param/aspifile5/data_datesat.json', 'a+') as datafile:
...
with open('./param/aspifile5/data_sat.json', 'a+') as datafile:
...
print("\nLoading 'plot_sat.py'...")
subprocess.run('./param/aspifile5/plot/plot_sat.py', check=True)
