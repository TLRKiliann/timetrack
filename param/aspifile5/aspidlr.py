...
file = open('./param/aspifile5/dlr.json')
data = json.load(file)
...
with open('./param/aspifile5/data_datedlr.json', 'a+') as datafile:
...
with open('./param/aspifile5/data_dlr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile5/dlr.json",
...
print("\nLoading 'plot_dlr.py'...")
subprocess.run('./param/aspifile5/plot/plot_dlr.py', check=True)
