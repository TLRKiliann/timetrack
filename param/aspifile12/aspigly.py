...
file = open('./param/aspifile12/gly.json')
data = json.load(file)
...
with open('./param/aspifile12/data_dategly.json', 'a+') as datafile:
...
with open('./param/aspifile12/data_gly.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile12/gly.json",
...
print("\nLoading 'plot_gly.py'...")
subprocess.run('./param/aspifile12/plot/plot_gly.py', check=True)
