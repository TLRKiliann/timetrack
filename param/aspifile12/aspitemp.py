...
file = open('./param/aspifile12/temp.json')
data = json.load(file)
...
with open('./param/aspifile12/data_datetemp.json', 'a+') as datafile:
...
with open('./param/aspifile12/data_temp.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile12/temp.json",
...
subprocess.run('./param/aspifile12/plot/plot_temp.py', check=True)
