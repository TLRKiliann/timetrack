...
file = open('./param/aspifile12/sat.json')
data = json.load(file)
...
with open('./param/aspifile12/data_datesat.json', 'a+') as datafile:
...
with open('./param/aspifile12/data_sat.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile12/sat.json",
...
print("\nLoading 'plot_sat.py'...")
subprocess.run('./param/aspifile12/plot/plot_sat.py', check=True)
