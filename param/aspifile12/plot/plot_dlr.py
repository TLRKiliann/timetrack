...
print("\nListe1 = dates :")
print("--------------")
fileO = open('./param/aspifile12/data_datedlr.json')
...
fileO = open('./param/aspifile12/data_dlr.json')
...
try:
    os.remove('./param/aspifile12/data_datedlr.json')
    print("+ File data_datedlr.json removed !")
    os.remove('./param/aspifile12/data_dlr.json')
