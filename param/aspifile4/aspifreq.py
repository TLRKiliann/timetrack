...
file = open('./param/aspifile4/freq.json')
data = json.load(file)
...
with open('./param/aspifile4/data_datefr.json', 'a+') as datafile:
...
with open('./param/aspifile4/data_fr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile4/freq.json",
...
subprocess.run('./param/aspifile4/plot/plot_freq.py', check=True)
