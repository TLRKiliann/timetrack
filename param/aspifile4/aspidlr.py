...
with open('./param/aspifile4/data_datedlr.json', 'a+') as datafile:
...
with open('./param/aspifile4/data_dlr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile4/dlr.json",
...
print("\nLoading 'plot_dlr.py'...")
subprocess.run('./param/aspifile4/plot/plot_dlr.py', check=True)
