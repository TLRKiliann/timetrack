...
try:
    fileO = open('./param/aspifile4/data_datetemp.json')
...
try:
    file1 = open('./param/aspifile4/data_temp.json')
...
try:
    os.remove('./param/aspifile4/data_datetemp.json')
    print("+ File data_datetemp.json removed !")
    os.remove('./param/aspifile4/data_temp.json')
