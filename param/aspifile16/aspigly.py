...
file = open('./param/aspifile16/gly.json')
data = json.load(file)
...
with open('./param/aspifile16/data_dategly.json', 'a+') as datafile:
...
with open('./param/aspifile16/data_gly.json', 'a+') as datafile:
...
print("\nLoading 'plot_gly.py'...")
subprocess.run('./param/aspifile16/plot/plot_gly.py', check=True)
