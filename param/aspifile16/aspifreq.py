...
file = open('./param/aspifile16/freq.json')
data = json.load(file)
...
with open('./param/aspifile16/data_datefr.json', 'a+') as datafile:
...
with open('./param/aspifile16/data_fr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile16/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt16/freq.json"],
        stderr=subprocess.PIPE)
...
subprocess.run('./param/aspifile16/plot/plot_freq.py', check=True)
