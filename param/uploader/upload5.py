...
def process_unknown_duration(root):
    ...
    if proc.stderr == b'':
        print("[+] File paramdata5.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "paramdata5.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No paramdata5.txt to upload...")

    secproc = subprocess.run(["scp", "./param/aspifile5/diastol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt5/Files5/diastol.json"],
        stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "./param/aspifile5/systol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt5/Files5/systol.json"],
        stderr=subprocess.PIPE)
    ...
    fourproc = subprocess.run(["scp", "./param/aspifile5/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt5/Files5/dlr.json"],
        stderr=subprocess.PIPE)
    ...
    fiveproc = subprocess.run(["scp", "./param/aspifile5/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt5/Files5/freq.json"],
        stderr=subprocess.PIPE)
    ...
    sixproc = subprocess.run(["scp", "./param/aspifile5/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt5/Files5/gly.json"],
        stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "./param/aspifile5/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt5/Files5/puls.json"],
        stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "./param/aspifile5/sat.json",
    ...
    nineproc = subprocess.run(["scp", "./param/aspifile5/temp.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt5/Files5/temp.json"],
        stderr=subprocess.PIPE)
