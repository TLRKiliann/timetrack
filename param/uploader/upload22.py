...
def process_unknown_duration(root):
    ...
    proc = subprocess.run(["scp", "./param/paramdata22.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/paramdata22.txt"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    if proc.stderr == b'':
        print("[+] File paramdata22.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "paramdata22.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No paramdata22.txt to upload...")

    secproc = subprocess.run(["scp", "./param/aspifile22/diastol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/diastol.json"],
        stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "./param/aspifile22/systol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/systol.json"],
        stderr=subprocess.PIPE)
    ...
    fourproc = subprocess.run(["scp", "./param/aspifile22/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/dlr.json"],
        stderr=subprocess.PIPE)
    ...
    fiveproc = subprocess.run(["scp", "./param/aspifile22/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/freq.json"],
        stderr=subprocess.PIPE)
    ...
    sixproc = subprocess.run(["scp", "./param/aspifile22/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/gly.json"],
        stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "./param/aspifile22/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/puls.json"],
        stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "./param/aspifile22/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/sat.json"],
        stderr=subprocess.PIPE)
    ...
    nineproc = subprocess.run(["scp", "./param/aspifile22/temp.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/temp.json"],
        stderr=subprocess.PIPE)
