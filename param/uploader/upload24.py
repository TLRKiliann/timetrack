...
def process_unknown_duration(root):
    ...
    """
    #time.sleep(1)
    proc = subprocess.run(["scp", "./param/paramdata24.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt24/Files24/paramdata24.txt"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    if proc.stderr == b'':
        print("[+] File paramdata24.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "paramdata24.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No paramdata24.txt to upload...")

    secproc = subprocess.run(["scp", "./param/aspifile24/diastol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt24/Files24/diastol.json"],
        stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "./param/aspifile24/systol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt24/Files24/systol.json"],
        stderr=subprocess.PIPE)
    ...
    fourproc = subprocess.run(["scp", "./param/aspifile24/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt24/Files24/dlr.json"],
        stderr=subprocess.PIPE)
    ...
    fiveproc = subprocess.run(["scp", "./param/aspifile24/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt24/Files24/freq.json"],
        stderr=subprocess.PIPE)
    ...
    sixproc = subprocess.run(["scp", "./param/aspifile24/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt24/Files24/gly.json"],
        stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "./param/aspifile24/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt24/Files24/puls.json"],
        stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "./param/aspifile24/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt24/Files24/sat.json"],
        stderr=subprocess.PIPE)
    ...
    nineproc = subprocess.run(["scp", "./param/aspifile24/temp.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt24/Files24/temp.json"],
        stderr=subprocess.PIPE)
