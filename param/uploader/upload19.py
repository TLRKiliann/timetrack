...
def process_unknown_duration(root):
    ...
    """
    #time.sleep(1)
    proc = subprocess.run(["scp", "./param/paramdata19.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt19/Files19/paramdata19.txt"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    if proc.stderr == b'':
        print("[+] File paramdata19.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "paramdata19.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No paramdata19.txt to upload...")

    secproc = subprocess.run(["scp", "./param/aspifile19/diastol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt19/Files19/diastol.json"],
        stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "./param/aspifile19/systol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt19/Files19/systol.json"],
        stderr=subprocess.PIPE)
    ...
    fourproc = subprocess.run(["scp", "./param/aspifile19/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt19/Files19/dlr.json"],
        stderr=subprocess.PIPE)
    ...
    fiveproc = subprocess.run(["scp", "./param/aspifile19/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt19/Files19/freq.json"],
        stderr=subprocess.PIPE)
    ...
    sixproc = subprocess.run(["scp", "./param/aspifile19/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt19/Files19/gly.json"],
        stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "./param/aspifile19/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt19/Files19/puls.json"],
        stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "./param/aspifile19/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt19/Files19/sat.json"],
        stderr=subprocess.PIPE)
    ...
    nineproc = subprocess.run(["scp", "./param/aspifile19/temp.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt19/Files19/temp.json"],
        stderr=subprocess.PIPE)
