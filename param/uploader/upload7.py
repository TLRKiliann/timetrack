...
def process_unknown_duration(root):
    ...
    if proc.stderr == b'':
        print("[+] File paramdata7.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "paramdata7.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No paramdata7.txt to upload...")

    secproc = subprocess.run(["scp", "./param/aspifile7/diastol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt7/Files7/diastol.json"],
        stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "./param/aspifile7/systol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt7/Files7/systol.json"],
        stderr=subprocess.PIPE)
    ...
    fourproc = subprocess.run(["scp", "./param/aspifile7/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt7/Files7/dlr.json"],
        stderr=subprocess.PIPE)
    ...
    fiveproc = subprocess.run(["scp", "./param/aspifile7/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt7/Files7/freq.json"],
        stderr=subprocess.PIPE)
    ...
    sixproc = subprocess.run(["scp", "./param/aspifile7/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt7/Files7/gly.json"],
        stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "./param/aspifile7/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt7/Files7/puls.json"],
        stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "./param/aspifile7/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt7/Files7/sat.json"],
        stderr=subprocess.PIPE)
    ...
    nineproc = subprocess.run(["scp", "./param/aspifile7/temp.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt7/Files7/temp.json"],
        stderr=subprocess.PIPE)
