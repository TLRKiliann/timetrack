...
def process_unknown_duration(root):
    ...
    """
    #time.sleep(1)
    proc = subprocess.run(["scp", "./param/paramdata6.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt6/Files6/paramdata6.txt"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    if proc.stderr == b'':
        print("[+] File paramdata6.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "paramdata6.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No paramdata6.txt to upload...")

    secproc = subprocess.run(["scp", "./param/aspifile6/diastol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt6/Files6/diastol.json"],
        stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "./param/aspifile6/systol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt6/Files6/systol.json"],
        stderr=subprocess.PIPE)
    ...
    fourproc = subprocess.run(["scp", "./param/aspifile6/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt6/Files6/dlr.json"],
        stderr=subprocess.PIPE)
    ...
    fiveproc = subprocess.run(["scp", "./param/aspifile6/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt6/Files6/freq.json"],
        stderr=subprocess.PIPE)
    ...
    sixproc = subprocess.run(["scp", "./param/aspifile6/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt6/Files6/gly.json"],
        stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "./param/aspifile6/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt6/Files6/puls.json"],
        stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "./param/aspifile6/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt6/Files6/sat.json"],
        stderr=subprocess.PIPE)
    ...
    nineproc = subprocess.run(["scp", "./param/aspifile6/temp.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt6/Files6/temp.json"],
        stderr=subprocess.PIPE)
