...
def process_unknown_duration(root):
    ...
    proc = subprocess.run(["scp", "./param/paramdata10.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt10/Files10/paramdata10.txt"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    if proc.stderr == b'':
        print("[+] File paramdata10.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "paramdata10.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No paramdata10.txt to upload...")

    secproc = subprocess.run(["scp", "./param/aspifile10/diastol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt10/Files10/diastol.json"],
        stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "./param/aspifile10/systol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt10/Files10/systol.json"],
        stderr=subprocess.PIPE)
    ...
    fourproc = subprocess.run(["scp", "./param/aspifile10/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt10/Files10/dlr.json"],
        stderr=subprocess.PIPE)
    ...
    fiveproc = subprocess.run(["scp", "./param/aspifile10/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt10/Files10/freq.json"],
        stderr=subprocess.PIPE)
    ...
    sixproc = subprocess.run(["scp", "./param/aspifile10/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt10/Files10/gly.json"],
        stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "./param/aspifile10/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt10/Files10/puls.json"],
        stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "./param/aspifile10/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt10/Files10/sat.json"],
        stderr=subprocess.PIPE)
    ...
    nineproc = subprocess.run(["scp", "./param/aspifile10/temp.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt10/Files10/temp.json"],
        stderr=subprocess.PIPE)
