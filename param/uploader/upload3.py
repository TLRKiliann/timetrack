...
def process_unknown_duration(root):
    ...
    """
    #time.sleep(1)
    proc = subprocess.run(["scp", "./param/paramdata3.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt3/Files3/paramdata3.txt"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    if proc.stderr == b'':
        print("[+] File paramdata3.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "paramdata3.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No paramdata3.txt to upload...")

    secproc = subprocess.run(["scp", "./param/aspifile3/diastol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt3/Files3/diastol.json"],
        stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "./param/aspifile3/systol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt3/Files3/systol.json"],
        stderr=subprocess.PIPE)
    ...
    fourproc = subprocess.run(["scp", "./param/aspifile3/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt3/Files3/dlr.json"],
        stderr=subprocess.PIPE)
    ...
    fiveproc = subprocess.run(["scp", "./param/aspifile3/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt3/Files3/freq.json"],
        stderr=subprocess.PIPE)
    ...
    sixproc = subprocess.run(["scp", "./param/aspifile3/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt3/Files3/gly.json"],
        stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "./param/aspifile3/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt3/Files3/puls.json"],
        stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "./param/aspifile3/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt3/Files3/sat.json"],
        stderr=subprocess.PIPE)
    ...
    nineproc = subprocess.run(["scp", "./param/aspifile3/temp.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt3/Files3/temp.json"],
        stderr=subprocess.PIPE)
