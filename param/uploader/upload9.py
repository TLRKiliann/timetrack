...
def process_unknown_duration(root):
    ...
    if proc.stderr == b'':
        print("[+] File paramdata9.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "paramdata9.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No paramdata9.txt to upload...")

    secproc = subprocess.run(["scp", "./param/aspifile9/diastol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/diastol.json"],
        stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "./param/aspifile9/systol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/systol.json"],
        stderr=subprocess.PIPE)
    ...
    fourproc = subprocess.run(["scp", "./param/aspifile9/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/dlr.json"],
        stderr=subprocess.PIPE)
    ...
    fiveproc = subprocess.run(["scp", "./param/aspifile9/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/freq.json"],
        stderr=subprocess.PIPE)
    ...
    sixproc = subprocess.run(["scp", "./param/aspifile9/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/gly.json"],
        stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "./param/aspifile9/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/puls.json"],
        stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "./param/aspifile9/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/sat.json"],
        stderr=subprocess.PIPE)
    ...
    nineproc = subprocess.run(["scp", "./param/aspifile9/temp.json",
