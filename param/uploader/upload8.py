...
def process_unknown_duration(root):
    ...
    if proc.stderr == b'':
        print("[+] File paramdata8.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "paramdata8.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No paramdata8.txt to upload...")

    secproc = subprocess.run(["scp", "./param/aspifile8/diastol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt8/Files8/diastol.json"],
        stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "./param/aspifile8/systol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt8/Files8/systol.json"],
        stderr=subprocess.PIPE)
    ...
    fourproc = subprocess.run(["scp", "./param/aspifile8/dlr.json",
    ...
    fiveproc = subprocess.run(["scp", "./param/aspifile8/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt8/Files8/freq.json"],
        stderr=subprocess.PIPE)
    ...
    sixproc = subprocess.run(["scp", "./param/aspifile8/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt8/Files8/gly.json"],
        stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "./param/aspifile8/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt8/Files8/puls.json"],
        stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "./param/aspifile8/sat.json",
    ...
    nineproc = subprocess.run(["scp", "./param/aspifile8/temp.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt8/Files8/temp.json"],
        stderr=subprocess.PIPE)
