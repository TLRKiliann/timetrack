...
def process_unknown_duration(root):
    ...
    if proc.stderr == b'':
        print("[+] File paramdata2.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "paramdata2.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No paramdata2.txt to upload...")
    ...
    fourproc = subprocess.run(["scp", "./param/aspifile2/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt2/Files2/dlr.json"],
        stderr=subprocess.PIPE)
    ...
    fiveproc = subprocess.run(["scp", "./param/aspifile2/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt2/Files2/freq.json"],
        stderr=subprocess.PIPE)
    ...
    sixproc = subprocess.run(["scp", "./param/aspifile2/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt2/Files2/gly.json"],
        stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "./param/aspifile2/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt2/Files2/puls.json"],
        stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "./param/aspifile2/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt2/Files2/sat.json"],
        stderr=subprocess.PIPE)
    ...
    nineproc = subprocess.run(["scp", "./param/aspifile2/temp.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt2/Files2/temp.json"],
        stderr=subprocess.PIPE)
