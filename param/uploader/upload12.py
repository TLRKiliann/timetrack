...
def process_unknown_duration(root):
    ...
    """
    #time.sleep(1)
    proc = subprocess.run(["scp", "./param/paramdata12.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/paramdata12.txt"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    if proc.stderr == b'':
        print("[+] File paramdata12.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "paramdata12.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No paramdata12.txt to upload...")

    secproc = subprocess.run(["scp", "./param/aspifile12/diastol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/diastol.json"],
        stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "./param/aspifile12/systol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/systol.json"],
        stderr=subprocess.PIPE)
    ...
    fourproc = subprocess.run(["scp", "./param/aspifile12/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/dlr.json"],
        stderr=subprocess.PIPE)
    ...
    fiveproc = subprocess.run(["scp", "./param/aspifile12/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/freq.json"],
        stderr=subprocess.PIPE)
    ...
    sixproc = subprocess.run(["scp", "./param/aspifile12/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/gly.json"],
        stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "./param/aspifile12/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/puls.json"],
        stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "./param/aspifile12/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/sat.json"],
        stderr=subprocess.PIPE)
    ...
    nineproc = subprocess.run(["scp", "./param/aspifile12/temp.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/temp.json"],
        stderr=subprocess.PIPE)
