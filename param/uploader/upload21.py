...
def process_unknown_duration(root):
    ...
    proc = subprocess.run(["scp", "./param/paramdata21.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt21/Files21/paramdata21.txt"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    if proc.stderr == b'':
        print("[+] File paramdata21.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "paramdata21.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No paramdata21.txt to upload...")

    secproc = subprocess.run(["scp", "./param/aspifile21/diastol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt21/Files21/diastol.json"],
        stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "./param/aspifile21/systol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt21/Files21/systol.json"],
        stderr=subprocess.PIPE)
    ...
    fourproc = subprocess.run(["scp", "./param/aspifile21/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt21/Files21/dlr.json"],
        stderr=subprocess.PIPE)
    ...
    fiveproc = subprocess.run(["scp", "./param/aspifile21/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt21/Files21/freq.json"],
        stderr=subprocess.PIPE)
    ...
    sixproc = subprocess.run(["scp", "./param/aspifile21/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt21/Files21/gly.json"],
        stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "./param/aspifile21/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt21/Files21/puls.json"],
        stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "./param/aspifile21/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt21/Files21/sat.json"],
        stderr=subprocess.PIPE)
    ...
    nineproc = subprocess.run(["scp", "./param/aspifile21/temp.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt21/Files21/temp.json"],
        stderr=subprocess.PIPE)
