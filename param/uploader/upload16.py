...
def process_unknown_duration(root):
    ...
    """
    #time.sleep(1)
    proc = subprocess.run(["scp", "./param/paramdata16.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt16/Files16/paramdata16.txt"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    if proc.stderr == b'':
        print("[+] File paramdata16.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "paramdata16.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No paramdata16.txt to upload...")

    secproc = subprocess.run(["scp", "./param/aspifile16/diastol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt16/Files16/diastol.json"],
        stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "./param/aspifile16/systol.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt16/Files16/systol.json"],
        stderr=subprocess.PIPE)
    ...
    fourproc = subprocess.run(["scp", "./param/aspifile16/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt16/Files16/dlr.json"],
        stderr=subprocess.PIPE)
    ...
    fiveproc = subprocess.run(["scp", "./param/aspifile16/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt16/Files16/freq.json"],
        stderr=subprocess.PIPE)
    ...
    sixproc = subprocess.run(["scp", "./param/aspifile16/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt16/Files16/gly.json"],
        stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "./param/aspifile16/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt16/Files16/puls.json"],
        stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "./param/aspifile16/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt16/Files16/sat.json"],
        stderr=subprocess.PIPE)
    ...
    nineproc = subprocess.run(["scp", "./param/aspifile16/temp.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt16/Files16/temp.json"],
        stderr=subprocess.PIPE)
