...
def process_of_unknown_duration(root):
    ...
    if proc.stderr == b'':
        print("[+] File paramdata9.txt downloaded !")
        #tk.messagebox.showinfo("INFO", "paramdata9.txt downloaded")
    else:
        print("[!] No file to download !")
        tk.messagebox.showerror("Error", "No paramdata9.txt to download !")

    secproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/diastol.json",
        "./param/aspifile9/"], stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/dlr.json",
        "./param/aspifile9/"], stderr=subprocess.PIPE)
    ...
    forthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/freq.json",
        "./param/aspifile9/"], stderr=subprocess.PIPE)
    ...
    fivthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/gly.json",
        "./param/aspifile9/"], stderr=subprocess.PIPE)
    ...
    sixthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/puls.json",
        "./param/aspifile9/"], stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/sat.json",
        "./param/aspifile9/"], stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/systol.json",
        "./param/aspifile9/"], stderr=subprocess.PIPE)
    ...
    ninethproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt9/Files9/temp.json",
        "./param/aspifile9/"], stderr=subprocess.PIPE)
