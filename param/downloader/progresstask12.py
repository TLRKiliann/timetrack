...
def process_of_unknown_duration(root):
    ...
    """
    #time.sleep(1)
    proc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/paramdata12.txt",
        "./param/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    if proc.stderr == b'':
        print("[+] File paramdata12.txt downloaded !")
        #tk.messagebox.showinfo("INFO", "paramdata12.txt downloaded")
    else:
        print("[!] No file to download !")
        tk.messagebox.showerror("Error", "No paramdata12.txt to download !")

    secproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/diastol.json",
    ...
    thirdproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/dlr.json",
        "./param/aspifile12/"], stderr=subprocess.PIPE)
    ...
    forthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/freq.json",
        "./param/aspifile12/"], stderr=subprocess.PIPE)
    ...
    fivthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/gly.json",
        "./param/aspifile12/"], stderr=subprocess.PIPE)
    ...
    sixthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/puls.json",
        "./param/aspifile12/"], stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/sat.json",
        "./param/aspifile12/"], stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/systol.json",
        "./param/aspifile12/"], stderr=subprocess.PIPE)
    ...
    ninethproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/temp.json",
        "./param/aspifile12/"], stderr=subprocess.PIPE)
