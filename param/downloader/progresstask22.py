...
def process_of_unknown_duration(root):
    ...
    """
    #time.sleep(1)
    proc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/paramdata22.txt",
        "./param/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    if proc.stderr == b'':
        print("[+] File paramdata22.txt downloaded !")
        #tk.messagebox.showinfo("INFO", "paramdata22.txt downloaded")
    else:
        print("[!] No file to download !")
        tk.messagebox.showerror("Error", "No paramdata22.txt to download !")

    secproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/diastol.json",
    ...
    thirdproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/dlr.json",
        "./param/aspifile22/"], stderr=subprocess.PIPE)
    ...
    forthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/freq.json",
        "./param/aspifile22/"], stderr=subprocess.PIPE)
    ...
    fivthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/gly.json",
        "./param/aspifile22/"], stderr=subprocess.PIPE)
    ...
    sixthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/puls.json",
        "./param/aspifile22/"], stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/sat.json",
        "./param/aspifile22/"], stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/systol.json",
        "./param/aspifile22/"], stderr=subprocess.PIPE)
    ...
    ninethproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/temp.json",
        "./param/aspifile22/"], stderr=subprocess.PIPE)
