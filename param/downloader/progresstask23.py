...
def process_of_unknown_duration(root):
    ...
    """
    time.sleep(1)
    proc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/Files23/paramdata23.txt",
        "./param/"], stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(proc.stderr))
    if proc.stderr == b'':
        print("[+] File paramdata23.txt downloaded !")
        #tk.messagebox.showinfo("INFO", "paramdata23.txt downloaded")
    else:
        print("[!] No file to download !")
        tk.messagebox.showerror("Error", "No paramdata23.txt to download !")

    secproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/Files23/diastol.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
    ...
    thirdproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/Files23/dlr.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
    ...
    forthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/Files23/freq.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
    ...
    fivthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/Files23/gly.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
    ...
    sixthproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/Files23/puls.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
    ...
    sevenproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/Files23/sat.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
    ...
    eightproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/Files23/systol.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
    ...
    ninethproc = subprocess.run(["scp", "pi@192.168.18.12:~/tt_doc/doc_txt23/Files23/temp.json",
        "./param/aspifile23/"], stderr=subprocess.PIPE)
