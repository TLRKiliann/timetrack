...
file = open('./param/aspifile17/puls.json')
data = json.load(file)
...
with open('./param/aspifile17/data_datepuls.json', 'a+') as datafile:
...
with open('./param/aspifile17/data_puls.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile17/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt17/puls.json"],
        stderr=subprocess.PIPE)
...
subprocess.run('./param/aspifile17/plot/plot_puls.py', check=True)
