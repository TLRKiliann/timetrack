...
file = open('./param/aspifile17/systol.json')
data = json.load(file)
...
with open('./param/aspifile17/data_date.json', 'a+') as datafile:
...
with open('./param/aspifile17/data_Systol.json', 'a+') as datafile:
    json.dump(data_list2, datafile, indent=4)

#second file ttt
filedias = open('./param/aspifile17/diastol.json')
...
with open('./param/aspifile17/data_dia.json', 'a+') as datafiled:
...
subprocess.run('./param/aspifile17/plot/plot_prog.py', check=True)
