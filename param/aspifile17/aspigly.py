...
file = open('./param/aspifile17/gly.json')
data = json.load(file)
...
with open('./param/aspifile17/data_dategly.json', 'a+') as datafile:
...
with open('./param/aspifile17/data_gly.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile17/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt17/gly.json"],
        stderr=subprocess.PIPE)
...
print("\nLoading 'plot_gly.py'...")
subprocess.run('./param/aspifile17/plot/plot_gly.py', check=True)
