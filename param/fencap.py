...
def writeData(textDate, textHour, textName, textTa, textDia,
    ...
    try:
        ...
        print("[!] File : 'paramdata1.txt' doesn't exist !", info)
        print("[+] File 'paramdata1.txt' created !")
    finally:
        with open('./param/paramdata1.txt', 'a+') as file:
            file.write(str("Date : "))
    ...
    try:
        if os.path.getsize('./param/aspifile1/systol.json'):
            ...
            with open('./param/aspifile1/systol.json', 'r') as datafile:
            ...
            if textTa.get() == "":
                ...
                with open('./param/aspifile1/systol.json', 'w') as datafile2:
    ...
    try:
        if os.path.getsize('./param/aspifile1/diastol.json'):
            ...
            if textDia.get() == "":
                ...
                with open('./param/aspifile1/diastol.json', 'w') as datafile2:
        ...
        if textDia.get() == "":
            ...
            print("[rec] 'Diastol' saved !")
            with open('./param/aspifile1/diastol.json', 'w') as datafile:
                json.dump(dataDia, datafile, indent=4)

    try:
        if os.path.getsize('./param/aspifile1/puls.json'):
            print("[+] File 'puls' exist !")
            with open('./param/aspifile1/puls.json', 'r') as datapuls:
            ...
            if textPuls.get() == "":
                ...
                with open('./param/aspifile1/puls.json', 'w') as datapuls2:
        ...
        if textPuls.get() == "":
            ...
            print("[rec] 'Puls' saved !")
            with open('./param/aspifile1/puls.json', 'w') as datapuls3:
                json.dump(dataP, datapuls3, indent=4)

    try:
        if os.path.getsize('./param/aspifile1/sat.json'):
            print("[+] File 'sat' exist !")
            with open('./param/aspifile1/sat.json', 'r') as datasat:
            ...
            if textSa.get() == "":
                ...
                with open('./param/aspifile1/sat.json', 'w') as datasat2:
    ...
    try:
        if os.path.getsize('./param/aspifile1/freq.json'):
            ...
            if textFr.get() == "":
                ...
                print("[rec] 'FR' saved !")
                with open('./param/aspifile1/freq.json', 'w') as datafreq2:
        ...
        if textFr.get() == "":
            ...
            print("[rec] 'FR' saved !")
            with open('./param/aspifile1/freq.json', 'w') as datafreq3:
                json.dump(dataF, datafreq3, indent=4)

    try:
        if os.path.getsize('./param/aspifile1/temp.json'):
            print("[+] File 'temp' exist !")
            with open('./param/aspifile1/temp.json', 'r') as datatemp:
            ...
            if textTemp.get() == "":
                ...
                with open('./param/aspifile1/temp.json', 'w') as datatemp2:
    ...
    try:
        if os.path.getsize('./param/aspifile1/gly.json'):
            ...
            if textHgt.get() == "":
                ...
                with open('./param/aspifile1/gly.json', 'w') as datagly2:
    ...
    try:
        if os.path.getsize('./param/aspifile1/dlr.json'):
            ...
            if textDlrs.get() == "":
                ...
                with open('./param/aspifile1/dlr.json', 'w') as datadlr2:
        ...
        if textDlrs.get() == "":
            ...
            print("[rec] 'Douleurs' saved !")
            with open('./param/aspifile1/dlr.json', 'w') as datadlr3:
...
def mainRead():
    try:
        if os.path.getsize('./param/main_read.py'):
...
def delSystolDia():
    ...
    try:
        if os.path.getsize('./param/aspifile1/systol.json'):
            ...
            for key, value in data.items():
                ...
                print(value[-1])
                del value[-1]
            with open('./param/aspifile1/systol.json', 'w') as file:
    ...
    try:
        if os.path.getsize('./param/aspifile1/diastol.json'):
            with open('./param/aspifile1/diastol.json', 'r') as filedia:
                data = json.load(filedia)
            for key, value in data.items():
                print("[del] Last diastol deleted")
                print(value[-1])
                del value[-1]
            with open('./param/aspifile1/diastol.json', 'w') as file:
                json.dump(data, file, indent=4)
    ...
    try:
        if os.path.getsize('./param/aspifile1/puls.json'):
            ...
            for key, value in data.items():
                ...
                print(value[-1])
                del value[-1]
            with open('./param/aspifile1/puls.json', 'w') as file:
                json.dump(data, file, indent=4)
    ...
    try:
        if os.path.getsize('./param/aspifile1/sat.json'):
            ...
            for key, value in data.items():
                ...
                print(value[-1])
                del value[-1]
            with open('./param/aspifile1/sat.json', 'w') as file:
                json.dump(data, file, indent=4)
    ...
    try:
        if os.path.getsize('./param/aspifile1/freq.json'):
            ...
            for key, value in data.items():
                ...
                print(value[-1])
                del value[-1]
            with open('./param/aspifile1/freq.json', 'w') as file:
                json.dump(data, file, indent=4)
    ...
    try:
        if os.path.getsize('./param/aspifile1/temp.json'):
            ...
            for key, value in data.items():
                ...
                print(value[-1])
                del value[-1]
            with open('./param/aspifile1/temp.json', 'w') as file:
                json.dump(data, file, indent=4)
    ...
    try:
        if os.path.getsize('./param/aspifile1/gly.json'):
            ...
            for key, value in data.items():
                ...
                print(value[-1])
                del value[-1]
            with open('./param/aspifile1/gly.json', 'w') as file:
                json.dump(data, file, indent=4)
    ...
    try:
        if os.path.getsize('./param/aspifile1/dlr.json'):
            ...
            for key, value in data.items():
                ...
                print(value[-1])
                del value[-1]
            with open('./param/aspifile1/dlr.json', 'w') as file:
                json.dump(data, file, indent=4)
...
button1Del.config(text='Cancel last TA', width=15,
    bg='coral', fg='yellow',
    highlightbackground='DodgerBlue2', activeforeground='white',
