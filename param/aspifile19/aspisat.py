...
file = open('./param/aspifile19/sat.json')
data = json.load(file)
...
with open('./param/aspifile19/data_datesat.json', 'a+') as datafile:
...
with open('./param/aspifile19/data_sat.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile19/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt19/sat.json"],
        stderr=subprocess.PIPE)
...
print("\nLoading 'plot_sat.py'...")
subprocess.run('./param/aspifile19/plot/plot_sat.py', check=True)
