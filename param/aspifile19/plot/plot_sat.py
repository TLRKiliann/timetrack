...
print("\nListe1 = dates :")
print("--------------")
fileO = open('./param/aspifile19/data_datesat.json')
...
fileO = open('./param/aspifile19/data_sat.json')
...
try:
    os.remove('./param/aspifile19/data_datesat.json')
    print("+ File data_datesat.json removed !")
    os.remove('./param/aspifile19/data_sat.json')
