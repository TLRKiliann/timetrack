...
file = open('./param/aspifile19/puls.json')
data = json.load(file)
...
with open('./param/aspifile19/data_datepuls.json', 'a+') as datafile:
...
with open('./param/aspifile19/data_puls.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile19/puls.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt19/puls.json"],
        stderr=subprocess.PIPE)
...
subprocess.run('./param/aspifile19/plot/plot_puls.py', check=True)
