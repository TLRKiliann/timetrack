...
file = open('./param/aspifile18/sat.json')
data = json.load(file)
...
with open('./param/aspifile18/data_datesat.json', 'a+') as datafile:
...
with open('./param/aspifile18/data_sat.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile18/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt18/sat.json"],
        stderr=subprocess.PIPE)
...
print("\nLoading 'plot_sat.py'...")
subprocess.run('./param/aspifile18/plot/plot_sat.py', check=True)
