...
file = open('./param/aspifile18/systol.json')
data = json.load(file)
...
with open('./param/aspifile18/data_date.json', 'a+') as datafile:
...
with open('./param/aspifile18/data_Systol.json', 'a+') as datafile:
    json.dump(data_list2, datafile, indent=4)

#second file ttt
filedias = open('./param/aspifile18/diastol.json')
...
with open('./param/aspifile18/data_dia.json', 'a+') as datafiled:
...
subprocess.run('./param/aspifile18/plot/plot_prog.py', check=True)
