...
file = open('./param/aspifile8/systol.json')
data = json.load(file)
...
with open('./param/aspifile8/data_date.json', 'a+') as datafile:
...
with open('./param/aspifile8/data_Systol.json', 'a+') as datafile:
    json.dump(data_list2, datafile, indent=4)

#second file ttt
filedias = open('./param/aspifile8/diastol.json')
...
with open('./param/aspifile8/data_dia.json', 'a+') as datafiled:
...
with open('./param/aspifile8/data_Diastol.json', 'a+') as datafile2d:
...
subprocess.run('./param/aspifile8/plot/plot_prog.py', check=True)
