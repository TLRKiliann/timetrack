...
print("\nListe1 = dates :")
print("--------------")
fileO = open('./param/aspifile8/data_datefr.json')
...
fileO = open('./param/aspifile8/data_fr.json')
...
try:
    os.remove('./param/aspifile8/data_datefr.json')
    print("[+] File data_datefr.json removed !")
    os.remove('./param/aspifile8/data_fr.json')
