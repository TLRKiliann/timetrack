...
file = open('./param/aspifile8/freq.json')
data = json.load(file)
...
with open('./param/aspifile8/data_datefr.json', 'a+') as datafile:
...
with open('./param/aspifile8/data_fr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile8/freq.json",
...
subprocess.run('./param/aspifile8/plot/plot_freq.py', check=True)
