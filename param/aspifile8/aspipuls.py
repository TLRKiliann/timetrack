...
file = open('./param/aspifile8/puls.json')
data = json.load(file)
...
with open('./param/aspifile8/data_datepuls.json', 'a+') as datafile:
...
with open('./param/aspifile8/data_puls.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile8/puls.json",
...
subprocess.run('./param/aspifile8/plot/plot_puls.py', check=True)
