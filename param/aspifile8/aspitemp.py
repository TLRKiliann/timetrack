...
file = open('./param/aspifile8/temp.json')
data = json.load(file)
...
with open('./param/aspifile8/data_datetemp.json', 'a+') as datafile:
...
with open('./param/aspifile8/data_temp.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile8/temp.json",
...
subprocess.run('./param/aspifile8/plot/plot_temp.py', check=True)
