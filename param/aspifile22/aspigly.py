...
file = open('./param/aspifile22/gly.json')
data = json.load(file)
...
with open('./param/aspifile22/data_dategly.json', 'a+') as datafile:
...
with open('./param/aspifile22/data_gly.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile22/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt22/gly.json"],
        stderr=subprocess.PIPE)
...
print("\nLoading 'plot_gly.py'...")
subprocess.run('./param/aspifile22/plot/plot_gly.py', check=True)
