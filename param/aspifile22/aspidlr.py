...
file = open('./param/aspifile22/dlr.json')
data = json.load(file)
...
with open('./param/aspifile22/data_datedlr.json', 'a+') as datafile:
...
with open('./param/aspifile22/data_dlr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile22/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt22/dlr.json"],
        stderr=subprocess.PIPE)
...
print("\nLoading 'plot_dlr.py'...")
subprocess.run('./param/aspifile22/plot/plot_dlr.py', check=True)
