...
file = open('./param/aspifile22/sat.json')
data = json.load(file)
...
with open('./param/aspifile22/data_datesat.json', 'a+') as datafile:
...
with open('./param/aspifile22/data_sat.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile22/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt22/sat.json"],
        stderr=subprocess.PIPE)
...
print("\nLoading 'plot_sat.py'...")
subprocess.run('./param/aspifile22/plot/plot_sat.py', check=True)
