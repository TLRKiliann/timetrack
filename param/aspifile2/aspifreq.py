...
file = open('./param/aspifile2/freq.json')
data = json.load(file)
...
with open('./param/aspifile2/data_datefr.json', 'a+') as datafile:
...
with open('./param/aspifile2/data_fr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile2/freq.json",
...
subprocess.run('./param/aspifile2/plot/plot_freq.py', check=True)
