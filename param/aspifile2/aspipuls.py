...
with open('./param/aspifile2/data_datepuls.json', 'a+') as datafile:
...
with open('./param/aspifile2/data_puls.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile2/puls.json",
...
subprocess.run('./param/aspifile2/plot/plot_puls.py', check=True)
