...
file = open('./param/aspifile2/systol.json')
data = json.load(file)
...
with open('./param/aspifile2/data_Systol.json', 'a+') as datafile:
    json.dump(data_list2, datafile, indent=4)

#second file ttt
filedias = open('./param/aspifile2/diastol.json')
...
with open('./param/aspifile2/data_dia.json', 'a+') as datafiled:
...
with open('./param/aspifile2/data_Diastol.json', 'a+') as datafile2d:
