...
file = open('./param/aspifile2/gly.json')
data = json.load(file)
...
with open('./param/aspifile2/data_dategly.json', 'a+') as datafile:
...
with open('./param/aspifile2/data_gly.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile2/gly.json",
...
print("\nLoading 'plot_gly.py'...")
subprocess.run('./param/aspifile2/plot/plot_gly.py', check=True)
