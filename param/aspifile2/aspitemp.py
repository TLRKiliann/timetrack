...
file = open('./param/aspifile2/temp.json')
data = json.load(file)
...
with open('./param/aspifile2/data_datetemp.json', 'a+') as datafile:
...
with open('./param/aspifile2/data_temp.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile2/temp.json",
...
subprocess.run('./param/aspifile2/plot/plot_temp.py', check=True)
