...
file = open('./param/aspifile10/gly.json')
data = json.load(file)
...
with open('./param/aspifile10/data_dategly.json', 'a+') as datafile:
...
with open('./param/aspifile10/data_gly.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile10/gly.json",
...
print("\nLoading 'plot_gly.py'...")
subprocess.run('./param/aspifile10/plot/plot_gly.py', check=True)
