...
file = open('./param/aspifile10/puls.json')
data = json.load(file)
...
with open('./param/aspifile10/data_datepuls.json', 'a+') as datafile:
...
with open('./param/aspifile10/data_puls.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile10/puls.json",
...
subprocess.run('./param/aspifile10/plot/plot_puls.py', check=True)
