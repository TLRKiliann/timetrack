...
print("\nListe1 = dates :")
print("--------------")
fileO = open('./param/aspifile10/data_dategly.json')
...
fileO = open('./param/aspifile10/data_gly.json')
...
try:
    os.remove('./param/aspifile10/data_dategly.json')
    print("+ File data_dategly.json removed !")
    os.remove('./param/aspifile10/data_gly.json')
