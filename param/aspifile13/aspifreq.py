...
file = open('./param/aspifile13/freq.json')
data = json.load(file)
...
with open('./param/aspifile13/data_datefr.json', 'a+') as datafile:
...
with open('./param/aspifile13/data_fr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile13/freq.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt13/freq.json"],
        stderr=subprocess.PIPE)
...
subprocess.run('./param/aspifile13/plot/plot_freq.py', check=True)
