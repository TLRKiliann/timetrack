...
file = open('./param/aspifile13/dlr.json')
data = json.load(file)
...
with open('./param/aspifile13/data_datedlr.json', 'a+') as datafile:
...
with open('./param/aspifile13/data_dlr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile13/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt13/dlr.json"],
        stderr=subprocess.PIPE)
...
print("\nLoading 'plot_dlr.py'...")
subprocess.run('./param/aspifile13/plot/plot_dlr.py', check=True)
