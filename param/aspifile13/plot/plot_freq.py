...
print("\nListe1 = dates :")
print("--------------")
fileO = open('./param/aspifile13/data_datefr.json')
...
fileO = open('./param/aspifile13/data_fr.json')
...
try:
    ...
    with plt.style.context('seaborn-darkgrid'):
        ...
        plt.plot(reo_x, reo_y, 'o', color='cyan')
...
try:
    os.remove('./param/aspifile13/data_datefr.json')
    print("[+] File data_datefr.json removed !")
    os.remove('./param/aspifile13/data_fr.json')
