...
file = open('./param/aspifile13/sat.json')
data = json.load(file)
...
with open('./param/aspifile13/data_datesat.json', 'a+') as datafile:
...
with open('./param/aspifile13/data_sat.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile13/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt13/sat.json"],
        stderr=subprocess.PIPE)
...
print("\nLoading 'plot_sat.py'...")
subprocess.run('./param/aspifile13/plot/plot_sat.py', check=True)
