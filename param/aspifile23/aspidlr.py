...
file = open('./param/aspifile23/dlr.json')
data = json.load(file)
...
with open('./param/aspifile23/data_datedlr.json', 'a+') as datafile:
...
with open('./param/aspifile23/data_dlr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile23/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt23/dlr.json"],
        stderr=subprocess.PIPE)
...
print("\nLoading 'plot_dlr.py'...")
subprocess.run('./param/aspifile23/plot/plot_dlr.py', check=True)
