...
file = open('./param/aspifile3/dlr.json')
data = json.load(file)
...
with open('./param/aspifile3/data_datedlr.json', 'a+') as datafile:
...
with open('./param/aspifile3/data_dlr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile3/dlr.json",
...
print("\nLoading 'plot_dlr.py'...")
subprocess.run('./param/aspifile3/plot/plot_dlr.py', check=True)
