...
file = open('./param/aspifile3/puls.json')
data = json.load(file)
...
with open('./param/aspifile3/data_datepuls.json', 'a+') as datafile:
...
with open('./param/aspifile3/data_puls.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile3/puls.json",
...
subprocess.run('./param/aspifile3/plot/plot_puls.py', check=True)
