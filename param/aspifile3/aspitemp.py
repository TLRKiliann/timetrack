...
file = open('./param/aspifile3/temp.json')
data = json.load(file)
...
with open('./param/aspifile3/data_datetemp.json', 'a+') as datafile:
...
with open('./param/aspifile3/data_temp.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile3/temp.json",
...
subprocess.run('./param/aspifile3/plot/plot_temp.py', check=True)
