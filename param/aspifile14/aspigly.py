...
file = open('./param/aspifile14/gly.json')
data = json.load(file)
...
with open('./param/aspifile14/data_dategly.json', 'a+') as datafile:
...
with open('./param/aspifile14/data_gly.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile14/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt14/gly.json"],
        stderr=subprocess.PIPE)
...
print("\nLoading 'plot_gly.py'...")
subprocess.run('./param/aspifile14/plot/plot_gly.py', check=True)
