...
file = open('./param/aspifile14/temp.json')
data = json.load(file)
...
with open('./param/aspifile14/data_datetemp.json', 'a+') as datafile:
...
with open('./param/aspifile14/data_temp.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile14/temp.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt14/temp.json"],
        stderr=subprocess.PIPE)
...
subprocess.run('./param/aspifile14/plot/plot_temp.py', check=True)
