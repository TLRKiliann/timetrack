...
file = open('./param/aspifile14/sat.json')
data = json.load(file)
...
with open('./param/aspifile14/data_datesat.json', 'a+') as datafile:
...
with open('./param/aspifile14/data_sat.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile14/sat.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt14/sat.json"],
        stderr=subprocess.PIPE)
...
print("\nLoading 'plot_sat.py'...")
subprocess.run('./param/aspifile14/plot/plot_sat.py', check=True)
