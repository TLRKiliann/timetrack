...
file = open('./param/aspifile24/dlr.json')
data = json.load(file)
...
with open('./param/aspifile24/data_datedlr.json', 'a+') as datafile:
...
with open('./param/aspifile24/data_dlr.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile24/dlr.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt24/dlr.json"],
        stderr=subprocess.PIPE)
