...
file = open('./param/aspifile24/systol.json')
data = json.load(file)
...
with open('./param/aspifile24/data_date.json', 'a+') as datafile:
...
with open('./param/aspifile24/data_Systol.json', 'a+') as datafile:
    json.dump(data_list2, datafile, indent=4)

#second file ttt
filedias = open('./param/aspifile24/diastol.json')
...
with open('./param/aspifile24/data_dia.json', 'a+') as datafiled:
...
subprocess.run('./param/aspifile24/plot/plot_prog.py', check=True)
