...
file = open('./param/aspifile24/gly.json')
data = json.load(file)
...
with open('./param/aspifile24/data_dategly.json', 'a+') as datafile:
...
with open('./param/aspifile24/data_gly.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile24/gly.json",
        "pi@192.168.18.12:~/tt_doc/doc_txt24/gly.json"],
        stderr=subprocess.PIPE)
...
print("\nLoading 'plot_gly.py'...")
subprocess.run('./param/aspifile24/plot/plot_gly.py', check=True)
