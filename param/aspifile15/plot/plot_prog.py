...
try:
    fileO = open('./param/aspifile15/data_date.json')
...
try:
    fileO = open('./param/aspifile15/data_Systol.json')
...
try:
    file3 = open('./param/aspifile15/data_dia.json')
...
try:
    file4 = open('./param/aspifile15/data_Diastol.json')
...
try:
    os.remove('./param/aspifile15/data_date.json')
    os.remove('./param/aspifile15/data_Systol.json')
    print("+ File data_date.json removed !")
    print("+ File data_Systol.json removed !")
    os.remove('./param/aspifile15/data_dia.json')
    os.remove('./param/aspifile15/data_Diastol.json')
