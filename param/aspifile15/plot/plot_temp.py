...
try:
    fileO = open('./param/aspifile15/data_datetemp.json')
...
try:
    file1 = open('./param/aspifile15/data_temp.json')
...
try:
    os.remove('./param/aspifile15/data_datetemp.json')
    print("+ File data_datetemp.json removed !")
    os.remove('./param/aspifile15/data_temp.json')
