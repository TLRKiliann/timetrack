...
file = open('./param/aspifile7/sat.json')
data = json.load(file)
...
with open('./param/aspifile7/data_datesat.json', 'a+') as datafile:
...
with open('./param/aspifile7/data_sat.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile7/sat.json",
...
print("\nLoading 'plot_sat.py'...")
subprocess.run('./param/aspifile7/plot/plot_sat.py', check=True)
