...
file = open('./param/aspifile7/temp.json')
data = json.load(file)
...
with open('./param/aspifile7/data_datetemp.json', 'a+') as datafile:
...
with open('./param/aspifile7/data_temp.json', 'a+') as datafile:
...
try:
    ...
    secproc = subprocess.run(["scp", "./param/aspifile7/temp.json",
...
subprocess.run('./param/aspifile7/plot/plot_temp.py', check=True)
