...
try:
    if os.path.getsize('./param/paramdata1.txt'):
        importationFile('./param/paramdata1.txt', encodage="Utf-8")
except FileNotFoundError as nf_file:
    print("[!] File paramdata for patient 1 not found !", nf_file)
    messagebox.showwarning('Warning', 'File paramdata1.txt not found !')
