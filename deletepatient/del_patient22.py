...
def delFuncFile22():
    ...
    """
    backproc = subprocess.run(["scp", "-r", "-C", "./Backup/Files22",
        "pi@192.168.18.12:~/tt_doc/doc_txt22/Backup22"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(backproc.stderr))
    if backproc.stderr == b'':
        print("[Backup] Backup22 done on server !")
        messagebox.showinfo("INFO", "Backup22 done on server !")
    else:
        print("[!] No Backup22 done on server [!]")
        messagebox.showerror("Error", "!!! No Backup22 done on server !!!")

    delproc = subprocess.run(["ssh",
        "pi@192.168.18.12", "rm -r ~/tt_doc/doc_txt22/Files22/*"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(delproc.stderr))
    if delproc.stderr == b'':
        print("[del] Files22 has been deleted on server !")
        messagebox.showinfo("INFO", "Files22 has been deleted on server !")
    else:
        print("[!] Error", "Not deleted Files22 on server [!]")
        messagebox.showerror("Error", "!!! Not deleted Files22 on server !!!")
    ...
    try:
        if os.path.getsize('./need/doc_suivi22/patient22_14b.txt'):
            ...
            print("[del] File patient22_14b.txt deleted")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt22/stopped_ttt.txt'):
            os.remove('./ttt/doc_ttt22/stopped_ttt.txt')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt22/intro_ts.txt'):
            os.remove('./ttt/doc_ttt22/intro_ts.txt')
            print("[del] File intro_ts.txt deleted (22)")
    except FileNotFoundError as err_ts:
        print("[!] File intro_ts.txt does not exist", err_ts)

    try:
        if os.path.getsize('./ttt/doc_ttt22/report_ttt.txt'):
            os.remove('./ttt/doc_ttt22/report_ttt.txt')
            print("[del] File report_ttt.txt deleted (22)")
    except FileNotFoundError as err_trep:
        print("[!] File report_ttt.txt does not exist", err_trep)

    try:
        if os.path.getsize('./ttt/doc_ttt22/report_res.txt'):
            os.remove('./ttt/doc_ttt22/report_res.txt')
            print("[del] File report_res.txt deleted (22)")
    except FileNotFoundError as err_resrep:
        print("[!] File report_res.txt does not exist", err_resrep)

    try:
        if os.path.getsize('./ttt/doc_ttt22/ires_rs.txt'):
            os.remove('./ttt/doc_ttt22/ires_rs.txt')
            print("[del] File ires_rs.txt deleted (22)")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt22/stopped_res.txt'):
            os.remove('./ttt/doc_ttt22/stopped_res.txt')
    ...
    try:
        if os.path.getsize('./param/paramdata22.txt'):
            ...
            print("[del] File paramdata22.txt deleted")
    ...
    try:
        if os.path.getsize('./calBmi/bmi22.txt'):
            ...
            print("[del] File bmi22.txt deleted")
    ...
    try:
        if os.path.getsize('./diag/doc_diag22/diagrecap22.txt'):
            ...
            print("[del] File diagrecap22.txt deleted")
    ...
    try:
        if os.path.getsize('./labo/doc_labo/result22.txt'):
            ...
            print("[del] File result22.txt deleted")
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed22/resultvmed22.txt'):
            ...
            print("[del] File resultvmed22.txt deleted")
    ...
    try:
        if os.path.getsize('./allergy/allergyfile22.txt'):
            ...
            print("[del] File allergyfile22.txt deleted")
    ...
    try:
        if os.path.getsize('./newpatient/entryfile22.txt'):
            with open('./newpatient/entryfile22.txt', 'w') as file:
                file.write("----------------------")
            print("[del] File entryfile22.txt deleted")
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip22/auxiliary1.txt'):
            os.remove('./auxequip/doc_equip22/auxiliary1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact22/contact1.txt'):
            os.remove('./contact/conpact22/contact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact22/contactdoc1.txt'):
            os.remove('./contact/conpact22/contactdoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact22/contactdoc2.txt'):
            os.remove('./contact/conpact22/contactdoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact22/contactdoc3.txt'):
            os.remove('./contact/conpact22/contactdoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact22/famycontact1.txt'):
            os.remove('./contact/conpact22/famycontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact22/hcscontact1.txt'):
            os.remove('./contact/conpact22/hcscontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact22/hcscontact2.txt'):
            os.remove('./contact/conpact22/hcscontact2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact22/hcscontact3.txt'):
            os.remove('./contact/conpact22/hcscontact3.txt')
    ...
    # Final
    try:
        if os.path.getsize('./contact/conpact22/finalfile22.txt'):
            os.remove('./contact/conpact22/finalfile22.txt')
            print("[del] File finalfile22.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile22.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact22/finalfiledoc1.txt'):
            os.remove('./contact/conpact22/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact22/finaldoc2.txt'):
            os.remove('./contact/conpact22/finaldoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact22/finaldoc3.txt'):
            os.remove('./contact/conpact22/finaldoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact22/finalfam22.txt'):
            os.remove('./contact/conpact22/finalfam22.txt')
            print("[del] File finalfam22.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam22.txt does not exist", err_finalfam)

    try:
        if os.path.getsize('./contact/conpact22/finalhcs1.txt'):
            os.remove('./contact/conpact22/finalhcs1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact22/finalhcs2.txt'):
            os.remove('./contact/conpact22/finalhcs2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact22/finalhcs3.txt'):
            os.remove('./contact/conpact22/finalhcs3.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst22/parcours.txt'):
            os.remove('./medidoc/doc_dmst22/parcours.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst22/pbm.txt'):
            os.remove('./medidoc/doc_dmst22/pbm.txt')
            print("[del] File pbm.txt deleted")
    except FileNotFoundError as filefunc30:
        print("[!] File pbm.txt does not exist", filefunc30)

    try:
        if os.path.getsize('./medidoc/doc_dmst22/project.txt'):
            os.remove('./medidoc/doc_dmst22/project.txt')
            print("[del] File project.txt deleted")
    except FileNotFoundError as filefunc31:
        print("[!] File project.txt does not exist", filefunc31)

    try:
        if os.path.getsize('./medidoc/doc_dmst22/rslt_dmst1.txt'):
            os.remove('./medidoc/doc_dmst22/rslt_dmst1.txt')
    ...
    try:
        if os.path.exists('./Backup/Files22'):
            print("[+] Files22 doc exist !")
            shutil.rmtree('./Backup/Files22')
            print("[del] Files22 doc deleted !")
