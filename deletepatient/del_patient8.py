...
"""
    To delete all files for patient 8
...
def delFuncFile8():
    ...
    """
    backproc = subprocess.run(["scp", "-r", "-C", "./Backup/Files8",
        "pi@192.168.18.12:~/tt_doc/doc_txt8/Backup8"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(backproc.stderr))
    if backproc.stderr == b'':
        print("[Backup] Backup8 done on server !")
        messagebox.showinfo("INFO", "Backup8 done on server !")
    else:
        print("[!] No Backup8 done on server [!]")
        messagebox.showerror("Error", "!!! No Backup8 done on server !!!")

    delproc = subprocess.run(["ssh",
        "pi@192.168.18.12", "rm -r ~/tt_doc/doc_txt8/Files8/*"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(delproc.stderr))
    if delproc.stderr == b'':
        print("[del] Files8 has been deleted on server !")
        messagebox.showinfo("INFO", "Files8 has been deleted on server !")
    else:
        print("[!] Error", "Not deleted Files8 on server [!]")
        messagebox.showerror("Error", "!!! Not deleted Files8 on server !!!")
    ...
    try:
        if os.path.getsize('./need/doc_suivi8/patient8_14b.txt'):
            os.remove('./need/doc_suivi8/patient8_14b.txt')
            print("[del] File patient8_14b.txt deleted")
    except FileNotFoundError as filefunc2:
        print("[!] File patient8_14b.txt does not exist", filefunc2)
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt8/stopped_ttt.txt'):
            os.remove('./ttt/doc_ttt8/stopped_ttt.txt')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt8/intro_ts.txt'):
            os.remove('./ttt/doc_ttt8/intro_ts.txt')
            print("[del] File intro_ts.txt deleted (8)")
    except FileNotFoundError as err_ts:
        print("[!] File intro_ts.txt does not exist", err_ts)

    try:
        if os.path.getsize('./ttt/doc_ttt8/report_ttt.txt'):
            os.remove('./ttt/doc_ttt8/report_ttt.txt')
            print("[del] File report_ttt.txt deleted (8)")
    except FileNotFoundError as err_trep:
        print("[!] File report_ttt.txt does not exist", err_trep)

    try:
        if os.path.getsize('./ttt/doc_ttt8/report_res.txt'):
            os.remove('./ttt/doc_ttt8/report_res.txt')
            print("[del] File report_res.txt deleted (8)")
    except FileNotFoundError as err_resrep:
        print("[!] File report_res.txt does not exist", err_resrep)

    try:
        if os.path.getsize('./ttt/doc_ttt8/ires_rs.txt'):
            os.remove('./ttt/doc_ttt8/ires_rs.txt')
            print("[del] File ires_rs.txt deleted (8)")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt8/stopped_res.txt'):
            os.remove('./ttt/doc_ttt8/stopped_res.txt')
    ...
    try:
        if os.path.getsize('./param/paramdata8.txt'):
            ...
            print("[del] File paramdata8.txt deleted")
    except FileNotFoundError as filefunc61:
        print("[!] File paramdata8.txt does not exist", filefunc61)

    try:
        if os.path.getsize('./param/aspifile8/diastol.json'):
            os.remove('./param/aspifile8/diastol.json')
    ...
    try:
        if os.path.getsize('./param/aspifile8/dlr.json'):
    ...
    try:
        if os.path.getsize('./param/aspifile8/freq.json'):
    ...
    try:
        if os.path.getsize('./param/aspifile8/gly.json'):
    ...
    try:
        if os.path.getsize('./param/aspifile8/puls.json'):
    ...
    try:
        if os.path.getsize('./param/aspifile8/sat.json'):
    ...
    try:
        if os.path.getsize('./param/aspifile8/systol.json'):
            os.remove('./param/aspifile8/systol.json')
            print("[del] File systol.json deleted")
    except FileNotFoundError as filefunc68:
        print("[!] File systol.json does not exist", filefunc68)

    try:
        if os.path.getsize('./param/aspifile8/temp.json'):
    ...
    try:
        if os.path.getsize('./calBmi/doc_BMI8/custom_kg.txt'):
            os.remove('./calBmi/doc_BMI8/custom_kg.txt')
    ...
    try:
        if os.path.getsize('./calBmi/bmi8.txt'):
            ...
            print("[del] File bmi8.txt deleted")
    except FileNotFoundError as filefunc9:
        print("[!] File bmi8.txt does not exist", filefunc9)

    try:
        if os.path.getsize('./diag/doc_diag8/diagrecap8.txt'):
            os.remove('./diag/doc_diag8/diagrecap8.txt')
            print("[del] File diagrecap8.txt deleted")
    except FileNotFoundError as filefunc10:
        print("[!] File diagrecap8.txt does not exist", filefunc10)

    try:
        if os.path.getsize('./labo/doc_labo/result8.txt'):
            os.remove('./labo/doc_labo/result8.txt')
            print("[del] File result8.txt deleted")
    except FileNotFoundError as filefunc11:
        print("[!] File result8.txt does not exist", filefunc11)
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed8/resultvmed8.txt'):
            os.remove('./vmed/doc_vmed8/resultvmed8.txt')
            print("[del] File resultvmed8.txt deleted")
    except FileNotFoundError as filefunc17:
        print("[!] File resultvmed8.txt does not exist", filefunc17)

    try:
        if os.path.getsize('./allergy/allergyfile8.txt'):
            os.remove('./allergy/allergyfile8.txt')
            print("[del] File allergyfile8.txt deleted")
    except FileNotFoundError as filefunc18:
        print("[!] File allergyfile8.txt does not exist", filefunc18)

    try:
        if os.path.getsize('./newpatient/entryfile8.txt'):
            with open('./newpatient/entryfile8.txt', 'w') as file:
                file.write("--------")
            print("[del] File entryfile8.txt deleted")
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip8/auxiliary1.txt'):
            os.remove('./auxequip/doc_equip8/auxiliary1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact8/contact1.txt'):
            os.remove('./contact/conpact8/contact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact8/contactdoc1.txt'):
            os.remove('./contact/conpact8/contactdoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact8/contactdoc2.txt'):
            os.remove('./contact/conpact8/contactdoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact8/contactdoc3.txt'):
            os.remove('./contact/conpact8/contactdoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact8/famycontact1.txt'):
            os.remove('./contact/conpact8/famycontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact8/hcscontact1.txt'):
            os.remove('./contact/conpact8/hcscontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact8/hcscontact2.txt'):
            os.remove('./contact/conpact8/hcscontact2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact8/hcscontact3.txt'):
            os.remove('./contact/conpact8/hcscontact3.txt')
    ...
    # Final
    try:
        if os.path.getsize('./contact/conpact8/finalfile8.txt'):
            os.remove('./contact/conpact8/finalfile8.txt')
            print("[del] File finalfile8.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile8.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact8/finalfiledoc1.txt'):
            os.remove('./contact/conpact8/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact8/finalfam8.txt'):
            ...
            print("[del] File finalfam8.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam8.txt does not exist", err_finalfam)

    try:
        if os.path.getsize('./contact/conpact8/finalhcs1.txt'):
            os.remove('./contact/conpact8/finalhcs1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact8/finalhcs2.txt'):
            os.remove('./contact/conpact8/finalhcs2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact8/finalhcs3.txt'):
            os.remove('./contact/conpact8/finalhcs3.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst8/parcours.txt'):
            os.remove('./medidoc/doc_dmst8/parcours.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst8/pbm.txt'):
            os.remove('./medidoc/doc_dmst8/pbm.txt')
            print("[del] File pbm.txt deleted")
    except FileNotFoundError as filefunc30:
        print("[!] File pbm.txt does not exist", filefunc30)

    try:
        if os.path.getsize('./medidoc/doc_dmst8/project.txt'):
            os.remove('./medidoc/doc_dmst8/project.txt')
            print("[del] File project.txt deleted")
    except FileNotFoundError as filefunc31:
        print("[!] File project.txt does not exist", filefunc31)

    try:
        if os.path.getsize('./medidoc/doc_dmst8/rslt_dmst1.txt'):
            os.remove('./medidoc/doc_dmst8/rslt_dmst1.txt')
    ...
    try:
        if os.path.exists('./Backup/Files8/Backup_param8.txt'):
            print("[+] Backup_param8.txt exist")
            shutil.copy('./Backup/Files8/Backup_param8.txt',
                './Backup/old/oldfiles8/Backup_param8.txt')
            os.remove('./Backup/Files8/Backup_param8.txt')
    except FileNotFoundError as nf_param:
        print("[!] Not found", nf_param)

    try:
        if os.path.exists('./Backup/Files8/Backup_patient8.txt'):
            print("[+] Backup_patient8.txt exist")
            shutil.copy('./Backup/Files8/Backup_patient8.txt',
                './Backup/old/oldfiles8/Backup_patient8.txt')
            os.remove('./Backup/Files8/Backup_patient8.txt')
    except FileNotFoundError as nf_oldfile:
        print("[!] Not found", nf_oldfile)

    try:
        if os.path.exists('./Backup/Files8/Backup_careneeds8.txt'):
            print("[+] Backup_careneeds8.txt exist")
            shutil.copy('./Backup/Files8/Backup_careneeds8.txt',
                './Backup/old/oldfiles8/Backup_careneeds8.txt')
            os.remove('./Backup/Files8/Backup_careneeds8.txt')
    except FileNotFoundError as nf_oldfile2:
        print("[!] Not found", nf_oldfile2)

    try:
        if os.path.exists('./Backup/Files8/Backup_diag8.txt'):
            print("[+] Backup_diag8.txt exist")
            shutil.copy('./Backup/Files8/Backup_diag8.txt',
                './Backup/old/oldfiles8/Backup_diag8.txt')
            os.remove('./Backup/Files8/Backup_diag8.txt')
    except FileNotFoundError as nf_oldfile3:
        print("[!] Not found", nf_oldfile3)

    try:
        if os.path.exists('./Backup/Files8/Backup_Bmi8.txt'):
            print("[+] Backup_Bmi8.txt exist")
            shutil.copy('./Backup/Files8/Backup_Bmi8.txt',
                './Backup/old/oldfiles8/Backup_Bmi8.txt')
            os.remove('./Backup/Files8/Backup_Bmi8.txt')
    except FileNotFoundError as nf_oldfile4:
        print("[!] Not found", nf_oldfile4)

    try:
        if os.path.exists('./Backup/Files8/Backup_resultvmed8.txt'):
            print("[+] Backup_resultvmed8.txt exist")
            shutil.copy('./Backup/Files8/Backup_resultvmed8.txt',
                './Backup/old/oldfiles8/Backup_resultvmed8.txt')
            os.remove('./Backup/Files8/Backup_resultvmed8.txt')
    except FileNotFoundError as nf_oldfile5:
        print("[!] Not found", nf_oldfile5)

    try:
        if os.path.exists('./Backup/Files8/Backup_ttt8.txt'):
            print("[+] Backup_ttt8.txt exist")
            shutil.copy('./Backup/Files8/Backup_ttt8.txt',
                './Backup/old/oldfiles8/Backup_ttt8.txt')
            os.remove('./Backup/Files8/Backup_ttt8.txt')
    except FileNotFoundError as nf_oldfile6:
        print("[!] Not found", nf_oldfile6)

    try:
        if os.path.exists('./Backup/Files8'):
            print("[+] Files8 doc exist !")
            shutil.rmtree('./Backup/Files8')
            print("[del] Files8 doc deleted !")
