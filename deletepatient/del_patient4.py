...
def delFuncFile4():
    ...
    """
    backproc = subprocess.run(["scp", "-r", "-C", "./Backup/Files4",
        "pi@192.168.18.12:~/tt_doc/doc_txt4/Backup4"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(backproc.stderr))
    if backproc.stderr == b'':
        print("[Backup] Backup4 done on server !")
        messagebox.showinfo("INFO", "Backup4 done on server !")
    else:
        print("[!] No Backup4 done on server [!]")
        messagebox.showerror("Error", "!!! No Backup4 done on server !!!")
    ...
    if delproc.stderr == b'':
        print("[del] Files4 has been deleted on server !")
    ...
    try:
        if os.path.getsize('./need/doc_suivi4/patient4_14b.txt'):
            ...
            print("[del] File patient4_14b.txt deleted")
    ...
    except FileNotFoundError as fnf_tttintro:
        print("[!] File intro_ttt.txt does not exist", fnf_tttintro)

    try:
        if os.path.getsize('./ttt/doc_ttt4/stopped_ttt.txt'):
            os.remove('./ttt/doc_ttt4/stopped_ttt.txt')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt4/intro_ts.txt'):
            os.remove('./ttt/doc_ttt4/intro_ts.txt')
            print("[del] File intro_ts.txt deleted (4)")
    except FileNotFoundError as err_ts:
        print("[!] File intro_ts.txt does not exist", err_ts)

    try:
        if os.path.getsize('./ttt/doc_ttt4/report_ttt.txt'):
            os.remove('./ttt/doc_ttt4/report_ttt.txt')
            print("[del] File report_ttt.txt deleted (4)")
    except FileNotFoundError as err_trep:
        print("[!] File report_ttt.txt does not exist", err_trep)

    try:
        if os.path.getsize('./ttt/doc_ttt4/report_res.txt'):
            os.remove('./ttt/doc_ttt4/report_res.txt')
            print("[del] File report_res.txt deleted (4)")
    except FileNotFoundError as err_resrep:
        print("[!] File report_res.txt does not exist", err_resrep)

    try:
        if os.path.getsize('./ttt/doc_ttt4/ires_rs.txt'):
            os.remove('./ttt/doc_ttt4/ires_rs.txt')
            print("[del] File ires_rs.txt deleted (4)")
    ...
    except FileNotFoundError as fnf_resintro:
        print("[!] File intro_res.txt does not exist", fnf_resintro)

    try:
        if os.path.getsize('./ttt/doc_ttt4/stopped_res.txt'):
            os.remove('./ttt/doc_ttt4/stopped_res.txt')
    ...
    try:
        if os.path.getsize('./param/paramdata4.txt'):
            ...
            print("[del] File paramdata4.txt deleted")
    ...
    try:
        if os.path.getsize('./calBmi/doc_BMI4/file_bmi.json'):
            ...
            print("[del] File bmi.json deleted")
    ...
    try:
        if os.path.getsize('./calBmi/bmi4.txt'):
            ...
            print("[del] File bmi4.txt deleted")
    ...
    try:
        if os.path.getsize('./diag/doc_diag4/diagrecap4.txt'):
            ...
            print("[del] File diagrecap4.txt deleted")
    ...
    try:
        if os.path.getsize('./labo/doc_labo/result4.txt'):
            ...
            print("[del] File result4.txt deleted")
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed4/resultvmed4.txt'):
            ...
            print("[del] File resultvmed4.txt.txt deleted")
    ...
    try:
        if os.path.getsize('./allergy/allergyfile4.txt'):
            ...
            print("[del] File allergyfile4.txt deleted")
    ...
    try:
        if os.path.getsize('./newpatient/entryfile4.txt'):
            with open('./newpatient/entryfile4.txt', 'w') as file:
                file.write("----")
            print("[del] File entryfile4.txt reborn")
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip4/auxiliary1.txt'):
            os.remove('./auxequip/doc_equip4/auxiliary1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact4/contact1.txt'):
            os.remove('./contact/conpact4/contact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact4/contactdoc1.txt'):
            os.remove('./contact/conpact4/contactdoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact4/contactdoc2.txt'):
            os.remove('./contact/conpact4/contactdoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact4/contactdoc3.txt'):
            os.remove('./contact/conpact4/contactdoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact4/famycontact1.txt'):
            os.remove('./contact/conpact4/famycontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact4/hcscontact1.txt'):
            os.remove('./contact/conpact4/hcscontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact4/hcscontact2.txt'):
            os.remove('./contact/conpact4/hcscontact2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact4/hcscontact3.txt'):
            os.remove('./contact/conpact4/hcscontact3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact4/finalfile4.txt'):
            ...
            print("[del] File finalfile4.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile4.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact4/finalfiledoc1.txt'):
            os.remove('./contact/conpact4/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact4/finaldoc2.txt'):
            os.remove('./contact/conpact4/finaldoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact4/finaldoc3.txt'):
            os.remove('./contact/conpact4/finaldoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact4/finalfam4.txt'):
            ...
            print("[del] File finalfam4.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam4.txt does not exist", err_finalfam)

    try:
        if os.path.getsize('./contact/conpact4/finalhcs1.txt'):
            os.remove('./contact/conpact4/finalhcs1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact4/finalhcs2.txt'):
            os.remove('./contact/conpact4/finalhcs2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact4/finalhcs3.txt'):
            os.remove('./contact/conpact4/finalhcs3.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst4/parcours.txt'):
            os.remove('./medidoc/doc_dmst4/parcours.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst4/pbm.txt'):
            os.remove('./medidoc/doc_dmst4/pbm.txt')
            print("[del] File pbm.txt deleted")
    except FileNotFoundError as filefunc30:
        print("[!] File pbm.txt does not exist", filefunc30)

    try:
        if os.path.getsize('./medidoc/doc_dmst4/project.txt'):
            os.remove('./medidoc/doc_dmst4/project.txt')
            print("[del] File project.txt deleted")
    except FileNotFoundError as filefunc31:
        print("[!] File project.txt does not exist", filefunc31)

    try:
        if os.path.getsize('./medidoc/doc_dmst4/rslt_dmst1.txt'):
            os.remove('./medidoc/doc_dmst4/rslt_dmst1.txt')
    ...
    try:
        if os.path.exists('./Backup/Files4'):
            print("[+] Files4 doc exist !")
            shutil.rmtree('./Backup/Files4')
            print("[del] Files4 doc deleted !")
