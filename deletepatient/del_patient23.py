...
def delFuncFile23():
    ...
    try:
        if os.path.getsize('./contact/conpact23/finalfile23.txt'):
            ...
            print("[del] File finalfile23.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile23.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact23/finalfiledoc1.txt'):
            os.remove('./contact/conpact23/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact23/finalfam23.txt'):
            os.remove('./contact/conpact23/finalfam23.txt')
            print("[del] File finalfam23.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam23.txt does not exist", err_finalfam)
