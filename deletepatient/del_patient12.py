...
def delFuncFile12():
    ...
    """
    backproc = subprocess.run(["scp", "-r", "-C", "./Backup/Files12",
        "pi@192.168.18.12:~/tt_doc/doc_txt12/Backup12"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(backproc.stderr))
    if backproc.stderr == b'':
        print("[Backup] Backup12 done on server !")
        messagebox.showinfo("INFO", "Backup12 done on server !")
    else:
        print("[!] No Backup12 done on server [!]")
        messagebox.showerror("Error", "!!! No Backup12 done on server !!!")

    delproc = subprocess.run(["ssh",
        "pi@192.168.18.12", "rm -r ~/tt_doc/doc_txt12/Files12/*"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(delproc.stderr))
    if delproc.stderr == b'':
        print("[del] Files12 has been deleted on server !")
        messagebox.showinfo("INFO", "Files12 has been deleted on server !")
    else:
        print("[!] Error", "Not deleted Files12 on server [!]")
        messagebox.showerror("Error", "!!! Not deleted Files12 on server !!!")
    ...
    try:
        if os.path.getsize('./need/doc_suivi12/patient12_14b.txt'):
            ...
            print("[del] File patient12_14b.txt deleted")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt12/stopped_ttt.txt'):
            os.remove('./ttt/doc_ttt12/stopped_ttt.txt')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt12/intro_ts.txt'):
            os.remove('./ttt/doc_ttt12/intro_ts.txt')
            print("[del] File intro_ts.txt deleted (12)")
    except FileNotFoundError as err_ts:
        print("[!] File intro_ts.txt does not exist", err_ts)

    try:
        if os.path.getsize('./ttt/doc_ttt12/report_ttt.txt'):
            os.remove('./ttt/doc_ttt12/report_ttt.txt')
            print("[del] File report_ttt.txt deleted (12)")
    except FileNotFoundError as err_trep:
        print("[!] File report_ttt.txt does not exist", err_trep)

    try:
        if os.path.getsize('./ttt/doc_ttt12/report_res.txt'):
            os.remove('./ttt/doc_ttt12/report_res.txt')
            print("[del] File report_res.txt deleted (12)")
    except FileNotFoundError as err_resrep:
        print("[!] File report_res.txt does not exist", err_resrep)

    try:
        if os.path.getsize('./ttt/doc_ttt12/ires_rs.txt'):
            os.remove('./ttt/doc_ttt12/ires_rs.txt')
            print("[del] File ires_rs.txt deleted (12)")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt12/stopped_res.txt'):
            os.remove('./ttt/doc_ttt12/stopped_res.txt')
    ...
    try:
        if os.path.getsize('./param/paramdata12.txt'):
            ...
            print("[del] File paramdata12.txt deleted")
    ...
    try:
        if os.path.getsize('./calBmi/bmi12.txt'):
            ...
            print("[del] File bmi12.txt deleted")
    ...
    try:
        if os.path.getsize('./diag/doc_diag12/diagrecap12.txt'):
            ...
            print("[del] File diagrecap12.txt deleted")
    ...
    try:
        if os.path.getsize('./labo/doc_labo/result12.txt'):
            ...
            print("[del] File result12.txt deleted")
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed12/resultvmed12.txt'):
            ...
            print("[del] File resultvmed12.txt deleted")
    ...
    try:
        if os.path.getsize('./allergy/allergyfile12.txt'):
            ...
            print("[del] File allergyfile12.txt deleted")
    ...
    try:
        if os.path.getsize('./newpatient/entryfile12.txt'):
            with open('./newpatient/entryfile12.txt', 'w') as file:
                file.write("------------")
            print("[del] File entryfile12.txt deleted")
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip12/auxiliary1.txt'):
            os.remove('./auxequip/doc_equip12/auxiliary1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact12/contact1.txt'):
            os.remove('./contact/conpact12/contact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact12/contactdoc1.txt'):
            os.remove('./contact/conpact12/contactdoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact12/contactdoc2.txt'):
            os.remove('./contact/conpact12/contactdoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact12/contactdoc3.txt'):
            os.remove('./contact/conpact12/contactdoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact12/famycontact1.txt'):
            os.remove('./contact/conpact12/famycontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact12/hcscontact1.txt'):
            os.remove('./contact/conpact12/hcscontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact12/hcscontact2.txt'):
            os.remove('./contact/conpact12/hcscontact2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact12/hcscontact3.txt'):
            os.remove('./contact/conpact12/hcscontact3.txt')
    ...
    # Final
    try:
        if os.path.getsize('./contact/conpact12/finalfile12.txt'):
            os.remove('./contact/conpact12/finalfile12.txt')
            print("[del] File finalfile12.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile12.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact12/finalfiledoc1.txt'):
            os.remove('./contact/conpact12/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact12/finaldoc2.txt'):
            os.remove('./contact/conpact12/finaldoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact12/finaldoc3.txt'):
            os.remove('./contact/conpact12/finaldoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact12/finalfam12.txt'):
            ...
            print("[del] File finalfam12.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam12.txt does not exist", err_finalfam)

    try:
        if os.path.getsize('./contact/conpact12/finalhcs1.txt'):
            os.remove('./contact/conpact12/finalhcs1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact12/finalhcs2.txt'):
            os.remove('./contact/conpact12/finalhcs2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact12/finalhcs3.txt'):
            os.remove('./contact/conpact12/finalhcs3.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst12/parcours.txt'):
            os.remove('./medidoc/doc_dmst12/parcours.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst12/pbm.txt'):
            os.remove('./medidoc/doc_dmst12/pbm.txt')
            print("[del] File pbm.txt deleted")
    except FileNotFoundError as filefunc30:
        print("[!] File pbm.txt does not exist", filefunc30)

    try:
        if os.path.getsize('./medidoc/doc_dmst12/project.txt'):
            os.remove('./medidoc/doc_dmst12/project.txt')
            print("[del] File project.txt deleted")
    except FileNotFoundError as filefunc31:
        print("[!] File project.txt does not exist", filefunc31)

    try:
        if os.path.getsize('./medidoc/doc_dmst12/rslt_dmst1.txt'):
            os.remove('./medidoc/doc_dmst12/rslt_dmst1.txt')
    ...
    try:
        if os.path.exists('./Backup/Files12'):
            print("[+] Files12 doc exist !")
            shutil.rmtree('./Backup/Files12')
            print("[del] Files12 doc deleted !")
