...
def delFuncFile10():
    ...
    """
    backproc = subprocess.run(["scp", "-r", "-C", "./Backup/Files10",
        "pi@192.168.18.12:~/tt_doc/doc_txt10/Backup10"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(backproc.stderr))
    if backproc.stderr == b'':
        print("[Backup] Backup10 done on server !")
        messagebox.showinfo("INFO", "Backup10 done on server !")
    else:
        print("[!] No Backup10 done on server [!]")
        messagebox.showerror("Error", "!!! No Backup10 done on server !!!")

    delproc = subprocess.run(["ssh",
        "pi@192.168.18.12", "rm -r ~/tt_doc/doc_txt10/Files10/*"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(delproc.stderr))
    if delproc.stderr == b'':
        print("[del] Files10 has been deleted on server !")
        messagebox.showinfo("INFO", "Files10 has been deleted on server !")
    else:
        print("[!] Error", "Not deleted Files10 on server [!]")
        messagebox.showerror("Error", "!!! Not deleted Files10 on server !!!")
    ...
    try:
        if os.path.getsize('./need/doc_suivi10/patient10_14b.txt'):
            ...
            print("[del] File patient10_14b.txt deleted")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt10/stopped_ttt.txt'):
            os.remove('./ttt/doc_ttt10/stopped_ttt.txt')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt10/intro_ts.txt'):
            os.remove('./ttt/doc_ttt10/intro_ts.txt')
            print("[del] File intro_ts.txt deleted (10)")
    except FileNotFoundError as err_ts:
        print("[!] File intro_ts.txt does not exist", err_ts)

    try:
        if os.path.getsize('./ttt/doc_ttt10/report_ttt.txt'):
            os.remove('./ttt/doc_ttt10/report_ttt.txt')
            print("[del] File report_ttt.txt deleted (10)")
    except FileNotFoundError as err_trep:
        print("[!] File report_ttt.txt does not exist", err_trep)

    try:
        if os.path.getsize('./ttt/doc_ttt10/report_res.txt'):
            os.remove('./ttt/doc_ttt10/report_res.txt')
            print("[del] File report_res.txt deleted (10)")
    except FileNotFoundError as err_resrep:
        print("[!] File report_res.txt does not exist", err_resrep)

    try:
        if os.path.getsize('./ttt/doc_ttt10/ires_rs.txt'):
            os.remove('./ttt/doc_ttt10/ires_rs.txt')
            print("[del] File ires_rs.txt deleted (10)")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt10/stopped_res.txt'):
            os.remove('./ttt/doc_ttt10/stopped_res.txt')
    ...
    try:
        if os.path.getsize('./param/paramdata10.txt'):
            ...
            print("[del] File paramdata10.txt deleted")
    ...
    try:
        if os.path.getsize('./calBmi/bmi10.txt'):
            ...
            print("[del] File bmi10.txt deleted")
    ...
    try:
        if os.path.getsize('./diag/doc_diag10/diagrecap10.txt'):
            ...
            print("[del] File diagrecap10.txt deleted")
    ...
    try:
        if os.path.getsize('./labo/doc_labo/result10.txt'):
            ...
            print("[del] File result10.txt deleted")
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed10/resultvmed10.txt'):
            ...
            print("[del] File resultvmed10.txt deleted")
    ...
    try:
        if os.path.getsize('./allergy/allergyfile10.txt'):
            ...
            print("[del] File allergyfile10.txt deleted")
    ...
    try:
        if os.path.getsize('./newpatient/entryfile10.txt'):
            with open('./newpatient/entryfile10.txt', 'w') as file:
                file.write("----------")
            print("[del] File entryfile10.txt deleted")
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip10/auxiliary1.txt'):
            os.remove('./auxequip/doc_equip10/auxiliary1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact10/contact1.txt'):
            os.remove('./contact/conpact10/contact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact10/contactdoc1.txt'):
            os.remove('./contact/conpact10/contactdoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact10/contactdoc2.txt'):
            os.remove('./contact/conpact10/contactdoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact10/contactdoc3.txt'):
            os.remove('./contact/conpact10/contactdoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact10/famycontact1.txt'):
            os.remove('./contact/conpact10/famycontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact10/hcscontact1.txt'):
            os.remove('./contact/conpact10/hcscontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact10/hcscontact2.txt'):
            os.remove('./contact/conpact10/hcscontact2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact10/hcscontact3.txt'):
            os.remove('./contact/conpact10/hcscontact3.txt')
    ...
    # Final
    try:
        if os.path.getsize('./contact/conpact10/finalfile10.txt'):
            os.remove('./contact/conpact10/finalfile10.txt')
            print("[del] File finalfile10.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile10.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact10/finalfiledoc1.txt'):
            os.remove('./contact/conpact10/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact10/finaldoc2.txt'):
            os.remove('./contact/conpact10/finaldoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact10/finaldoc3.txt'):
            os.remove('./contact/conpact10/finaldoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact10/finalfam10.txt'):
            os.remove('./contact/conpact10/finalfam10.txt')
            print("[del] File finalfam10.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam10.txt does not exist", err_finalfam)

    try:
        if os.path.getsize('./contact/conpact10/finalhcs1.txt'):
            os.remove('./contact/conpact10/finalhcs1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact10/finalhcs2.txt'):
            os.remove('./contact/conpact10/finalhcs2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact10/finalhcs3.txt'):
            os.remove('./contact/conpact10/finalhcs3.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst10/parcours.txt'):
            os.remove('./medidoc/doc_dmst10/parcours.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst10/pbm.txt'):
            os.remove('./medidoc/doc_dmst10/pbm.txt')
            print("[del] File pbm.txt deleted")
    except FileNotFoundError as filefunc30:
        print("[!] File pbm.txt does not exist", filefunc30)

    try:
        if os.path.getsize('./medidoc/doc_dmst10/project.txt'):
            os.remove('./medidoc/doc_dmst10/project.txt')
            print("[del] File project.txt deleted")
    except FileNotFoundError as filefunc31:
        print("[!] File project.txt does not exist", filefunc31)

    try:
        if os.path.getsize('./medidoc/doc_dmst10/rslt_dmst1.txt'):
            os.remove('./medidoc/doc_dmst10/rslt_dmst1.txt')
    ...
    try:
        if os.path.exists('./Backup/Files10'):
            print("[+] Files10 doc exist !")
            shutil.rmtree('./Backup/Files10')
            print("[del] Files10 doc deleted !")
