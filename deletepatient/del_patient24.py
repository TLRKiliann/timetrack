...
def delFuncFile24():
    ...
    if delproc.stderr == b'':
        print("[del] Files24 has been deleted on server !")
    ...
    try:
        if os.path.getsize('./need/doc_suivi24/patient24_14b.txt'):
            ...
            print("[del] File patient24_14b.txt deleted")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt24/stopped_ttt.txt'):
            os.remove('./ttt/doc_ttt24/stopped_ttt.txt')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt24/intro_ts.txt'):
            os.remove('./ttt/doc_ttt24/intro_ts.txt')
            print("[del] File intro_ts.txt deleted (24)")
    except FileNotFoundError as err_ts:
        print("[!] File intro_ts.txt does not exist", err_ts)

    try:
        if os.path.getsize('./ttt/doc_ttt24/report_ttt.txt'):
            os.remove('./ttt/doc_ttt24/report_ttt.txt')
            print("[del] File report_ttt.txt deleted (24)")
    except FileNotFoundError as err_trep:
        print("[!] File report_ttt.txt does not exist", err_trep)

    try:
        if os.path.getsize('./ttt/doc_ttt24/report_res.txt'):
            os.remove('./ttt/doc_ttt24/report_res.txt')
            print("[del] File report_res.txt deleted (24)")
    except FileNotFoundError as err_resrep:
        print("[!] File report_res.txt does not exist", err_resrep)

    try:
        if os.path.getsize('./ttt/doc_ttt24/ires_rs.txt'):
            os.remove('./ttt/doc_ttt24/ires_rs.txt')
            print("[del] File ires_rs.txt deleted (24)")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt24/stopped_res.txt'):
            os.remove('./ttt/doc_ttt24/stopped_res.txt')
    ...
    try:
        if os.path.getsize('./param/paramdata24.txt'):
            ...
            print("[del] File paramdata24.txt deleted")
    ...
    try:
        if os.path.getsize('./calBmi/bmi24.txt'):
            ...
            print("[del] File bmi24.txt deleted")
    ...
    try:
        if os.path.getsize('./diag/doc_diag24/diagrecap24.txt'):
            ...
            print("[del] File diagrecap24.txt deleted")
    ...
    try:
        if os.path.getsize('./labo/doc_labo/result24.txt'):
            ...
            print("[del] File result24.txt deleted")
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed24/resultvmed24.txt'):
            ...
            print("[del] File resultvmed24.txt deleted")
    ...
    try:
        if os.path.getsize('./allergy/allergyfile24.txt'):
            ...
            print("[del] File allergyfile24.txt deleted")
    ...
    try:
        if os.path.getsize('./newpatient/entryfile24.txt'):
            with open('./newpatient/entryfile24.txt', 'w') as file:
                file.write("------------------------")
            print("[del] File entryfile24.txt deleted")
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip24/auxiliary1.txt'):
            os.remove('./auxequip/doc_equip24/auxiliary1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact24/contact1.txt'):
            os.remove('./contact/conpact24/contact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact24/contactdoc1.txt'):
            os.remove('./contact/conpact24/contactdoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact24/contactdoc2.txt'):
            os.remove('./contact/conpact24/contactdoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact24/contactdoc3.txt'):
            os.remove('./contact/conpact24/contactdoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact24/famycontact1.txt'):
            os.remove('./contact/conpact24/famycontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact24/hcscontact1.txt'):
            os.remove('./contact/conpact24/hcscontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact24/hcscontact2.txt'):
            os.remove('./contact/conpact24/hcscontact2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact24/hcscontact3.txt'):
            os.remove('./contact/conpact24/hcscontact3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact24/finalfile24.txt'):
            ...
            print("[del] File finalfile24.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile24.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact24/finalfiledoc1.txt'):
            os.remove('./contact/conpact24/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact24/finaldoc2.txt'):
            os.remove('./contact/conpact24/finaldoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact24/finaldoc3.txt'):
            os.remove('./contact/conpact24/finaldoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact24/finalfam24.txt'):
            os.remove('./contact/conpact24/finalfam24.txt')
            print("[del] File finalfam24.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam24.txt does not exist", err_finalfam)

    try:
        if os.path.getsize('./contact/conpact24/finalhcs1.txt'):
            os.remove('./contact/conpact24/finalhcs1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact24/finalhcs2.txt'):
            os.remove('./contact/conpact24/finalhcs2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact24/finalhcs3.txt'):
            os.remove('./contact/conpact24/finalhcs3.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst24/parcours.txt'):
            os.remove('./medidoc/doc_dmst24/parcours.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst24/pbm.txt'):
            os.remove('./medidoc/doc_dmst24/pbm.txt')
            print("[del] File pbm.txt deleted")
    except FileNotFoundError as filefunc30:
        print("[!] File pbm.txt does not exist", filefunc30)

    try:
        if os.path.getsize('./medidoc/doc_dmst24/project.txt'):
            os.remove('./medidoc/doc_dmst24/project.txt')
            print("[del] File project.txt deleted")
    except FileNotFoundError as filefunc31:
        print("[!] File project.txt does not exist", filefunc31)

    try:
        if os.path.getsize('./medidoc/doc_dmst24/rslt_dmst1.txt'):
            os.remove('./medidoc/doc_dmst24/rslt_dmst1.txt')
