...
def delFuncFile7():
    ...
    if delproc.stderr == b'':
        print("[del] Files7 has been deleted on server !")
    ...
    try:
        if os.path.getsize('./need/doc_suivi7/patient7_14b.txt'):
            ...
            print("[del] File patient7_14b.txt deleted")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt7/stopped_ttt.txt'):
            os.remove('./ttt/doc_ttt7/stopped_ttt.txt')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt7/intro_ts.txt'):
            os.remove('./ttt/doc_ttt7/intro_ts.txt')
            print("[del] File intro_ts.txt deleted (7)")
    except FileNotFoundError as err_ts:
        print("[!] File intro_ts.txt does not exist", err_ts)

    try:
        if os.path.getsize('./ttt/doc_ttt7/report_ttt.txt'):
            os.remove('./ttt/doc_ttt7/report_ttt.txt')
            print("[del] File report_ttt.txt deleted (7)")
    except FileNotFoundError as err_trep:
        print("[!] File report_ttt.txt does not exist", err_trep)

    try:
        if os.path.getsize('./ttt/doc_ttt7/report_res.txt'):
            os.remove('./ttt/doc_ttt7/report_res.txt')
            print("[del] File report_res.txt deleted (7)")
    except FileNotFoundError as err_resrep:
        print("[!] File report_res.txt does not exist", err_resrep)

    try:
        if os.path.getsize('./ttt/doc_ttt7/ires_rs.txt'):
            os.remove('./ttt/doc_ttt7/ires_rs.txt')
            print("[del] File ires_rs.txt deleted (7)")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt7/stopped_res.txt'):
            os.remove('./ttt/doc_ttt7/stopped_res.txt')
    ...
    try:
        if os.path.getsize('./param/paramdata7.txt'):
            ...
            print("[del] File paramdata7.txt deleted")
    ...
    try:
        if os.path.getsize('./calBmi/bmi7.txt'):
            ...
            print("[del] File bmi7.txt deleted")
    ...
    try:
        if os.path.getsize('./diag/doc_diag7/diagrecap7.txt'):
            ...
            print("[del] File diagrecap7.txt deleted")
    ...
    try:
        if os.path.getsize('./labo/doc_labo/result7.txt'):
            ...
            print("[del] File result7.txt deleted")
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed7/resultvmed7.txt'):
            ...
            print("[del] File resultvmed7.txt deleted")
    ...
    try:
        if os.path.getsize('./allergy/allergyfile7.txt'):
            ...
            print("[del] File allergyfile7.txt deleted")
    ...
    try:
        if os.path.getsize('./newpatient/entryfile7.txt'):
            with open('./newpatient/entryfile7.txt', 'w') as file:
                file.write("-------")
            print("[del] File entryfile7.txt deleted")
    ...
    try:
        if os.path.getsize('./contact/conpact7/contact1.txt'):
            os.remove('./contact/conpact7/contact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact7/contactdoc1.txt'):
            os.remove('./contact/conpact7/contactdoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact7/contactdoc2.txt'):
            os.remove('./contact/conpact7/contactdoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact7/contactdoc3.txt'):
            os.remove('./contact/conpact7/contactdoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact7/famycontact1.txt'):
            os.remove('./contact/conpact7/famycontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact7/hcscontact1.txt'):
            os.remove('./contact/conpact7/hcscontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact7/hcscontact2.txt'):
            os.remove('./contact/conpact7/hcscontact2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact7/hcscontact3.txt'):
            os.remove('./contact/conpact7/hcscontact3.txt')
    ...
    # Final
    try:
        if os.path.getsize('./contact/conpact7/finalfile7.txt'):
            os.remove('./contact/conpact7/finalfile7.txt')
            print("[del] File finalfile7.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile7.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact7/finalfiledoc1.txt'):
            os.remove('./contact/conpact7/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact7/finalfam7.txt'):
            ...
            print("[del] File finalfam7.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam7.txt does not exist", err_finalfam)
