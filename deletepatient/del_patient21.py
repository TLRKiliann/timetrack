...
def delFuncFile21():
    ...
    if delproc.stderr == b'':
        print("[del] Files21 has been deleted on server !")
    ...
    try:
        if os.path.getsize('./need/doc_suivi21/patient21_14b.txt'):
            ...
            print("[del] File patient21_14b.txt deleted")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt21/stopped_ttt.txt'):
            os.remove('./ttt/doc_ttt21/stopped_ttt.txt')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt21/intro_ts.txt'):
            os.remove('./ttt/doc_ttt21/intro_ts.txt')
            print("[del] File intro_ts.txt deleted (21)")
    except FileNotFoundError as err_ts:
        print("[!] File intro_ts.txt does not exist", err_ts)

    try:
        if os.path.getsize('./ttt/doc_ttt21/report_ttt.txt'):
            os.remove('./ttt/doc_ttt21/report_ttt.txt')
            print("[del] File report_ttt.txt deleted (21)")
    except FileNotFoundError as err_trep:
        print("[!] File report_ttt.txt does not exist", err_trep)

    try:
        if os.path.getsize('./ttt/doc_ttt21/report_res.txt'):
            os.remove('./ttt/doc_ttt21/report_res.txt')
            print("[del] File report_res.txt deleted (21)")
    except FileNotFoundError as err_resrep:
        print("[!] File report_res.txt does not exist", err_resrep)

    try:
        if os.path.getsize('./ttt/doc_ttt21/ires_rs.txt'):
            os.remove('./ttt/doc_ttt21/ires_rs.txt')
            print("[del] File ires_rs.txt deleted (21)")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt21/stopped_res.txt'):
            os.remove('./ttt/doc_ttt21/stopped_res.txt')
    ...
    try:
        if os.path.getsize('./param/paramdata21.txt'):
            ...
            print("[del] File paramdata21.txt deleted")
    ...
    try:
        if os.path.getsize('./calBmi/bmi21.txt'):
            ...
            print("[del] File bmi21.txt deleted")
    ...
    try:
        if os.path.getsize('./diag/doc_diag21/diagrecap21.txt'):
            ...
            print("[del] File diagrecap21.txt deleted")
    ...
    try:
        if os.path.getsize('./labo/doc_labo/result21.txt'):
            ...
            print("[del] File result21.txt deleted")
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed21/resultvmed21.txt'):
            ...
            print("[del] File resultvmed21.txt deleted")
    ...
    try:
        if os.path.getsize('./allergy/allergyfile21.txt'):
            ...
            print("[del] File allergyfile21.txt deleted")
    ...
    try:
        if os.path.getsize('./newpatient/entryfile21.txt'):
            with open('./newpatient/entryfile21.txt', 'w') as file:
                file.write("---------------------")
            print("[del] File entryfile21.txt deleted")
    ...
    try:
        if os.path.getsize('./contact/conpact21/contact1.txt'):
            os.remove('./contact/conpact21/contact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact21/contactdoc1.txt'):
            os.remove('./contact/conpact21/contactdoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact21/contactdoc2.txt'):
            os.remove('./contact/conpact21/contactdoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact21/contactdoc3.txt'):
            os.remove('./contact/conpact21/contactdoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact21/famycontact1.txt'):
            os.remove('./contact/conpact21/famycontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact21/hcscontact1.txt'):
            os.remove('./contact/conpact21/hcscontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact21/hcscontact2.txt'):
            os.remove('./contact/conpact21/hcscontact2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact21/hcscontact3.txt'):
            os.remove('./contact/conpact21/hcscontact3.txt')
    ...
    # Final
    try:
        if os.path.getsize('./contact/conpact21/finalfile21.txt'):
            os.remove('./contact/conpact21/finalfile21.txt')
            print("[del] File finalfile21.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile21.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact21/finalfiledoc1.txt'):
            os.remove('./contact/conpact21/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact21/finalfam21.txt'):
            ...
            print("[del] File finalfam21.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam21.txt does not exist", err_finalfam)
