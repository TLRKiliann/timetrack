...
def delFuncFile3():
    ...
    # Final
    try:
        if os.path.getsize('./contact/conpact3/finalfile3.txt'):
            os.remove('./contact/conpact3/finalfile3.txt')
            print("[del] File finalfile3.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile3.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact3/finalfiledoc1.txt'):
            os.remove('./contact/conpact3/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact3/finalfam3.txt'):
            os.remove('./contact/conpact3/finalfam3.txt')
            print("[del] File finalfam3.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam3.txt does not exist", err_finalfam)
