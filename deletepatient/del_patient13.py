...
def delFuncFile13():
    ...
    if delproc.stderr == b'':
        print("[del] Files13 has been deleted on server !")
    ...
    try:
        if os.path.getsize('./need/doc_suivi13/patient13_14b.txt'):
            ...
            print("[del] File patient13_14b.txt deleted")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt13/stopped_ttt.txt'):
            os.remove('./ttt/doc_ttt13/stopped_ttt.txt')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt13/intro_ts.txt'):
            os.remove('./ttt/doc_ttt13/intro_ts.txt')
            print("[del] File intro_ts.txt deleted (13)")
    except FileNotFoundError as err_ts:
        print("[!] File intro_ts.txt does not exist", err_ts)

    try:
        if os.path.getsize('./ttt/doc_ttt13/report_ttt.txt'):
            os.remove('./ttt/doc_ttt13/report_ttt.txt')
            print("[del] File report_ttt.txt deleted (13)")
    except FileNotFoundError as err_trep:
        print("[!] File report_ttt.txt does not exist", err_trep)

    try:
        if os.path.getsize('./ttt/doc_ttt13/report_res.txt'):
            os.remove('./ttt/doc_ttt13/report_res.txt')
            print("[del] File report_res.txt deleted (13)")
    except FileNotFoundError as err_resrep:
        print("[!] File report_res.txt does not exist", err_resrep)

    try:
        if os.path.getsize('./ttt/doc_ttt13/ires_rs.txt'):
            os.remove('./ttt/doc_ttt13/ires_rs.txt')
            print("[del] File ires_rs.txt deleted (13)")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt13/stopped_res.txt'):
            os.remove('./ttt/doc_ttt13/stopped_res.txt')
    ...
    try:
        if os.path.getsize('./param/paramdata13.txt'):
            ...
            print("[del] File paramdata13.txt deleted")
    ...
    try:
        if os.path.getsize('./calBmi/bmi13.txt'):
            ...
            print("[del] File bmi13.txt deleted")
    ...
    try:
        if os.path.getsize('./diag/doc_diag13/diagrecap13.txt'):
            ...
            print("[del] File diagrecap13.txt deleted")
    ...
    try:
        if os.path.getsize('./labo/doc_labo/result13.txt'):
            ...
            print("[del] File result13.txt deleted")
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed13/resultvmed13.txt'):
            ...
            print("[del] File resultvmed13.txt deleted")
    ...
    try:
        if os.path.getsize('./allergy/allergyfile13.txt'):
            ...
            print("[del] File allergyfile13.txt deleted")
    ...
    try:
        if os.path.getsize('./newpatient/entryfile13.txt'):
            with open('./newpatient/entryfile13.txt', 'w') as file:
                file.write("-------------")
            print("[del] File entryfile13.txt deleted")
    ...
    try:
        if os.path.getsize('./contact/conpact13/contact1.txt'):
            os.remove('./contact/conpact13/contact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact13/contactdoc1.txt'):
            os.remove('./contact/conpact13/contactdoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact13/contactdoc2.txt'):
            os.remove('./contact/conpact13/contactdoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact13/contactdoc3.txt'):
            os.remove('./contact/conpact13/contactdoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact13/famycontact1.txt'):
            os.remove('./contact/conpact13/famycontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact13/hcscontact1.txt'):
            os.remove('./contact/conpact13/hcscontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact13/hcscontact2.txt'):
            os.remove('./contact/conpact13/hcscontact2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact13/hcscontact3.txt'):
            os.remove('./contact/conpact13/hcscontact3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact13/finalfile13.txt'):
            ...
            print("[del] File finalfile13.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile13.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact13/finalfiledoc1.txt'):
            os.remove('./contact/conpact13/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact13/finalfam13.txt'):
            os.remove('./contact/conpact13/finalfam13.txt')
            print("[del] File finalfam13.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam13.txt does not exist", err_finalfam)
