...
def delFuncFile9():
    ...
    """
    backproc = subprocess.run(["scp", "-r", "-C", "./Backup/Files9",
        "pi@192.168.18.12:~/tt_doc/doc_txt9/Backup9"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(backproc.stderr))
    if backproc.stderr == b'':
        print("[Backup] Backup9 done on server !")
        messagebox.showinfo("INFO", "Backup9 done on server !")
    else:
        print("[!] No Backup9 done on server [!]")
        messagebox.showerror("Error", "!!! No Backup9 done on server !!!")

    delproc = subprocess.run(["ssh",
        "pi@192.168.18.12", "rm -r ~/tt_doc/doc_txt9/Files9/*"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(delproc.stderr))
    if delproc.stderr == b'':
        print("[del] Files9 has been deleted on server !")
        messagebox.showinfo("INFO", "Files9 has been deleted on server !")
    else:
        print("[!] Error", "Not deleted Files9 on server [!]")
        messagebox.showerror("Error", "!!! Not deleted Files9 on server !!!")

    try:
        if os.path.getsize('./need/doc_suivi9/main_14b.txt'):
            os.remove('./need/doc_suivi9/main_14b.txt')
    ...
    try:
        if os.path.getsize('./need/doc_suivi9/patient9_14b.txt'):
            os.remove('./need/doc_suivi9/patient9_14b.txt')
            print("[del] File patient9_14b.txt deleted")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt9/stopped_ttt.txt'):
            os.remove('./ttt/doc_ttt9/stopped_ttt.txt')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt9/intro_ts.txt'):
            os.remove('./ttt/doc_ttt9/intro_ts.txt')
            print("[del] File intro_ts.txt deleted (9)")
    except FileNotFoundError as err_ts:
        print("[!] File intro_ts.txt does not exist", err_ts)

    try:
        if os.path.getsize('./ttt/doc_ttt9/report_ttt.txt'):
            os.remove('./ttt/doc_ttt9/report_ttt.txt')
            print("[del] File report_ttt.txt deleted (9)")
    except FileNotFoundError as err_trep:
        print("[!] File report_ttt.txt does not exist", err_trep)

    try:
        if os.path.getsize('./ttt/doc_ttt9/report_res.txt'):
            os.remove('./ttt/doc_ttt9/report_res.txt')
            print("[del] File report_res.txt deleted (9)")
    except FileNotFoundError as err_resrep:
        print("[!] File report_res.txt does not exist", err_resrep)

    try:
        if os.path.getsize('./ttt/doc_ttt9/ires_rs.txt'):
            os.remove('./ttt/doc_ttt9/ires_rs.txt')
            print("[del] File ires_rs.txt deleted (9)")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt9/stopped_res.txt'):
            os.remove('./ttt/doc_ttt9/stopped_res.txt')
    ...
    try:
        if os.path.getsize('./param/paramdata9.txt'):
            ...
            print("[del] File paramdata9.txt deleted")
    except FileNotFoundError as filefunc61:
        print("[!] File paramdata9.txt does not exist", filefunc61)

    try:
        if os.path.getsize('./param/aspifile9/diastol.json'):
            os.remove('./param/aspifile9/diastol.json')
    ...
    try:
        if os.path.getsize('./param/aspifile9/systol.json'):
            os.remove('./param/aspifile9/systol.json')
    ...
    try:
        if os.path.getsize('./calBmi/bmi9.txt'):
            ...
            print("[del] File bmi9.txt deleted")
    ...
    try:
        if os.path.getsize('./diag/doc_diag9/diagrecap9.txt'):
            ...
            print("[del] File diagrecap9.txt deleted")
    ...
    try:
        if os.path.getsize('./labo/doc_labo/result9.txt'):
            ...
            print("[del] File result9.txt deleted")
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed9/resultvmed9.txt'):
            ...
            print("[del] File resultvmed9.txt deleted")
    ...
    try:
        if os.path.getsize('./allergy/allergyfile9.txt'):
            ...
            print("[del] File allergyfile9.txt deleted")
    ...
    try:
        if os.path.getsize('./newpatient/entryfile9.txt'):
            with open('./newpatient/entryfile9.txt', 'w') as file:
                file.write("---------")
            print("[del] File entryfile9.txt deleted")
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip9/auxiliary1.txt'):
            os.remove('./auxequip/doc_equip9/auxiliary1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact9/contact1.txt'):
            os.remove('./contact/conpact9/contact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact9/contactdoc1.txt'):
            os.remove('./contact/conpact9/contactdoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact9/contactdoc2.txt'):
            os.remove('./contact/conpact9/contactdoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact9/contactdoc3.txt'):
            os.remove('./contact/conpact9/contactdoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact9/famycontact1.txt'):
            os.remove('./contact/conpact9/famycontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact9/hcscontact1.txt'):
            os.remove('./contact/conpact9/hcscontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact9/hcscontact2.txt'):
            os.remove('./contact/conpact9/hcscontact2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact9/hcscontact3.txt'):
            os.remove('./contact/conpact9/hcscontact3.txt')
    ...
    # Final
    try:
        if os.path.getsize('./contact/conpact9/finalfile9.txt'):
            os.remove('./contact/conpact9/finalfile9.txt')
            print("[del] File finalfile9.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile9.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact9/finalfiledoc1.txt'):
            os.remove('./contact/conpact9/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact9/finaldoc2.txt'):
            os.remove('./contact/conpact9/finaldoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact9/finaldoc3.txt'):
            os.remove('./contact/conpact9/finaldoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact9/finalfam9.txt'):
            os.remove('./contact/conpact9/finalfam9.txt')
            print("[del] File finalfam9.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam9.txt does not exist", err_finalfam)
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst9/parcours.txt'):
            os.remove('./medidoc/doc_dmst9/parcours.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst9/pbm.txt'):
            os.remove('./medidoc/doc_dmst9/pbm.txt')
            print("[del] File pbm.txt deleted")
    except FileNotFoundError as filefunc30:
        print("[!] File pbm.txt does not exist", filefunc30)

    try:
        if os.path.getsize('./medidoc/doc_dmst9/project.txt'):
            os.remove('./medidoc/doc_dmst9/project.txt')
            print("[del] File project.txt deleted")
    except FileNotFoundError as filefunc31:
        print("[!] File project.txt does not exist", filefunc31)

    try:
        if os.path.getsize('./medidoc/doc_dmst9/rslt_dmst1.txt'):
            os.remove('./medidoc/doc_dmst9/rslt_dmst1.txt')
    ...
    try:
        if os.path.exists('./Backup/Files9/Backup_param9.txt'):
            print("[+] Backup_param9.txt exist")
            shutil.copy('./Backup/Files9/Backup_param9.txt',
                './Backup/old/oldfiles9/Backup_param9.txt')
            os.remove('./Backup/Files9/Backup_param9.txt')
    ...
    try:
        if os.path.exists('./Backup/Files9'):
            print("[+] Files9 doc exist !")
            shutil.rmtree('./Backup/Files9')
            print("[del] Files9 doc deleted !")
