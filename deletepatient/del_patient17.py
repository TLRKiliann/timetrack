...
"""
    To delete all files for patient 17
...
def delFuncFile17():
    ...
    backproc = subprocess.run(["scp", "-r", "-C", "./Backup/Files17",
        "pi@192.168.18.12:~/tt_doc/doc_txt17/Backup17"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(backproc.stderr))
    if backproc.stderr == b'':
        print("[Backup] Backup17 done on server !")
    ...
    if delproc.stderr == b'':
        print("[del] Files17 has been deleted on server !")
        messagebox.showinfo("INFO", "Files17 has been deleted on server !")
    else:
        print("[!] Error", "Not deleted Files17 on server [!]")
        messagebox.showerror("Error", "!!! Not deleted Files17 on server !!!")

    try:
        if os.path.getsize('./need/doc_suivi17/main_14b.txt'):
            os.remove('./need/doc_suivi17/main_14b.txt')
            print("[del] File main_14b.txt deleted")
    except FileNotFoundError as filefunc1:
        print("[!] File main_14b.txt does not exist", filefunc1)

    try:
        if os.path.getsize('./need/doc_suivi17/patient17_14b.txt'):
            os.remove('./need/doc_suivi17/patient17_14b.txt')
            print("[del] File patient17_14b.txt deleted")
    except FileNotFoundError as filefunc2:
        print("[!] File patient17_14b.txt does not exist", filefunc2)

    try:
        if os.path.getsize('./ttt/doc_ttt17/convdose.json'):
            os.remove('./ttt/doc_ttt17/convdose.json')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt17/intro_ttt.txt'):
            os.remove('./ttt/doc_ttt17/intro_ttt.txt')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt17/stopped_ttt.txt'):
            os.remove('./ttt/doc_ttt17/stopped_ttt.txt')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt17/intro_ts.txt'):
            os.remove('./ttt/doc_ttt17/intro_ts.txt')
            print("[del] File intro_ts.txt deleted (17)")
    except FileNotFoundError as err_ts:
        print("[!] File intro_ts.txt does not exist", err_ts)

    try:
        if os.path.getsize('./ttt/doc_ttt17/report_ttt.txt'):
            os.remove('./ttt/doc_ttt17/report_ttt.txt')
            print("[del] File report_ttt.txt deleted (17)")
    except FileNotFoundError as err_trep:
        print("[!] File report_ttt.txt does not exist", err_trep)

    try:
        if os.path.getsize('./ttt/doc_ttt17/report_res.txt'):
            os.remove('./ttt/doc_ttt17/report_res.txt')
            print("[del] File report_res.txt deleted (17)")
    except FileNotFoundError as err_resrep:
        print("[!] File report_res.txt does not exist", err_resrep)

    try:
        if os.path.getsize('./ttt/doc_ttt17/ires_rs.txt'):
            os.remove('./ttt/doc_ttt17/ires_rs.txt')
            print("[del] File ires_rs.txt deleted (17)")
    except FileNotFoundError as err_res:
        print("[!] File ires_rs.txt does not exist", err_res)

    try:
        if os.path.getsize('./ttt/doc_ttt17/convres.json'):
            os.remove('./ttt/doc_ttt17/convres.json')
            print("[del] File convres.json deleted")
    except FileNotFoundError as filefunc5:
        print("[!] File convres.json does not exist", filefunc5)

    try:
        if os.path.getsize('./ttt/doc_ttt17/intro_res.txt'):
            os.remove('./ttt/doc_ttt17/intro_res.txt')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt17/stopped_res.txt'):
            os.remove('./ttt/doc_ttt17/stopped_res.txt')
    ...
    try:
        if os.path.getsize('./param/paramdata17.txt'):
            ...
            print("[del] File paramdata17.txt deleted")
    except FileNotFoundError as filefunc61:
        print("[!] File paramdata17.txt does not exist", filefunc61)

    try:
        if os.path.getsize('./param/aspifile17/diastol.json'):
            os.remove('./param/aspifile17/diastol.json')
    ...
    try:
        if os.path.getsize('./param/aspifile17/dlr.json'):
    ...
    try:
        if os.path.getsize('./param/aspifile17/freq.json'):
    ...
    try:
        if os.path.getsize('./param/aspifile17/gly.json'):
    ...
    try:
        if os.path.getsize('./param/aspifile17/puls.json'):
    ...
    try:
        if os.path.getsize('./param/aspifile17/sat.json'):
    ...
    try:
        if os.path.getsize('./param/aspifile17/systol.json'):
            os.remove('./param/aspifile17/systol.json')
            print("[del] File systol.json deleted")
    except FileNotFoundError as filefunc68:
        print("[!] File systol.json does not exist", filefunc68)

    try:
        if os.path.getsize('./param/aspifile17/temp.json'):
    ...
    try:
        if os.path.getsize('./calBmi/doc_BMI17/file_bmi.json'):
            os.remove('./calBmi/doc_BMI17/file_bmi.json')
    ...
    try:
        if os.path.getsize('./calBmi/doc_BMI17/file_kg.json'):
            os.remove('./calBmi/doc_BMI17/file_kg.json')
            print("[del] File file_kg.json deleted")
    except FileNotFoundError as filefunc8:
        print("[!] File file_kg.json does not exist", filefunc8)

    try:
        if os.path.getsize('./calBmi/doc_BMI17/custom_kg.txt'):
            os.remove('./calBmi/doc_BMI17/custom_kg.txt')
    ...
    try:
        if os.path.getsize('./calBmi/bmi17.txt'):
            os.remove('./calBmi/bmi17.txt')
            print("[del] File bmi17.txt deleted")
    except FileNotFoundError as filefunc9:
        print("[!] File bmi17.txt does not exist", filefunc9)

    try:
        if os.path.getsize('./diag/doc_diag17/diagrecap17.txt'):
            os.remove('./diag/doc_diag17/diagrecap17.txt')
            print("[del] File diagrecap17.txt deleted")
    except FileNotFoundError as filefunc10:
        print("[!] File diagrecap17.txt does not exist", filefunc10)

    try:
        if os.path.getsize('./labo/doc_labo/result17.txt'):
            os.remove('./labo/doc_labo/result17.txt')
            print("[del] File result17.txt deleted")
    except FileNotFoundError as filefunc11:
        print("[!] File result17.txt does not exist", filefunc11)

    try:
        if os.path.getsize('./patient_agenda/events17/doc_events/fix_agenda/fixed_rdv.txt'):
            os.remove('./patient_agenda/events17/doc_events/fix_agenda/fixed_rdv.txt')
    ...
    try:
        if os.path.getsize('./patient_agenda/events17/doc_events/fix_agenda/modifrdv.txt'):
            os.remove('./patient_agenda/events17/doc_events/fix_agenda/modifrdv.txt')
    ...
    try:
        if os.path.getsize('./patient_agenda/events17/doc_events/fix_agenda/patient_value.json'):
            os.remove('./patient_agenda/events17/doc_events/fix_agenda/patient_value.json')
    ...
    try:
        if os.path.getsize('./patient_agenda/events17/doc_events/patient_rdv.json'):
            os.remove('./patient_agenda/events17/doc_events/patient_rdv.json')
    ...
    try:
        if os.path.getsize('./patient_agenda/events17/patient_calendar.txt'):
            os.remove('./patient_agenda/events17/patient_calendar.txt')
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed17/resultvmed17.txt'):
            os.remove('./vmed/doc_vmed17/resultvmed17.txt')
            print("[del] File resultvmed17.txt deleted")
    except FileNotFoundError as filefunc17:
        print("[!] File resultvmed17.txt does not exist", filefunc17)

    try:
        if os.path.getsize('./allergy/allergyfile17.txt'):
            os.remove('./allergy/allergyfile17.txt')
            print("[del] File allergyfile17.txt deleted")
    except FileNotFoundError as filefunc18:
        print("[!] File allergyfile17.txt does not exist", filefunc18)

    try:
        if os.path.getsize('./newpatient/entryfile17.txt'):
            with open('./newpatient/entryfile17.txt', 'w') as file:
                file.write("-----------------")
            print("[del] File entryfile17.txt deleted")
    except FileNotFoundError as filefunc19:
        print("[!] File entryfile17.txt does not exist", filefunc19)
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip17/auxiliary1.txt'):
            os.remove('./auxequip/doc_equip17/auxiliary1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact17/contact1.txt'):
            os.remove('./contact/conpact17/contact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact17/contactdoc1.txt'):
            os.remove('./contact/conpact17/contactdoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact17/contactdoc2.txt'):
            os.remove('./contact/conpact17/contactdoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact17/contactdoc3.txt'):
            os.remove('./contact/conpact17/contactdoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact17/famycontact1.txt'):
            os.remove('./contact/conpact17/famycontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact17/hcscontact1.txt'):
            os.remove('./contact/conpact17/hcscontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact17/hcscontact2.txt'):
            os.remove('./contact/conpact17/hcscontact2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact17/hcscontact3.txt'):
            os.remove('./contact/conpact17/hcscontact3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact17/finalfile17.txt'):
            ...
            print("[del] File finalfile17.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile17.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact17/finalfiledoc1.txt'):
            os.remove('./contact/conpact17/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact17/finalfam17.txt'):
            ...
            print("[del] File finalfam17.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam17.txt does not exist", err_finalfam)

    try:
        if os.path.getsize('./contact/conpact17/finalhcs1.txt'):
            os.remove('./contact/conpact17/finalhcs1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact17/finalhcs2.txt'):
            os.remove('./contact/conpact17/finalhcs2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact17/finalhcs3.txt'):
            os.remove('./contact/conpact17/finalhcs3.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst17/parcours.txt'):
            os.remove('./medidoc/doc_dmst17/parcours.txt')
    ...
    try:
        if os.path.getsize('./medidoc/doc_dmst17/pbm.txt'):
            os.remove('./medidoc/doc_dmst17/pbm.txt')
            print("[del] File pbm.txt deleted")
    except FileNotFoundError as filefunc30:
        print("[!] File pbm.txt does not exist", filefunc30)

    try:
        if os.path.getsize('./medidoc/doc_dmst17/project.txt'):
            os.remove('./medidoc/doc_dmst17/project.txt')
            print("[del] File project.txt deleted")
    except FileNotFoundError as filefunc31:
        print("[!] File project.txt does not exist", filefunc31)

    try:
        if os.path.getsize('./medidoc/doc_dmst17/rslt_dmst1.txt'):
            os.remove('./medidoc/doc_dmst17/rslt_dmst1.txt')
    ...
    try:
        if os.path.exists('./Backup/Files17/Backup_param17.txt'):
            print("[+] Backup_param17.txt exist")
            shutil.copy('./Backup/Files17/Backup_param17.txt',
                './Backup/old/oldfiles17/Backup_param17.txt')
            os.remove('./Backup/Files17/Backup_param17.txt')
    except FileNotFoundError as nf_param:
        print("[!] Not found", nf_param)

    try:
        if os.path.exists('./Backup/Files17/Backup_patient17.txt'):
            print("[+] Backup_patient17.txt exist")
            shutil.copy('./Backup/Files17/Backup_patient17.txt',
                './Backup/old/oldfiles17/Backup_patient17.txt')
            os.remove('./Backup/Files17/Backup_patient17.txt')
    except FileNotFoundError as nf_oldfile:
        print("[!] Not found", nf_oldfile)

    try:
        if os.path.exists('./Backup/Files17/Backup_careneeds17.txt'):
            print("[+] Backup_careneeds17.txt exist")
            shutil.copy('./Backup/Files17/Backup_careneeds17.txt',
                './Backup/old/oldfiles17/Backup_careneeds17.txt')
            os.remove('./Backup/Files17/Backup_careneeds17.txt')
    except FileNotFoundError as nf_oldfile2:
        print("[!] Not found", nf_oldfile2)

    try:
        if os.path.exists('./Backup/Files17/Backup_diag17.txt'):
            print("[+] Backup_diag17.txt exist")
            shutil.copy('./Backup/Files17/Backup_diag17.txt',
                './Backup/old/oldfiles17/Backup_diag17.txt')
            os.remove('./Backup/Files17/Backup_diag17.txt')
    except FileNotFoundError as nf_oldfile3:
        print("[!] Not found", nf_oldfile3)

    try:
        if os.path.exists('./Backup/Files17/Backup_Bmi17.txt'):
            print("[+] Backup_Bmi17.txt exist")
            shutil.copy('./Backup/Files17/Backup_Bmi17.txt',
                './Backup/old/oldfiles17/Backup_Bmi17.txt')
            os.remove('./Backup/Files17/Backup_Bmi17.txt')
    except FileNotFoundError as nf_oldfile4:
        print("[!] Not found", nf_oldfile4)

    try:
        if os.path.exists('./Backup/Files17/Backup_resultvmed17.txt'):
            print("[+] Backup_resultvmed17.txt exist")
            shutil.copy('./Backup/Files17/Backup_resultvmed17.txt',
                './Backup/old/oldfiles17/Backup_resultvmed17.txt')
            os.remove('./Backup/Files17/Backup_resultvmed17.txt')
    except FileNotFoundError as nf_oldfile5:
        print("[!] Not found", nf_oldfile5)

    try:
        if os.path.exists('./Backup/Files17/Backup_ttt17.txt'):
            print("[+] Backup_ttt17.txt exist")
            shutil.copy('./Backup/Files17/Backup_ttt17.txt',
                './Backup/old/oldfiles17/Backup_ttt17.txt')
            os.remove('./Backup/Files17/Backup_ttt17.txt')
    except FileNotFoundError as nf_oldfile6:
        print("[!] Not found", nf_oldfile6)

    try:
        if os.path.exists('./Backup/Files17'):
            print("[+] Files17 doc exist !")
            shutil.rmtree('./Backup/Files17')
            print("[del] Files17 doc deleted !")
