...
def delFuncFile16():
    ...
    try:
        if os.path.getsize('./contact/conpact16/finalfile16.txt'):
            ...
            print("[del] File finalfile16.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile16.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact16/finalfiledoc1.txt'):
            os.remove('./contact/conpact16/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact16/finalfam16.txt'):
            os.remove('./contact/conpact16/finalfam16.txt')
            print("[del] File finalfam16.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam16.txt does not exist", err_finalfam)
