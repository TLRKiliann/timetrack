...
def delFuncFile18():
    ...
    try:
        if os.path.getsize('./contact/conpact18/finalfile18.txt'):
            ...
            print("[del] File finalfile18.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile18.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact18/finalfiledoc1.txt'):
            os.remove('./contact/conpact18/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact18/finalfam18.txt'):
            ...
            print("[del] File finalfam18.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam18.txt does not exist", err_finalfam)
