...
def delFuncFile6():
    ...
    if delproc.stderr == b'':
        print("[del] Files6 has been deleted on server !")
    ...
    try:
        if os.path.getsize('./need/doc_suivi6/patient6_14b.txt'):
            ...
            print("[del] File patient6_14b.txt deleted")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt6/stopped_ttt.txt'):
            os.remove('./ttt/doc_ttt6/stopped_ttt.txt')
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt6/intro_ts.txt'):
            os.remove('./ttt/doc_ttt6/intro_ts.txt')
            print("[del] File intro_ts.txt deleted (6)")
    except FileNotFoundError as err_ts:
        print("[!] File intro_ts.txt does not exist", err_ts)

    try:
        if os.path.getsize('./ttt/doc_ttt6/report_ttt.txt'):
            os.remove('./ttt/doc_ttt6/report_ttt.txt')
            print("[del] File report_ttt.txt deleted (6)")
    except FileNotFoundError as err_trep:
        print("[!] File report_ttt.txt does not exist", err_trep)

    try:
        if os.path.getsize('./ttt/doc_ttt6/report_res.txt'):
            os.remove('./ttt/doc_ttt6/report_res.txt')
            print("[del] File report_res.txt deleted (6)")
    except FileNotFoundError as err_resrep:
        print("[!] File report_res.txt does not exist", err_resrep)

    try:
        if os.path.getsize('./ttt/doc_ttt6/ires_rs.txt'):
            os.remove('./ttt/doc_ttt6/ires_rs.txt')
            print("[del] File ires_rs.txt deleted (6)")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt6/stopped_res.txt'):
            os.remove('./ttt/doc_ttt6/stopped_res.txt')
    ...
    try:
        if os.path.getsize('./param/paramdata6.txt'):
            ...
            print("[del] File paramdata6.txt deleted")
    ...
    try:
        if os.path.getsize('./calBmi/bmi6.txt'):
            ...
            print("[del] File bmi6.txt deleted")
    ...
    try:
        if os.path.getsize('./diag/doc_diag6/diagrecap6.txt'):
            ...
            print("[del] File diagrecap6.txt deleted")
    ...
    try:
        if os.path.getsize('./labo/doc_labo/result6.txt'):
            ...
            print("[del] File result6.txt deleted")
    ...
    try:
        if os.path.getsize('./vmed/doc_vmed6/resultvmed6.txt'):
            ...
            print("[del] File resultvmed6.txt deleted")
    ...
    try:
        if os.path.getsize('./allergy/allergyfile6.txt'):
            ...
            print("[del] File allergyfile6 deleted")
    ...
    try:
        if os.path.getsize('./newpatient/entryfile6.txt'):
            with open('./newpatient/entryfile6.txt', 'w') as file:
                file.write("------")
            print("[del] File entryfile6.txt reborn")
    ...
    try:
        if os.path.getsize('./contact/conpact6/contact1.txt'):
            os.remove('./contact/conpact6/contact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact6/contactdoc1.txt'):
            os.remove('./contact/conpact6/contactdoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact6/contactdoc2.txt'):
            os.remove('./contact/conpact6/contactdoc2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact6/contactdoc3.txt'):
            os.remove('./contact/conpact6/contactdoc3.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact6/famycontact1.txt'):
            os.remove('./contact/conpact6/famycontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact6/hcscontact1.txt'):
            os.remove('./contact/conpact6/hcscontact1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact6/hcscontact2.txt'):
            os.remove('./contact/conpact6/hcscontact2.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact6/hcscontact3.txt'):
            os.remove('./contact/conpact6/hcscontact3.txt')
    ...
    # Final
    try:
        if os.path.getsize('./contact/conpact6/finalfile6.txt'):
            os.remove('./contact/conpact6/finalfile6.txt')
            print("[del] File finalfile6.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile6.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact6/finalfiledoc1.txt'):
            os.remove('./contact/conpact6/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact6/finalfam6.txt'):
            ...
            print("[del] File finalfam6.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam6.txt does not exist", err_finalfam)
