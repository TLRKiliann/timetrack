...
def delFuncFile5():
    ...
    try:
        if os.path.getsize('./contact/conpact5/finalfile5.txt'):
            ...
            print("[del] File finalfile5.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile5.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact5/finalfiledoc1.txt'):
            os.remove('./contact/conpact5/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact5/finalfam5.txt'):
            ...
            print("[del] File finalfam5.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam5.txt does not exist", err_finalfam)
