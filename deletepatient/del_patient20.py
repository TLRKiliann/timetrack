...
def delFuncFile20():
    ...
    try:
        if os.path.getsize('./contact/conpact20/finalfile20.txt'):
            ...
            print("[del] File finalfile20.txt deleted")
    except FileNotFoundError as err_finalf:
        print("[!] File finalfile20.txt does not exist", err_finalf)

    try:
        if os.path.getsize('./contact/conpact20/finalfiledoc1.txt'):
            os.remove('./contact/conpact20/finalfiledoc1.txt')
    ...
    try:
        if os.path.getsize('./contact/conpact20/finalfam20.txt'):
            ...
            print("[del] File finalfam20.txt deleted")
    except FileNotFoundError as err_finalfam:
        print("[!] File finalfam20.txt does not exist", err_finalfam)
