...
import os
from auxequip.folderaux.auxrec14 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary14.txt'):
                importationFile('./auxequip/doc_equip/auxiliary14.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary14.txt for patient 14 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary14.txt not found !')
