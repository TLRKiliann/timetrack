...
def auxi_equip14(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary14.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary14.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt14/Files14/auxiliary14.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary14.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary14.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary14.txt to upload...")
