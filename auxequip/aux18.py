...
import os
from auxequip.folderaux.auxrec18 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary18.txt'):
                importationFile('./auxequip/doc_equip/auxiliary18.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary18.txt for patient 18 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary18.txt not found !')
