...
def auxi_equip18(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary18.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary18.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt18/Files18/auxiliary18.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary18.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary18.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary18.txt to upload...")
