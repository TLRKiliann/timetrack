...
import os
from auxequip.folderaux.auxrec19 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary19.txt'):
                importationFile('./auxequip/doc_equip/auxiliary19.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary19.txt for patient 19 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary19.txt not found !')
