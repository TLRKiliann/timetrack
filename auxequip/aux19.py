...
def auxi_equip19(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary19.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary19.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt19/Files19/auxiliary19.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary19.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary19.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary19.txt to upload...")
