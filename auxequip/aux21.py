...
def auxi_equip21(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary21.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary21.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt21/Files21/auxiliary21.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary21.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary21.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary21.txt to upload...")
