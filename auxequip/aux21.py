...
import os
from auxequip.folderaux.auxrec21 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary21.txt'):
                importationFile('./auxequip/doc_equip/auxiliary21.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary21.txt for patient 21 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary21.txt not found !')
