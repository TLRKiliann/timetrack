...
def auxi_equip10(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary10.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary10.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt10/Files10/auxiliary10.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary10.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary10.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary10.txt to upload...")
