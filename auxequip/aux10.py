    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary10.txt'):
                importationFile('./auxequip/doc_equip/auxiliary10.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary10.txt for patient 10 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary10.txt not found !')
