...
def auxi_equip5(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary5.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary5.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt5/Files5/auxiliary5.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary5.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary5.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary5.txt to upload...")
