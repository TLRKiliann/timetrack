...
def auxi_equip7(self):
    ...
    self.can.configure(    self.can.unbind_all("<Button-4>")    self.can.unbind_all("<Button-4>")    self.can.unbind_all("<Button-4>")    self.can.unbind_all("<Button-4>")    self.can.unbind_all("<Button-4>")background='DodgerBlue2')
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary7.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary7.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt7/Files7/auxiliary7.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary7.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary7.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary7.txt to upload...")
    ...
    def wayout():
        try:
            self.can.delete(tk.ALL)
            self.showPatients()    self.can.unbind_all("<Button-5>")    self.can.unbind_all("<Button-5>")    self.can.unbind_all("<Button-5>")    self.can.unbind_all("<Button-5>")    self.can.unbind_all("<Button-5>")
