...
import os
from auxequip.folderaux.auxrec11 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary11.txt'):
                importationFile('./auxequip/doc_equip/auxiliary11.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary11.txt for patient 11 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary11.txt not found !')
