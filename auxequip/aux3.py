...
def auxi_equip3(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary3.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary3.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt3/Files3/auxiliary3.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary3.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary3.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary3.txt to upload...")
