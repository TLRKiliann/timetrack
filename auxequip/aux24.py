...
import os
from auxequip.folderaux.auxrec24 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary24.txt'):
                importationFile('./auxequip/doc_equip/auxiliary24.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary24.txt for patient 24 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary24.txt not found !')
