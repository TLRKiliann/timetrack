...
def auxi_equip24(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary24.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary24.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt24/Files24/auxiliary24.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary24.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary24.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary24.txt to upload...")
