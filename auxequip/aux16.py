...
import os
from auxequip.folderaux.auxrec16 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary16.txt'):
                importationFile('./auxequip/doc_equip/auxiliary16.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary16.txt for patient 16 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary16.txt not found !')
