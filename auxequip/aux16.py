...
def auxi_equip16(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary16.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt16/Files16/auxiliary16.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary16.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary16.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary16.txt to upload...")
