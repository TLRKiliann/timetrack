...
import os
from auxequip.folderaux.auxrec4 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary4.txt'):
                importationFile('./auxequip/doc_equip/auxiliary4.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary4.txt for patient 4 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary4.txt not found !')
