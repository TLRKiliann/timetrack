...
def recordaux(self):
    ...
    with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as fintro:
        fintro.write("----------------------------------------------------------\n")
        fintro.write("Date : ")
    ...
    with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as endfile:
        endfile.write("---------------------------------------------------------\n")

    print(self.CheckVar1.get())
    if self.CheckVar1.get() == 1:
        print("[+] Stick was checked !")
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as sfile:
    ...
    if self.CheckVar2.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as wffile:
    ...
    if self.CheckVar3.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as rollfile:
    ...
    if self.CheckVar4.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as wheelfile:
    ...
    if self.CheckVar5.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as crutchfile:
    ...
    if self.CheckVar50.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as patchfile:
    ...
    if self.CheckVar60.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as pacefile:
    ...
    if self.CheckVar61.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as holtfile:
    ...
    if self.CheckVar70.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as insulinfile:
    ...
    if self.CheckVar80.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as mofile:
    ...
    if self.CheckVar90.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as vacfile:
    ...
    if self.CheckVar100.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as nasalfile:
    ...
    if self.CheckVar110.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as glassfile:
    ...
    if self.CheckVar120.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as hearfile:
    ...
    if self.CheckVar121.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as hearightfile:
    ...
    if self.CheckVar122.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as artfistfile:
    ...
    if self.CheckVar123.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as ostofile:
    ...
    if self.CheckVar124.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as perfile:
    ...
    if self.CheckVar125.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as injectfile:
    ...
    if self.CheckVar130.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as wondyfile:
    ...
    if self.CheckVar150.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as redonfile:
    ...
    if self.CheckVar160.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as kherfile:
    ...
    if self.CheckVar170.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as blakefile:
    ...
    if self.CheckVar180.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as penrosefile:
    ...
    if self.CheckVar190.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as mikufile:
    ...
    if self.CheckVar191.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as diafile:
    ...
    if self.CheckVar192.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as bilifile:
    ...
    if self.CheckVar193.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as urifile:
    ...
    if self.CheckVar194.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as suprafile:
    ...
    if self.CheckVar195.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as pleuralfile:
    ...
    if self.CheckVar196.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as nasogafile:
    ...
    if self.CheckVar200.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as vpfile:
    ...
    if self.CheckVar210.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as vafile:
    ...
    if self.CheckVar211.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as treewayfile:
    ...
    if self.CheckVar212.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as picfile:
    ...
    if self.CheckVar213.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as centralcatf:
    ...
    if self.CheckVar214.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as veinfile:
    ...
    if self.CheckVar220.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as lhipfile:
    ...
    if self.CheckVar230.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as rhipfile:
    ...
    if self.CheckVar240.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as lkneefile:
    ...
    if self.CheckVar250.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as rkneefile:
    ...
    if self.CheckVar260.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as shouldfile:
    ...
    if self.CheckVar270.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as rshouldfile:
    ...
    if self.CheckVar280.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as lelbfile:
    ...
    if self.CheckVar290.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as relbfile:
    ...
    if self.CheckVar300.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as lfootfile:
    ...
    if self.CheckVar310.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as rfootfile:
    ...
    if self.CheckVar320.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as llegfile:
    ...
    if self.CheckVar330.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as rlegfile:
    ...
    if self.CheckVar340.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as lhandfile:
    ...
    if self.CheckVar350.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as rhandfile:
    ...
    if self.CheckVar360.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as larmfile:
    ...
    if self.CheckVar370.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as rarmfile:
    ...
    if self.CheckVar380.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as locularfile:
    ...
    if self.CheckVar390.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as rocularfile:
    ...
    if self.CheckVar400.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as lsemfile:
    ...
    if self.CheckVar410.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as rsemfile:
    ...
    if self.CheckVar420.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as ldentalfile:
    ...
    if self.CheckVar430.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as udentalfile:
    ...
    if self.CheckVar440.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as maxilofile:
    ...
    if self.CheckVar450.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary16.txt', 'a+') as nasaprotfile:
...
def uploadaux():
    ...
    """
    procaux = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary16.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt16/Files16/auxiliary16.txt"],
        stderr=subprocess.PIPE)
    print("Result SCP transfert : %s" % repr(procaux.stderr))
    if procaux.stderr == b'':
        print("[+] File auxiliary16.txt uploaded !")
        tk.messagebox.showinfo("INFO", "auxiliary16.txt uploaded...")
    else:
        print("[!] No file auxiliary16.txt to upload !")
        tk.messagebox.showerror("Error", "No auxiliary16.txt to upload...")
