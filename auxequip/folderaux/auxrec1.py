...
def recordaux(self):
    ...
    if self.CheckVar122.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary1.txt', 'a+') as artfistfile:
    ...
    if self.CheckVar211.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary1.txt', 'a+') as treewayfile:
    ...
    if self.CheckVar212.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary1.txt', 'a+') as picfile:
    ...
    if self.CheckVar213.get() == 1:
        ...
        with open('./auxequip/doc_equip/auxiliary1.txt', 'a+') as centralcatf:
