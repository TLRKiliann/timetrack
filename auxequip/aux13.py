...
def auxi_equip13(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary13.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary13.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt13/Files13/auxiliary13.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary13.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary13.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary13.txt to upload...")
