...
import os
from auxequip.folderaux.auxrec22 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary22.txt'):
                importationFile('./auxequip/doc_equip/auxiliary22.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary22.txt for patient 22 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary22.txt not found !')
