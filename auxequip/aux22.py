...
def auxi_equip22(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary22.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary22.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt22/Files22/auxiliary22.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary22.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary22.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary22.txt to upload...")
