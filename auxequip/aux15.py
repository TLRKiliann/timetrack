...
import os
from auxequip.folderaux.auxrec15 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary15.txt'):
                importationFile('./auxequip/doc_equip/auxiliary15.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary15.txt for patient 15 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary15.txt not found !')
