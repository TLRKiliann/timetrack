...
def auxi_equip15(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary15.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary15.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt15/Files15/auxiliary15.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary15.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary15.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary15.txt to upload...")
