...
import os
from auxequip.folderaux.auxrec23 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary23.txt'):
                importationFile('./auxequip/doc_equip/auxiliary23.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary23.txt for patient 23 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary23.txt not found !')
