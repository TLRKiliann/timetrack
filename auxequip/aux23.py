...
def auxi_equip23(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary23.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary23.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt23/Files23/auxiliary23.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary23.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary23.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary23.txt to upload...")
