...
import os
from auxequip.folderaux.auxrec9 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary9.txt'):
                importationFile('./auxequip/doc_equip/auxiliary9.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary9.txt for patient 9 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary9.txt not found !')
