...
def auxi_equip12(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary12.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary12.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt12/Files12/auxiliary12.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary12.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary12.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary12.txt to upload...")
