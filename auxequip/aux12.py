...
import os
from auxequip.folderaux.auxrec12 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary12.txt'):
                importationFile('./auxequip/doc_equip/auxiliary12.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary12.txt for patient 12 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary12.txt not found !')
