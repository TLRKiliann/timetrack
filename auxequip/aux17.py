...
import os
from auxequip.folderaux.auxrec17 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary17.txt'):
                importationFile('./auxequip/doc_equip/auxiliary17.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary17.txt for patient 17 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary17.txt not found !')
