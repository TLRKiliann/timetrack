...
def auxi_equip17(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary17.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary17.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt17/Files17/auxiliary17.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary17.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary17.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary17.txt to upload...")
