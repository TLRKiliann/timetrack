...
def auxi_equip2(self):
    ...
    def recordaux():
        ...
        with open('./auxequip/doc_equip/auxiliary2.txt', 'a+') as file:
            file.write("----------------------------------------------------------\n")
            file.write("Date : ")
    ...
    def uploadaux():
        ...
        """
        proc = subprocess.run(["scp", "./auxequip/doc_equip/auxiliary2.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt2/Files2/auxiliary2.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File auxiliary2.txt uploaded !")
            messagebox.showinfo("INFO", "auxiliary2.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No auxiliary2.txt to upload...")
