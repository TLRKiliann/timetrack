...
import os
from auxequip.folderaux.auxrec8 import transwritedata
    ...
    def showData():
        ...
        try:
            if os.path.getsize('./auxequip/doc_equip/auxiliary8.txt'):
                importationFile('./auxequip/doc_equip/auxiliary8.txt', encodage="Utf-8")
        except FileNotFoundError as err_fnfaux:
            print("[!] File auxiliary8.txt for patient 8 not found !", err_fnfaux)
            tk.messagebox.showwarning('Warning', 'File auxiliary8.txt not found !')
