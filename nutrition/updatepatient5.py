...
try:
    ...
    print("[!] An error occured about pymysql - updatpatient5.py [!]", err_report)
    pass
...
def searchLineName5(firstpat, surname, birthvalue, allergia, transdisval, diagnosis):
    ...
    if MsgBox2 == 1:
        with open('./newpatient/entryfile5.txt', 'w') as file2:
            file2.write(firstpat + " " + surname + '\n')
            file2.write(birthvalue + '\n')
            file2.write(allergia + '\n')
            file2.write(transdisval + '\n')
            file2.write(diagnosis + '\n')
        with open('./allergy/allergyfile5.txt', 'w') as al_file:
            al_file.write(allergia + '\n')
    tk.messagebox.showinfo("Info", "Data was updated for entryfile5.txt and "\
        "allergyfile5.txt !")
...
def uptopat(idpatient, patient_num, firstpat, firstname_pat,
    ...
    if idpatient == '5':
        if os.path.getsize('./newpatient/entryfile5.txt'):
            ...
            os.remove('./allergy/aller_drop5.txt')
...
with open('./allergy/aller_drop5.txt', 'r') as patfile:
