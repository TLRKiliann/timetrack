...
try:
    ...
    print("[!] An error occured about pymysql - updatpatient6.py [!]", err_report)
    pass
...
def searchLineName6(firstpat, surname, birthvalue, allergia, transdisval, diagnosis):
    ...
    if MsgBox2 == 1:
        ...
        with open('./allergy/allergyfile6.txt', 'w') as al_file:
            al_file.write(allergia + '\n')
    tk.messagebox.showinfo("Info", "Data was updated for entryfile6.txt and "\
        "allergyfile6.txt !")
...
def uptopat(idpatient, patient_num, firstpat, firstname_pat,
    ...
    if idpatient == '6':
        if os.path.getsize('./newpatient/entryfile6.txt'):
            ...
            os.remove('./allergy/aller_drop6.txt')
...
with open('./allergy/aller_drop6.txt', 'r') as patfile:
