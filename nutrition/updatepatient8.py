...
try:
    ...
    print("[!] An error occured about pymysql - updatpatient8.py [!]", err_report)
    pass
...
def searchLineName8(firstpat, surname, birthvalue, allergia, transdisval, diagnosis):
    ...
    if MsgBox2 == 1:
        ...
        with open('./allergy/allergyfile8.txt', 'w') as al_file:
            al_file.write(allergia + '\n')
    tk.messagebox.showinfo("Info", "Data was updated for entryfile8.txt and "\
        "allergyfile8.txt !")
...
def uptopat(idpatient, patient_num, firstpat, firstname_pat,
    ...
    if idpatient == '8':
        if os.path.getsize('./newpatient/entryfile8.txt'):
            ...
            os.remove('./allergy/aller_drop8.txt')
...
with open('./allergy/aller_drop8.txt', 'r') as patfile:
