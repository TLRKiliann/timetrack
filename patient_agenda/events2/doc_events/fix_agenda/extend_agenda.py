...
def retrieve_input():
    ...
    print(inputValue)
    file_w = open('./patient_agenda/events2/doc_events/'\
    ...
    # 'agenda_saved' in 
    # './patient_agenda/events2/doc_events/fix_agenda' 
    topath = './patient_agenda/events2/doc_events/'\
    ...
    try:
        ...
        print("[Error] os.remove doesn't work for agenda 2", err_rm)
...
try:
    if os.path.getsize('./patient_agenda/events2/doc_events/'\
        'fix_agenda/patient_value.json'):
        print("[+] File 'patient_value.json exist' !")
        importationFile('./patient_agenda/events2/doc_events/'\
            'fix_agenda/patient_value.json')
