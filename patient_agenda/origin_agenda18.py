...
if __name__=='__main__':
    ...
    class Control:
        ...
        def accessDate(self):
            try:
                subprocess.run('./patient_agenda/events18/doc_events/fix_agenda/read_file.py', check=True)
        ...
        def accessLook(self):
            try:
                subprocess.run('./patient_agenda/events18/doc_events/fix_agenda/main.py', check=True)
