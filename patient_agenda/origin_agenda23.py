...
if __name__=='__main__':
    class Control:
        def __init__(self, parent):
            ...
            with open('./newpatient/entryfile23.txt', 'r') as file_r:
        ...
        def accessDate(self):
            try:
                subprocess.run('./patient_agenda/events23/doc_events/fix_agenda/read_file.py',
                    check=True)
        ...
        def accessLook(self):
            try:
                subprocess.run('./patient_agenda/events23/doc_events/fix_agenda/main.py',
                    check=True)
