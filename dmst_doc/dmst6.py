...
import os
import platform
from dmst_doc.extdmst6.extdmstfile6 import importationAdmin
from dmst_doc.extdmst6.extdmstfile6 import importationDoc1
from dmst_doc.extdmst6.extdmstfile6 import importationDoc2
from dmst_doc.extdmst6.extdmstfile6 import importationDoc3
from dmst_doc.extdmst6.extdmstfile6 import importationFam
from dmst_doc.extdmst6.extdmstfile6 import importationHealOne
from dmst_doc.extdmst6.extdmstfile6 import importationHealThree
from dmst_doc.extdmst6.extdmstfile6 import importationFile2
from dmst_doc.extdmst6.extdmstfile6 import importationParam
from dmst_doc.extdmst6.extdmstfile6 import importationBmi
from dmst_doc.extdmst6.extdmstfile6 import launchfunc
from dmst_doc.extdmst6.extdmstfile6 import saveData
from dmst_doc.extdmst6.extdmstfile6 import copytobackup
from dmst_doc.extdmst6.extdmstfile6 import uptoserv
...
def doc_medical6(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt6/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt6/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt6/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt6/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata6.txt'):
            importationParam(self, './param/paramdata6.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata6.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata6.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi6.txt'):
            importationBmi(self, './calBmi/bmi6.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi6.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi6.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact6/finalfile6.txt'):
            importationAdmin(self, './contact/conpact6/finalfile6.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile6.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact6/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact6/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact6/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact6/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact6/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact6/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact6/finalfam6.txt'):
            importationFam(self, './contact/conpact6/finalfam6.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam6.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam6.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact6/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact6/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact6/finalhcs2.txt'):
            importationHealTwo('./contact/conpact6/finalhcs2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact6/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact6/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip/auxiliary6.txt'):
            importationHealTwo('./auxequip/doc_equip/auxiliary6.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File auxiliary6.txt not found !")
        tk.messagebox.showinfo('INFO', 'File auxiliary6.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst6/rslt_dmst6.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst6/rslt_dmst6.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst6/rslt_dmst6.txt')
