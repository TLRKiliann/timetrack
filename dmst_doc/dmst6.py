...
def doc_medical6(self):
    ...
    try:
        if os.path.getsize('./contact/conpact6/finalfile1.txt'):
            importationAdmin('./contact/conpact6/finalfile1.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./contact/conpact6/finaldoc1.txt'):
            importationDoc1('./contact/conpact6/finaldoc1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact6/finaldoc2.txt'):
            importationDoc2('./contact/conpact6/finaldoc2.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact6/finaldoc3.txt'):
            importationDoc3('./contact/conpact6/finaldoc3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact6/finalfam1.txt'):
            importationFam('./contact/conpact6/finalfam1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact6/finalhcs1.txt'):
            importationHealOne('./contact/conpact6/finalhcs1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact6/finalhcs2.txt'):
            importationHealTwo('./contact/conpact6/finalhcs2.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact6/finalhcs3.txt'):
            importationHealThree('./contact/conpact6/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        with open('./diag/doc_diag6/diagrecap6.txt', 'r') as filediag:
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt6/intro_ttt.txt'):
            importationFile('./ttt/doc_ttt6/intro_ttt.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt6/intro_res.txt'):
            importationFile2('./ttt/doc_ttt6/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata6.txt'):
            importationParam('./param/paramdata6.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("+ File paramdata6.txt not found !")
        messagebox.showinfo('INFO', 'File paramdata6.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi6.txt'):
            importationBmi('./calBmi/bmi6.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("+ File bmi6.txt not found !")
        messagebox.showinfo('INFO', 'File bmi6.txt not found !')
    ...
    def launchfunc(ent_name, nt_birth, allertxt, transdis):
        ...
        try:
            with open('./contact/conpact6/finalfile1.txt', 'r') as file_contf1:
                with open('./dmst_doc/doc_dmst6/rslt_dmst6.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact6/finalfam1.txt', 'r') as file_fam:
                with open('./dmst_doc/doc_dmst6/rslt_dmst6.txt', '+a') as file_dm:
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip/auxiliary6.txt'):
            importationHealTwo('./auxequip/doc_equip/auxiliary6.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("+ File auxiliary6.txt not found !")
        messagebox.showinfo('INFO', 'File auxiliary6.txt not found !')
    ...
    try:
        if os.path.getsize('./need/doc_suivi6/main_14b.txt'):
            ...
            needimport('./need/doc_suivi6/main_14b.txt')
    ...
    try:
        if os.path.getsize('./dmst_doc/doc_dmst6/parcours.txt'):
            print("+ File 'parcours.txt' exist !")
            importationFile('./dmst_doc/doc_dmst6/parcours.txt')
    ...
    try:
        if os.path.getsize('./dmst_doc/doc_dmst6/pbm.txt'):
            print("+ File 'pbm.txt' exist !")
            pbmimport('./dmst_doc/doc_dmst6/pbm.txt')
    ...
    try:
        if os.path.getsize('./dmst_doc/doc_dmst6/project.txt'):
            print("+ File 'project.txt' exist !")
            projectimport('./dmst_doc/doc_dmst6/project.txt')
    ...
    def uptoserv():
        ...
        if proc.stderr == b'':
            print("+ File rslt_dmst6.txt uploaded !")
            #messagebox.showinfo("INFO", "rslt_dmst6.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No rslt_dmst6.txt to upload...")
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst6/rslt_dmst6.txt"') # Linux
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst6/rslt_dmst6.txt') # Mac
        else:
            os.startfile('./dmst_doc/doc_dmst6/rslt_dmst6.txt') # Windows
