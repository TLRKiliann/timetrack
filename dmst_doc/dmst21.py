...
import os
import platform
from dmst_doc.extdmst21.extdmstfile21 import importationAdmin
from dmst_doc.extdmst21.extdmstfile21 import importationDoc1
from dmst_doc.extdmst21.extdmstfile21 import importationDoc2
from dmst_doc.extdmst21.extdmstfile21 import importationDoc3
from dmst_doc.extdmst21.extdmstfile21 import importationFam
from dmst_doc.extdmst21.extdmstfile21 import importationHealOne
from dmst_doc.extdmst21.extdmstfile21 import importationHealThree
from dmst_doc.extdmst21.extdmstfile21 import importationFile2
from dmst_doc.extdmst21.extdmstfile21 import importationParam
from dmst_doc.extdmst21.extdmstfile21 import importationBmi
from dmst_doc.extdmst21.extdmstfile21 import launchfunc
from dmst_doc.extdmst21.extdmstfile21 import saveData
from dmst_doc.extdmst21.extdmstfile21 import copytobackup
from dmst_doc.extdmst21.extdmstfile21 import uptoserv
...
def doc_medical21(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt21/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt21/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt21/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt21/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata21.txt'):
            importationParam(self, './param/paramdata21.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata21.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata21.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi21.txt'):
            importationBmi(self, './calBmi/bmi21.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi21.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi21.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact21/finalfile21.txt'):
            importationAdmin(self, './contact/conpact21/finalfile21.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile21.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact21/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact21/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact21/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact21/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact21/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact21/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact21/finalfam21.txt'):
            importationFam(self, './contact/conpact21/finalfam21.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam21.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam21.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact21/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact21/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact21/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact21/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File auxiliary21.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst21/rslt_dmst21.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst21/rslt_dmst21.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst21/rslt_dmst21.txt')
