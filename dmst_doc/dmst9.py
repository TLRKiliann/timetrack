...
import os
import platform
from dmst_doc.extdmst9.extdmstfile9 import importationAdmin
from dmst_doc.extdmst9.extdmstfile9 import importationDoc1
from dmst_doc.extdmst9.extdmstfile9 import importationDoc2
from dmst_doc.extdmst9.extdmstfile9 import importationDoc3
from dmst_doc.extdmst9.extdmstfile9 import importationFam
from dmst_doc.extdmst9.extdmstfile9 import importationHealOne
from dmst_doc.extdmst9.extdmstfile9 import importationHealThree
from dmst_doc.extdmst9.extdmstfile9 import importationFile2
from dmst_doc.extdmst9.extdmstfile9 import importationParam
from dmst_doc.extdmst9.extdmstfile9 import importationBmi
from dmst_doc.extdmst9.extdmstfile9 import launchfunc
from dmst_doc.extdmst9.extdmstfile9 import saveData
from dmst_doc.extdmst9.extdmstfile9 import copytobackup
from dmst_doc.extdmst9.extdmstfile9 import uptoserv
...
def doc_medical9(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt9/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt9/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt9/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt9/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata9.txt'):
            importationParam(self, './param/paramdata9.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata9.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata9.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi9.txt'):
            importationBmi(self, './calBmi/bmi9.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi9.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi9.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact9/finalfile9.txt'):
            importationAdmin(self, './contact/conpact9/finalfile9.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile9.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact9/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact9/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact9/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact9/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact9/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact9/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact9/finalfam9.txt'):
            importationFam(self, './contact/conpact9/finalfam9.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact9/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact9/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact9/finalhcs2.txt'):
            importationHealTwo('./contact/conpact9/finalhcs2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact9/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact9/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip/auxiliary9.txt'):
            importationHealTwo('./auxequip/doc_equip/auxiliary9.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File auxiliary9.txt not found !")
        tk.messagebox.showinfo('INFO', 'File auxiliary9.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst9/rslt_dmst9.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst9/rslt_dmst9.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst9/rslt_dmst9.txt')
