...
def doc_medical9(self):
    ...
    with open('./newpatient/entryfile9.txt', 'r') as filename2:
    ...
    self.LabDate = tk.Label(self.can, text="Date : ",
        width=15, font=12,
    ...
    self.t6 = tk.Text(self.can, height=11, width=50, font=18,
        relief=SUNKEN)
    self.wt6_window = self.can.create_window(self.x6, self.y6,
        window=self.t6)
    ...
    try:
        if os.path.getsize('./contact/conpact9/finalfile1.txt'):
            importationAdmin('./contact/conpact9/finalfile1.txt',
                encodage="Utf-8")
    ...
    self.t8 = tk.Text(self.can, height=8, width=50, font=18,
        relief=SUNKEN)
    self.wt8_window = self.can.create_window(self.x8, self.y8,
        window=self.t8)
    ...
    try:
        if os.path.getsize('./contact/conpact9/finaldoc1.txt'):
            importationDoc1('./contact/conpact9/finaldoc1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    self.t9 = tk.Text(self.can, height=8, width=50, font=18,
        relief=SUNKEN)
    self.wt9_window = self.can.create_window(self.x9, self.y9,
        window=self.t9)
    ...
    try:
        if os.path.getsize('./contact/conpact9/finaldoc2.txt'):
            importationDoc2('./contact/conpact9/finaldoc2.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    self.t10 = tk.Text(self.can, height=8, width=50, font=18,
        relief=SUNKEN)
    self.wt10_window = self.can.create_window(self.x10, self.y10,
        window=self.t10)
    ...
    try:
        if os.path.getsize('./contact/conpact9/finaldoc3.txt'):
            importationDoc3('./contact/conpact9/finaldoc3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    self.t12 = tk.Text(self.can, height=6, width=50, font=18,
        relief=SUNKEN)
    self.wt12_window = self.can.create_window(self.x12, self.y12,
        window=self.t12)
    ...
    try:
        if os.path.getsize('./contact/conpact9/finalfam1.txt'):
            importationFam('./contact/conpact9/finalfam1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    self.lbl_heal = tk.Label(self.can,
        text='--- Home Care System Data ---',
        font="Times 14 bold", width=60,
        height=1, bg='RoyalBlue3', fg='white')
    ...
    self.t14 = tk.Text(self.can, height=6, width=50, font=18,
        relief=SUNKEN)
    self.wt14_window = self.can.create_window(self.x14, self.y14,
        window=self.t14)
    ...
    try:
        if os.path.getsize('./contact/conpact9/finalhcs1.txt'):
            importationHealOne('./contact/conpact9/finalhcs1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    self.t15 = tk.Text(self.can, height=6, width=50, font=18,
        relief=SUNKEN)
    self.wt15_window = self.can.create_window(self.x15, self.y15,
        window=self.t15)
    ...
    try:
        if os.path.getsize('./contact/conpact9/finalhcs2.txt'):
            importationHealTwo('./contact/conpact9/finalhcs2.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    self.t16 = tk.Text(self.can, height=6, width=50, font=18,
        relief=SUNKEN)
    self.wt16_window = self.can.create_window(self.x16, self.y16,
        window=self.t16)
    ...
    try:
        if os.path.getsize('./contact/conpact9/finalhcs3.txt'):
            importationHealThree('./contact/conpact9/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    self.LabHour = tk.Label(self.can, text="Hour : ",
        width=15, font=12,
        fg='white', bg='DodgerBlue2', anchor='e')
    ...
    self.LabName = tk.Label(self.can, text="Patient name : ",
        width=15, font=12,
        fg='white', bg='DodgerBlue2', anchor='e')
    ...
    self.birth_lab = tk.Label(self.can, text="Birthday : ",
        width=15, font=12,
        fg='white', bg='DodgerBlue2', anchor='e')
    ...
    self.allerlab = tk.Label(self.can, text="Allergy : ",
        width=15, font=12,
        fg='white', bg='DodgerBlue2', anchor='e')
    ...
    self.t29 = tk.Text(self.can, height=10, width=50, font=18,
        relief=SUNKEN)
    self.wt29_window = self.can.create_window(self.x29, self.y29,
        window=self.t29)

    # Display text in textbox from diag file
    try:
        with open('./diag/doc_diag9/diagrecap9.txt', 'r') as filediag:
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt9/intro_ttt.txt'):
            importationFile('./ttt/doc_ttt9/intro_ttt.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt9/intro_res.txt'):
            importationFile2('./ttt/doc_ttt9/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata9.txt'):
            importationParam('./param/paramdata9.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("+ File paramdata9.txt not found !")
        messagebox.showinfo('INFO', 'File paramdata9.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi9.txt'):
            importationBmi('./calBmi/bmi9.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("+ File bmi9.txt not found !")
        messagebox.showinfo('INFO', 'File bmi9.txt not found !')
    ...
    def launchfunc(ent_name, nt_birth, allertxt, transdis):
        ...
        try:
            ...
            print("+ File rslt_dmst9.txt not found !", nf_rsltdm)
        
        print("!!! rslt_dmst9 initialized !!!")

        try:
            with open('./diag/doc_diag9/diagrecap9.txt', 'r') as file_di:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', '+a') as file_dm:
                    diag_content = file_di.readlines()
                    for li in diag_content:
                        file_dm.writelines(diag_content)
                        break
        except FileNotFoundError as diag_nf:
            print("+ File diagrecap9.txt not found !", diag_nf)

        try:
            with open('./ttt/doc_ttt9/intro_ttt.txt', 'r') as file_ttt:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', '+a') as file_dm:
        ...
        try:
            with open('./ttt/doc_ttt9/intro_res.txt', 'r') as file_res:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', '+a') as file_dm:
        ...
        try:
            with open('./param/paramdata9.txt', 'r') as file_pa:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', '+a') as file_dm:
            ...
            print("+ File paramdata9.txt not found !", param_nf)

        try:
            with open('./calBmi/bmi9.txt', 'r') as file_b:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', '+a') as file_dm:
            ...
            print("+ File bmi9.txt not found !", bmi_nf)

        try:
            with open('./contact/conpact9/finalfile1.txt', 'r') as file_contf1:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact9/finaldoc1.txt', 'r') as file_do1:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact9/finaldoc2.txt', 'r') as file_do2:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact9/finaldoc3.txt', 'r') as file_do3:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact9/finalfam1.txt', 'r') as file_fam:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact9/finalhcs1.txt', 'r') as file_hcs1:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact9/finalhcs2.txt', 'r') as file_hcs2:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact9/finalhcs3.txt', 'r') as file_hcs3:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', '+a') as file_dm:
        ...
        try:
            with open('./auxequip/doc_equip/auxiliary9.txt', 'r') as file_aux:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', '+a') as file_dm:
            ...
            print("+ File auxiliary9.txt not found !", aux_nf)

        print(CheckVar1.get())
        if CheckVar1.get() == 1:
            with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', 'a+') as file1:
                file1.write("\n\n--- AGGIR grid : ---\n")
                file1.write("+ Orientation = 1\n")
        elif CheckVar1.get() == 2:
            with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', 'a+') as file2:
                file2.write("\n\n--- AGGIR grid : ---\n")
                file2.write("+ Orientation = 2\n")
        elif CheckVar1.get() == 3:
            with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', 'a+') as file3:
                file3.write("\n\n--- AGGIR grid : ---\n")
                file3.write("+ Orientation = 3\n")
        elif CheckVar1.get() == 4:
            with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', 'a+') as file4:
                file4.write("\n\n--- AGGIR grid : ---\n")
                file4.write("+ Orientation = 4\n")
        else:
            with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', 'a+') as file0:
                file0.write("\n\n--- AGGIR grid : ---\n")
        ...
        try:
            with open('./dmst_doc/doc_dmst9/parcours.txt', 'r') as ftor:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', 'a+') as ftocp:
        ...
        try:
            with open('./dmst_doc/doc_dmst9/pbm.txt', 'r') as fpbmtor:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', 'a+') as fthreecp:
        ...
        try:
            with open('./dmst_doc/doc_dmst9/project.txt', 'r') as fprojcp:
                with open('./dmst_doc/doc_dmst9/rslt_dmst9.txt', 'a+') as fortocp:
    ...
    self.t87 = tk.Text(self.can, height=6, width=50, font=18,
        relief=SUNKEN)
    self.wt87_window = self.can.create_window(self.x87, self.y87,
        window=self.t87)

    try:
        if os.path.getsize('./auxequip/doc_equip/auxiliary9.txt'):
            importationHealTwo('./auxequip/doc_equip/auxiliary9.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("+ File auxiliary9.txt not found !")
        messagebox.showinfo('INFO', 'File auxiliary9.txt not found !')
    ...
    self.lbl_diranticip = tk.Label(self.can,
        text='Directives anticipées :',
        font="Times 14 bold", width=20, height=1,
        bg='DodgerBlue2', fg='white', anchor='w')
    ...
    try:
        if os.path.getsize('./need/doc_suivi9/main_14b.txt'):
            print("+ File 'main_14b.txt' exist !")
            needimport('./need/doc_suivi9/main_14b.txt')
    ...
    def saveData():
        ...
        """
        try:
            if os.path.getsize('./dmst_doc/doc_dmst9/parcours.txt'):
                print("+ File 'parcours.txt' exist !")
                with open('./dmst_doc/doc_dmst9/parcours.txt', 'w') as parc_file:
    ...
    try:
        if os.path.getsize('./dmst_doc/doc_dmst9/parcours.txt'):
            print("+ File 'parcours.txt' exist !")
            importationFile('./dmst_doc/doc_dmst9/parcours.txt')
    ...
    try:
        if os.path.getsize('./dmst_doc/doc_dmst9/project.txt'):
            print("+ File 'project.txt' exist !")
            projectimport('./dmst_doc/doc_dmst9/project.txt')
    ...
    def copytobackup():
        """
            To copy file below to ./Backup/Files9
        """
        try:
            if os.path.exists('./dmst_doc/doc_dmst9/parcours.txt'):
                shutil.copy('./dmst_doc/doc_dmst9/parcours.txt',
                    './Backup/Files9/parcours.txt')
                print("+ File --> parcours.txt copied into ./Backup/Files9")
        except FileNotFoundError as nf_parco:
            print("Not found", nf_parco)

        try:
            if os.path.exists('./dmst_doc/doc_dmst9/pbm.txt'):
                shutil.copy('./dmst_doc/doc_dmst9/pbm.txt',
                    './Backup/Files9/pbm.txt')
                print("+ File --> pbm.txt copied into ./Backup/Files9")
        except FileNotFoundError as nf_prob:
            print("Not found", nf_prob)

        try:
            if os.path.exists('./dmst_doc/doc_dmst9/project.txt'):
                shutil.copy('./dmst_doc/doc_dmst9/project.txt',
                    './Backup/Files9/project.txt')
                print("+ File --> project.txt copied into ./Backup/Files9")
        except FileNotFoundError as nf_projex:
            print("Not found", nf_projex)

        try:
            if os.path.exists('./dmst_doc/doc_dmst9/rslt_dmst9.txt'):
                shutil.copy('./dmst_doc/doc_dmst9/rslt_dmst9.txt',
                    './Backup/Files9/rslt_dmst9.txt')
                print("+ File --> rslt_dmst9.txt copied into ./Backup/Files9")
    ...
    def uptoserv():
        ...
        """
        proc = subprocess.run(["scp", "./dmst_doc/doc_dmst9/rslt_dmst9.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt9/dmst9/rslt_dmst9.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File rslt_dmst9.txt uploaded !")
            #messagebox.showinfo("INFO", "rslt_dmst9.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No rslt_dmst9.txt to upload...")

        secproc = subprocess.run(["scp", "./dmst_doc/doc_dmst9/parcours.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt9/dmst9/parcours.txt"],
            stderr=subprocess.PIPE)
        ...
        thirdproc = subprocess.run(["scp", "./dmst_doc/doc_dmst9/pbm.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt9/dmst9/pbm.txt"],
            stderr=subprocess.PIPE)
        ...
        forthproc = subprocess.run(["scp", "./dmst_doc/doc_dmst9/project.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt9/dmst9/project.txt"],
            stderr=subprocess.PIPE)
        ...
        fivth = subprocess.run(["scp", "./need/doc_suivi9/main_14b.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt9/dmst9/main_14b.txt"],
            stderr=subprocess.PIPE)
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst9/rslt_dmst9.txt"') # Linux
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst9/rslt_dmst9.txt') # Mac
        else:
            os.startfile('./dmst_doc/doc_dmst9/rslt_dmst9.txt') # Windows
