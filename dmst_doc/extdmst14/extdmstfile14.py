...
def launchfunc(self):
    ...
    try:
        with open('./contact/conpact14/finalfile14.txt', 'r') as file_contf1:
            with open('./dmst_doc/doc_dmst14/rslt_dmst14.txt', '+a') as file_dm:
        ...
        print("[!] File finalfile14.txt not found !", ff1_nf)
    ...
    try:
        with open('./contact/conpact14/finalfam14.txt', 'r') as file_fam:
            with open('./dmst_doc/doc_dmst14/rslt_dmst14.txt', '+a') as file_dm:
        ...
        print("[!] File finalfam14.txt not found !", ffam_nf)
...
def uptoserv():
    ...
    if proc.stderr == b'':
        print("[Upload] File rslt_dmst14.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "rslt_dmst14.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No rslt_dmst14.txt to upload...")
