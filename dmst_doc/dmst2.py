...
def doc_medical2(self):
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst2/rslt_dmst2.txt"') # Linux
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst2/rslt_dmst2.txt') # Mac
        else:
            os.startfile('./dmst_doc/doc_dmst2/rslt_dmst2.txt') # Windows
