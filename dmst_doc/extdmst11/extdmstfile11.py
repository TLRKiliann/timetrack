...
def launchfunc(self):
    ...
    try:
        with open('./contact/conpact11/finalfile11.txt', 'r') as file_contf1:
            with open('./dmst_doc/doc_dmst11/rslt_dmst11.txt', '+a') as file_dm:
        ...
        print("[!] File finalfile11.txt not found !", ff1_nf)
    ...
    try:
        with open('./contact/conpact11/finalfam11.txt', 'r') as file_fam:
            with open('./dmst_doc/doc_dmst11/rslt_dmst11.txt', '+a') as file_dm:
        ...
        print("[!] File finalfam11.txt not found !", ffam_nf)
...
def uptoserv():
    ...
    if proc.stderr == b'':
        print("[Upload] File rslt_dmst11.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "rslt_dmst11.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No rslt_dmst11.txt to upload...")
