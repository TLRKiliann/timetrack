...
def launchfunc(self):
    ...
    try:
        with open('./contact/conpact3/finalfile3.txt', 'r') as file_contf1:
            with open('./dmst_doc/doc_dmst3/rslt_dmst3.txt', '+a') as file_dm:
        ...
        print("[!] File finalfile3.txt not found !", ff1_nf)
    ...
    try:
        with open('./contact/conpact3/finalfam3.txt', 'r') as file_fam:
            with open('./dmst_doc/doc_dmst3/rslt_dmst3.txt', '+a') as file_dm:
        ...
        print("[!] File finalfam3.txt not found !", ffam_nf)
