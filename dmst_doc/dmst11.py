...
import os
import platform
from dmst_doc.extdmst11.extdmstfile11 import importationAdmin
from dmst_doc.extdmst11.extdmstfile11 import importationDoc1
from dmst_doc.extdmst11.extdmstfile11 import importationDoc2
from dmst_doc.extdmst11.extdmstfile11 import importationDoc3
from dmst_doc.extdmst11.extdmstfile11 import importationFam
from dmst_doc.extdmst11.extdmstfile11 import importationHealOne
from dmst_doc.extdmst11.extdmstfile11 import importationHealThree
from dmst_doc.extdmst11.extdmstfile11 import importationFile2
from dmst_doc.extdmst11.extdmstfile11 import importationParam
from dmst_doc.extdmst11.extdmstfile11 import importationBmi
from dmst_doc.extdmst11.extdmstfile11 import launchfunc
from dmst_doc.extdmst11.extdmstfile11 import saveData
from dmst_doc.extdmst11.extdmstfile11 import copytobackup
from dmst_doc.extdmst11.extdmstfile11 import uptoserv
...
def doc_medical11(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt11/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt11/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt11/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt11/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata11.txt'):
            importationParam(self, './param/paramdata11.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata11.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata11.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi11.txt'):
            importationBmi(self, './calBmi/bmi11.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi11.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi11.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact11/finalfile11.txt'):
            importationAdmin(self, './contact/conpact11/finalfile11.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile11.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact11/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact11/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact11/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact11/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact11/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact11/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact11/finalfam11.txt'):
            importationFam(self, './contact/conpact11/finalfam11.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam11.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact11/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact11/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact11/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact11/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File auxiliary11.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst11/rslt_dmst11.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst11/rslt_dmst11.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst11/rslt_dmst11.txt')
