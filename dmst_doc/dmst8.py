...
def doc_medical8(self):
    ...
    with open('./newpatient/entryfile8.txt', 'r') as filename2:
    ...
    try:
        if os.path.getsize('./contact/conpact8/finalfile1.txt'):
            importationAdmin('./contact/conpact8/finalfile1.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./contact/conpact8/finaldoc1.txt'):
            importationDoc1('./contact/conpact8/finaldoc1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact8/finaldoc2.txt'):
            importationDoc2('./contact/conpact8/finaldoc2.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact8/finaldoc3.txt'):
            importationDoc3('./contact/conpact8/finaldoc3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact8/finalfam1.txt'):
            importationFam('./contact/conpact8/finalfam1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact8/finalhcs1.txt'):
            importationHealOne('./contact/conpact8/finalhcs1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact8/finalhcs2.txt'):
            importationHealTwo('./contact/conpact8/finalhcs2.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact8/finalhcs3.txt'):
            importationHealThree('./contact/conpact8/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        with open('./diag/doc_diag8/diagrecap8.txt', 'r') as filediag:
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt8/intro_ttt.txt'):
            importationFile('./ttt/doc_ttt8/intro_ttt.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt8/intro_res.txt'):
            importationFile2('./ttt/doc_ttt8/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata8.txt'):
            importationParam('./param/paramdata8.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("+ File paramdata8.txt not found !")
        messagebox.showinfo('INFO', 'File paramdata8.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi8.txt'):
            importationBmi('./calBmi/bmi8.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("+ File bmi8.txt not found !")
        messagebox.showinfo('INFO', 'File bmi8.txt not found !')
    ...
    def launchfunc(ent_name, nt_birth, allertxt, transdis):
        ...
        try:
            ...
            print("+ File rslt_dmst8.txt not found !", nf_rsltdm)
        
        print("!!! rslt_dmst8 initialized !!!")

        try:
            with open('./diag/doc_diag8/diagrecap8.txt', 'r') as file_di:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', '+a') as file_dm:
                    diag_content = file_di.readlines()
                    for li in diag_content:
                        file_dm.writelines(diag_content)
                        break
        except FileNotFoundError as diag_nf:
            print("+ File diagrecap8.txt not found !", diag_nf)

        try:
            with open('./ttt/doc_ttt8/intro_ttt.txt', 'r') as file_ttt:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', '+a') as file_dm:
        ...
        try:
            with open('./ttt/doc_ttt8/intro_res.txt', 'r') as file_res:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', '+a') as file_dm:
        ...
        try:
            with open('./param/paramdata8.txt', 'r') as file_pa:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', '+a') as file_dm:
            ...
            print("+ File paramdata8.txt not found !", param_nf)

        try:
            with open('./calBmi/bmi8.txt', 'r') as file_b:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', '+a') as file_dm:
            ...
            print("+ File bmi8.txt not found !", bmi_nf)

        try:
            with open('./contact/conpact8/finalfile1.txt', 'r') as file_contf1:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact8/finaldoc1.txt', 'r') as file_do1:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact8/finaldoc2.txt', 'r') as file_do2:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact8/finaldoc3.txt', 'r') as file_do3:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact8/finalfam1.txt', 'r') as file_fam:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact8/finalhcs1.txt', 'r') as file_hcs1:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact8/finalhcs2.txt', 'r') as file_hcs2:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', '+a') as file_dm:
        ...
        try:
            with open('./contact/conpact8/finalhcs3.txt', 'r') as file_hcs3:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', '+a') as file_dm:
        ...
        try:
            with open('./auxequip/doc_equip/auxiliary8.txt', 'r') as file_aux:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', '+a') as file_dm:
            ...
            print("+ File auxiliary8.txt not found !", aux_nf)

        print(CheckVar1.get())
        if CheckVar1.get() == 1:
            with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', 'a+') as file1:
                file1.write("\n\n--- AGGIR grid : ---\n")
                file1.write("+ Orientation = 1\n")
        elif CheckVar1.get() == 2:
            with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', 'a+') as file2:
                file2.write("\n\n--- AGGIR grid : ---\n")
                file2.write("+ Orientation = 2\n")
        elif CheckVar1.get() == 3:
            with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', 'a+') as file3:
                file3.write("\n\n--- AGGIR grid : ---\n")
                file3.write("+ Orientation = 3\n")
        elif CheckVar1.get() == 4:
            with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', 'a+') as file4:
                file4.write("\n\n--- AGGIR grid : ---\n")
                file4.write("+ Orientation = 4\n")
        else:
            with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', 'a+') as file0:
                file0.write("\n\n--- AGGIR grid : ---\n")
        ...
        try:
            with open('./dmst_doc/doc_dmst8/parcours.txt', 'r') as ftor:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', 'a+') as ftocp:
        ...
        try:
            with open('./dmst_doc/doc_dmst8/pbm.txt', 'r') as fpbmtor:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', 'a+') as fthreecp:
        ...
        try:
            with open('./dmst_doc/doc_dmst8/project.txt', 'r') as fprojcp:
                with open('./dmst_doc/doc_dmst8/rslt_dmst8.txt', 'a+') as fortocp:
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip/auxiliary8.txt'):
            importationHealTwo('./auxequip/doc_equip/auxiliary8.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("+ File auxiliary8.txt not found !")
        messagebox.showinfo('INFO', 'File auxiliary8.txt not found !')
    ...
    try:
        if os.path.getsize('./need/doc_suivi8/main_14b.txt'):
            ...
            needimport('./need/doc_suivi8/main_14b.txt')
    ...
    def saveData():
        ...
        """
        try:
            if os.path.getsize('./dmst_doc/doc_dmst8/parcours.txt'):
                print("+ File 'parcours.txt' exist !")
                with open('./dmst_doc/doc_dmst8/parcours.txt', 'w') as parc_file:
    ...
    try:
        if os.path.getsize('./dmst_doc/doc_dmst8/parcours.txt'):
            print("+ File 'parcours.txt' exist !")
            importationFile('./dmst_doc/doc_dmst8/parcours.txt')
    ...
    try:
        if os.path.getsize('./dmst_doc/doc_dmst8/pbm.txt'):
            print("+ File 'pbm.txt' exist !")
            pbmimport('./dmst_doc/doc_dmst8/pbm.txt')
    ...
    try:
        if os.path.getsize('./dmst_doc/doc_dmst8/project.txt'):
            print("+ File 'project.txt' exist !")
            projectimport('./dmst_doc/doc_dmst8/project.txt')
    ...
    def copytobackup():
        """
            To copy file below to ./Backup/Files8
        """
        try:
            if os.path.exists('./dmst_doc/doc_dmst8/parcours.txt'):
                shutil.copy('./dmst_doc/doc_dmst8/parcours.txt',
                    './Backup/Files8/parcours.txt')
                print("+ File --> parcours.txt copied into ./Backup/Files8")
        except FileNotFoundError as nf_parco:
            print("Not found", nf_parco)

        try:
            if os.path.exists('./dmst_doc/doc_dmst8/pbm.txt'):
                shutil.copy('./dmst_doc/doc_dmst8/pbm.txt',
                    './Backup/Files8/pbm.txt')
                print("+ File --> pbm.txt copied into ./Backup/Files8")
        except FileNotFoundError as nf_prob:
            print("Not found", nf_prob)

        try:
            if os.path.exists('./dmst_doc/doc_dmst8/project.txt'):
                shutil.copy('./dmst_doc/doc_dmst8/project.txt',
                    './Backup/Files8/project.txt')
                print("+ File --> project.txt copied into ./Backup/Files8")
        except FileNotFoundError as nf_projex:
            print("Not found", nf_projex)

        try:
            if os.path.exists('./dmst_doc/doc_dmst8/rslt_dmst8.txt'):
                shutil.copy('./dmst_doc/doc_dmst8/rslt_dmst8.txt',
                    './Backup/Files8/rslt_dmst8.txt')
                print("+ File --> rslt_dmst8.txt copied into ./Backup/Files8")
    ...
    def uptoserv():
        ...
        """
        proc = subprocess.run(["scp", "./dmst_doc/doc_dmst8/rslt_dmst8.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt8/dmst8/rslt_dmst8.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File rslt_dmst8.txt uploaded !")
            #messagebox.showinfo("INFO", "rslt_dmst8.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No rslt_dmst8.txt to upload...")

        secproc = subprocess.run(["scp", "./dmst_doc/doc_dmst8/parcours.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt8/dmst8/parcours.txt"],
            stderr=subprocess.PIPE)
        ...
        thirdproc = subprocess.run(["scp", "./dmst_doc/doc_dmst8/pbm.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt8/dmst8/pbm.txt"],
            stderr=subprocess.PIPE)
        ...
        forthproc = subprocess.run(["scp", "./dmst_doc/doc_dmst8/project.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt8/dmst8/project.txt"],
            stderr=subprocess.PIPE)
        ...
        fivth = subprocess.run(["scp", "./need/doc_suivi8/main_14b.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt8/dmst8/main_14b.txt"],
            stderr=subprocess.PIPE)
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst8/rslt_dmst8.txt"') # Linux
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst8/rslt_dmst8.txt') # Mac
        else:
            os.startfile('./dmst_doc/doc_dmst8/rslt_dmst8.txt') # Windows
