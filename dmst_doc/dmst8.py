...
import os
import platform
from dmst_doc.extdmst8.extdmstfile8 import importationAdmin
from dmst_doc.extdmst8.extdmstfile8 import importationDoc1
from dmst_doc.extdmst8.extdmstfile8 import importationDoc2
from dmst_doc.extdmst8.extdmstfile8 import importationDoc3
from dmst_doc.extdmst8.extdmstfile8 import importationFam
from dmst_doc.extdmst8.extdmstfile8 import importationHealOne
from dmst_doc.extdmst8.extdmstfile8 import importationHealThree
from dmst_doc.extdmst8.extdmstfile8 import importationFile2
from dmst_doc.extdmst8.extdmstfile8 import importationParam
from dmst_doc.extdmst8.extdmstfile8 import importationBmi
from dmst_doc.extdmst8.extdmstfile8 import launchfunc
from dmst_doc.extdmst8.extdmstfile8 import saveData
from dmst_doc.extdmst8.extdmstfile8 import copytobackup
from dmst_doc.extdmst8.extdmstfile8 import uptoserv
...
def doc_medical8(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt8/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt8/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt8/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt8/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata8.txt'):
            importationParam(self, './param/paramdata8.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata8.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata8.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi8.txt'):
            importationBmi(self, './calBmi/bmi8.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi8.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi8.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact8/finalfile8.txt'):
            importationAdmin(self, './contact/conpact8/finalfile8.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile8.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact8/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact8/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact8/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact8/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact8/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact8/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact8/finalfam8.txt'):
            importationFam(self, './contact/conpact8/finalfam8.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam8.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam8.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact8/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact8/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact8/finalhcs2.txt'):
            importationHealTwo('./contact/conpact8/finalhcs2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact8/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact8/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip/auxiliary8.txt'):
            importationHealTwo('./auxequip/doc_equip/auxiliary8.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File auxiliary8.txt not found !")
        tk.messagebox.showinfo('INFO', 'File auxiliary8.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst8/rslt_dmst8.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst8/rslt_dmst8.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst8/rslt_dmst8.txt')
