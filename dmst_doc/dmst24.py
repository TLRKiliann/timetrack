...
import os
import platform
from dmst_doc.extdmst24.extdmstfile24 import importationAdmin
from dmst_doc.extdmst24.extdmstfile24 import importationDoc1
from dmst_doc.extdmst24.extdmstfile24 import importationDoc2
from dmst_doc.extdmst24.extdmstfile24 import importationDoc3
from dmst_doc.extdmst24.extdmstfile24 import importationFam
from dmst_doc.extdmst24.extdmstfile24 import importationHealOne
from dmst_doc.extdmst24.extdmstfile24 import importationHealThree
from dmst_doc.extdmst24.extdmstfile24 import importationFile2
from dmst_doc.extdmst24.extdmstfile24 import importationParam
from dmst_doc.extdmst24.extdmstfile24 import importationBmi
from dmst_doc.extdmst24.extdmstfile24 import launchfunc
from dmst_doc.extdmst24.extdmstfile24 import saveData
from dmst_doc.extdmst24.extdmstfile24 import copytobackup
from dmst_doc.extdmst24.extdmstfile24 import uptoserv
...
def doc_medical24(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt24/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt24/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt24/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt24/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata24.txt'):
            importationParam(self, './param/paramdata24.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata24.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata24.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi24.txt'):
            importationBmi(self, './calBmi/bmi24.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi24.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi24.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact24/finalfile24.txt'):
            importationAdmin(self, './contact/conpact24/finalfile24.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile24.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact24/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact24/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact24/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact24/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact24/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact24/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact24/finalfam24.txt'):
            importationFam(self, './contact/conpact24/finalfam24.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam24.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam24.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact24/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact24/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact24/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact24/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File auxiliary24.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst24/rslt_dmst24.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst24/rslt_dmst24.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst24/rslt_dmst24.txt')
