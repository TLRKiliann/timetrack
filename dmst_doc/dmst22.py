...
import os
import platform
from dmst_doc.extdmst22.extdmstfile22 import importationAdmin
from dmst_doc.extdmst22.extdmstfile22 import importationDoc1
from dmst_doc.extdmst22.extdmstfile22 import importationDoc2
from dmst_doc.extdmst22.extdmstfile22 import importationDoc3
from dmst_doc.extdmst22.extdmstfile22 import importationFam
from dmst_doc.extdmst22.extdmstfile22 import importationHealOne
from dmst_doc.extdmst22.extdmstfile22 import importationHealThree
from dmst_doc.extdmst22.extdmstfile22 import importationFile2
from dmst_doc.extdmst22.extdmstfile22 import importationParam
from dmst_doc.extdmst22.extdmstfile22 import importationBmi
from dmst_doc.extdmst22.extdmstfile22 import launchfunc
from dmst_doc.extdmst22.extdmstfile22 import saveData
from dmst_doc.extdmst22.extdmstfile22 import copytobackup
from dmst_doc.extdmst22.extdmstfile22 import uptoserv
...
def doc_medical22(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt22/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt22/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt22/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt22/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata22.txt'):
            importationParam(self, './param/paramdata22.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata22.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata22.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi22.txt'):
            importationBmi(self, './calBmi/bmi22.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi22.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi22.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact22/finalfile22.txt'):
            importationAdmin(self, './contact/conpact22/finalfile22.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile22.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact22/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact22/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact22/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact22/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact22/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact22/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact22/finalfam22.txt'):
            importationFam(self, './contact/conpact22/finalfam22.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam22.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam22.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact22/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact22/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact22/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact22/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File auxiliary22.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst22/rslt_dmst22.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst22/rslt_dmst22.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst22/rslt_dmst22.txt')
