...
import os
import platform
from dmst_doc.extdmst10.extdmstfile10 import importationAdmin
from dmst_doc.extdmst10.extdmstfile10 import importationDoc1
from dmst_doc.extdmst10.extdmstfile10 import importationDoc2
from dmst_doc.extdmst10.extdmstfile10 import importationDoc3
from dmst_doc.extdmst10.extdmstfile10 import importationFam
from dmst_doc.extdmst10.extdmstfile10 import importationHealOne
from dmst_doc.extdmst10.extdmstfile10 import importationHealThree
from dmst_doc.extdmst10.extdmstfile10 import importationFile2
from dmst_doc.extdmst10.extdmstfile10 import importationParam
from dmst_doc.extdmst10.extdmstfile10 import importationBmi
from dmst_doc.extdmst10.extdmstfile10 import launchfunc
from dmst_doc.extdmst10.extdmstfile10 import saveData
from dmst_doc.extdmst10.extdmstfile10 import copytobackup
from dmst_doc.extdmst10.extdmstfile10 import uptoserv
...
def doc_medical10(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt10/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt10/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt10/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt10/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata10.txt'):
            importationParam(self, './param/paramdata10.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata10.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata10.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi10.txt'):
            importationBmi(self, './calBmi/bmi10.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi10.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi10.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact10/finalfile10.txt'):
            importationAdmin(self, './contact/conpact10/finalfile10.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile10.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact10/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact10/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact10/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact10/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact10/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact10/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact10/finalfam10.txt'):
            importationFam(self, './contact/conpact10/finalfam10.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact10/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact10/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact10/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact10/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File auxiliary10.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst10/rslt_dmst10.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst10/rslt_dmst10.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst10/rslt_dmst10.txt')
