...
import os
import platform
from dmst_doc.extdmst19.extdmstfile19 import importationAdmin
from dmst_doc.extdmst19.extdmstfile19 import importationDoc1
from dmst_doc.extdmst19.extdmstfile19 import importationDoc2
from dmst_doc.extdmst19.extdmstfile19 import importationDoc3
from dmst_doc.extdmst19.extdmstfile19 import importationFam
from dmst_doc.extdmst19.extdmstfile19 import importationHealOne
from dmst_doc.extdmst19.extdmstfile19 import importationHealThree
from dmst_doc.extdmst19.extdmstfile19 import importationFile2
from dmst_doc.extdmst19.extdmstfile19 import importationParam
from dmst_doc.extdmst19.extdmstfile19 import importationBmi
from dmst_doc.extdmst19.extdmstfile19 import launchfunc
from dmst_doc.extdmst19.extdmstfile19 import saveData
from dmst_doc.extdmst19.extdmstfile19 import copytobackup
from dmst_doc.extdmst19.extdmstfile19 import uptoserv
...
def doc_medical19(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt19/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt19/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt19/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt19/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata19.txt'):
            importationParam(self, './param/paramdata19.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata19.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata19.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi19.txt'):
            importationBmi(self, './calBmi/bmi19.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi19.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi19.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact19/finalfile19.txt'):
            importationAdmin(self, './contact/conpact19/finalfile19.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile19.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact19/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact19/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact19/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact19/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact19/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact19/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact19/finalfam19.txt'):
            importationFam(self, './contact/conpact19/finalfam19.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam19.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam19.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact19/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact19/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact19/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact19/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File auxiliary19.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst19/rslt_dmst19.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst19/rslt_dmst19.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst19/rslt_dmst19.txt')
