...
def launchfunc(self):
    ...
    try:
        with open('./contact/conpact5/finalfile5.txt', 'r') as file_contf1:
            with open('./dmst_doc/doc_dmst5/rslt_dmst5.txt', '+a') as file_dm:
        ...
        print("[!] File finalfile2.txt not found !", ff1_nf)
    ...
    try:
        with open('./contact/conpact5/finalfam5.txt', 'r') as file_fam:
            with open('./dmst_doc/doc_dmst5/rslt_dmst5.txt', '+a') as file_dm:
        ...
        print("[!] File finalfam2.txt not found !", ffam_nf)
...
def uptoserv():
    ...
    if proc.stderr == b'':
        print("[Upload] File rslt_dmst5.txt uploaded !")
        #tk.messagebox.showinfo("INFO", "rslt_dmst5.txt uploaded...")
    else:
        print("[!] No file to upload !")
        tk.messagebox.showerror("Error", "No rslt_dmst5.txt to upload...")
