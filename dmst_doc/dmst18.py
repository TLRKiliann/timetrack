...
import os
import platform
from dmst_doc.extdmst18.extdmstfile18 import importationAdmin
from dmst_doc.extdmst18.extdmstfile18 import importationDoc1
from dmst_doc.extdmst18.extdmstfile18 import importationDoc2
from dmst_doc.extdmst18.extdmstfile18 import importationDoc3
from dmst_doc.extdmst18.extdmstfile18 import importationFam
from dmst_doc.extdmst18.extdmstfile18 import importationHealOne
from dmst_doc.extdmst18.extdmstfile18 import importationHealThree
from dmst_doc.extdmst18.extdmstfile18 import importationFile2
from dmst_doc.extdmst18.extdmstfile18 import importationParam
from dmst_doc.extdmst18.extdmstfile18 import importationBmi
from dmst_doc.extdmst18.extdmstfile18 import launchfunc
from dmst_doc.extdmst18.extdmstfile18 import saveData
from dmst_doc.extdmst18.extdmstfile18 import copytobackup
from dmst_doc.extdmst18.extdmstfile18 import uptoserv
...
def doc_medical18(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt18/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt18/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt18/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt18/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata18.txt'):
            importationParam(self, './param/paramdata18.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata18.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata18.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi18.txt'):
            importationBmi(self, './calBmi/bmi18.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi18.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi18.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact18/finalfile18.txt'):
            importationAdmin(self, './contact/conpact18/finalfile18.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile18.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact18/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact18/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact18/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact18/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact18/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact18/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact18/finalfam18.txt'):
            importationFam(self, './contact/conpact18/finalfam18.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam18.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam18.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact18/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact18/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact18/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact18/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File auxiliary18.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst18/rslt_dmst18.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst18/rslt_dmst18.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst18/rslt_dmst18.txt')
