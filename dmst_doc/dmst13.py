...
import os
import platform
from dmst_doc.extdmst13.extdmstfile13 import importationAdmin
from dmst_doc.extdmst13.extdmstfile13 import importationDoc1
from dmst_doc.extdmst13.extdmstfile13 import importationDoc2
from dmst_doc.extdmst13.extdmstfile13 import importationDoc3
from dmst_doc.extdmst13.extdmstfile13 import importationFam
from dmst_doc.extdmst13.extdmstfile13 import importationHealOne
from dmst_doc.extdmst13.extdmstfile13 import importationHealThree
from dmst_doc.extdmst13.extdmstfile13 import importationFile2
from dmst_doc.extdmst13.extdmstfile13 import importationParam
from dmst_doc.extdmst13.extdmstfile13 import importationBmi
from dmst_doc.extdmst13.extdmstfile13 import launchfunc
from dmst_doc.extdmst13.extdmstfile13 import saveData
from dmst_doc.extdmst13.extdmstfile13 import copytobackup
from dmst_doc.extdmst13.extdmstfile13 import uptoserv
...
def doc_medical13(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt13/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt13/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt13/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt13/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata13.txt'):
            importationParam(self, './param/paramdata13.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata13.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata13.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact13/finalfile13.txt'):
            importationAdmin(self, './contact/conpact13/finalfile13.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile13.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact13/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact13/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact13/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact13/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact13/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact13/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact13/finalfam13.txt'):
            importationFam(self, './contact/conpact13/finalfam13.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam13.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam13.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact13/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact13/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact13/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact13/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File auxiliary13.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst13/rslt_dmst13.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst13/rslt_dmst13.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst13/rslt_dmst13.txt')
