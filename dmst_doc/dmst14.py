...
import os
import platform
from dmst_doc.extdmst14.extdmstfile14 import importationAdmin
from dmst_doc.extdmst14.extdmstfile14 import importationDoc1
from dmst_doc.extdmst14.extdmstfile14 import importationDoc2
from dmst_doc.extdmst14.extdmstfile14 import importationDoc3
from dmst_doc.extdmst14.extdmstfile14 import importationFam
from dmst_doc.extdmst14.extdmstfile14 import importationHealOne
from dmst_doc.extdmst14.extdmstfile14 import importationHealThree
from dmst_doc.extdmst14.extdmstfile14 import importationFile2
from dmst_doc.extdmst14.extdmstfile14 import importationParam
from dmst_doc.extdmst14.extdmstfile14 import importationBmi
from dmst_doc.extdmst14.extdmstfile14 import launchfunc
from dmst_doc.extdmst14.extdmstfile14 import saveData
from dmst_doc.extdmst14.extdmstfile14 import copytobackup
from dmst_doc.extdmst14.extdmstfile14 import uptoserv
...
def doc_medical14(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt14/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt14/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt14/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt14/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata14.txt'):
            importationParam(self, './param/paramdata14.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata14.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata14.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi14.txt'):
            importationBmi(self, './calBmi/bmi14.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi14.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi14.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact14/finalfile14.txt'):
            importationAdmin(self, './contact/conpact14/finalfile14.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile14.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact14/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact14/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact14/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact14/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact14/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact14/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact14/finalfam14.txt'):
            importationFam(self, './contact/conpact14/finalfam14.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam14.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam14.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact14/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact14/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact14/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact14/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File auxiliary14.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst14/rslt_dmst14.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst14/rslt_dmst14.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst14/rslt_dmst14.txt')
