...
import os
import platform
from dmst_doc.extdmst4.extdmstfile4 import importationAdmin
from dmst_doc.extdmst4.extdmstfile4 import importationDoc1
from dmst_doc.extdmst4.extdmstfile4 import importationDoc2
from dmst_doc.extdmst4.extdmstfile4 import importationDoc3
from dmst_doc.extdmst4.extdmstfile4 import importationFam
from dmst_doc.extdmst4.extdmstfile4 import importationHealOne
from dmst_doc.extdmst4.extdmstfile4 import importationHealThree
from dmst_doc.extdmst4.extdmstfile4 import importationFile2
from dmst_doc.extdmst4.extdmstfile4 import importationParam
from dmst_doc.extdmst4.extdmstfile4 import importationBmi
from dmst_doc.extdmst4.extdmstfile4 import launchfunc
from dmst_doc.extdmst4.extdmstfile4 import saveData
from dmst_doc.extdmst4.extdmstfile4 import copytobackup
from dmst_doc.extdmst4.extdmstfile4 import uptoserv
...
def doc_medical4(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt4/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt4/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt4/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt4/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata4.txt'):
            importationParam(self, './param/paramdata4.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./calBmi/bmi4.txt'):
            importationBmi(self, './calBmi/bmi4.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.exists('./contact/conpact4/finalfile4.txt'):
            importationAdmin(self, './contact/conpact4/finalfile4.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact4/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact4/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact4/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact4/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact4/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact4/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact4/finalfam4.txt'):
            importationFam(self, './contact/conpact4/finalfam4.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam4.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam4.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact4/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact4/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact4/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact4/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
