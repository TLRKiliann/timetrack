...
def doc_medical4(self):
    ...
    try:
        if os.path.getsize('./contact/conpact4/finalfile1.txt'):
            importationAdmin('./contact/conpact4/finalfile1.txt', encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip/auxiliary4.txt'):
            importationHealTwo('./auxequip/doc_equip/auxiliary4.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File auxiliary4.txt not found !")
        tk.messagebox.showinfo('INFO', 'File auxiliary4.txt not found !')
    ...
    def uptoserv():
        ...
        if proc.stderr == b'':
            print("[Upload] File rslt_dmst4.txt uploaded !")
            #tk.messagebox.showinfo("INFO", "rslt_dmst4.txt uploaded...")
        else:
            print("[!] No file to upload !")
            tk.messagebox.showerror("Error", "No rslt_dmst4.txt to upload...")
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst4/rslt_dmst4.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst4/rslt_dmst4.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst4/rslt_dmst4.txt')
