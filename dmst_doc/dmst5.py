...
import os
import platform
from dmst_doc.extdmst5.extdmstfile5 import importationAdmin
from dmst_doc.extdmst5.extdmstfile5 import importationDoc1
from dmst_doc.extdmst5.extdmstfile5 import importationDoc2
from dmst_doc.extdmst5.extdmstfile5 import importationDoc3
from dmst_doc.extdmst5.extdmstfile5 import importationFam
from dmst_doc.extdmst5.extdmstfile5 import importationHealOne
from dmst_doc.extdmst5.extdmstfile5 import importationHealThree
from dmst_doc.extdmst5.extdmstfile5 import importationFile2
from dmst_doc.extdmst5.extdmstfile5 import importationParam
from dmst_doc.extdmst5.extdmstfile5 import importationBmi
from dmst_doc.extdmst5.extdmstfile5 import launchfunc
from dmst_doc.extdmst5.extdmstfile5 import saveData
from dmst_doc.extdmst5.extdmstfile5 import copytobackup
from dmst_doc.extdmst5.extdmstfile5 import uptoserv
...
def doc_medical5(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt5/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt5/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt5/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt5/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata5.txt'):
            importationParam(self, './param/paramdata5.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata5.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata5.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi5.txt'):
            importationBmi(self, './calBmi/bmi5.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi5.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi5.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact5/finalfile5.txt'):
            importationAdmin(self, './contact/conpact5/finalfile5.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile5.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact5/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact5/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact5/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact5/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact5/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact5/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact5/finalfam5.txt'):
            importationFam(self, './contact/conpact5/finalfam5.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam5.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam5.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact5/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact5/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact5/finalhcs2.txt'):
            importationHealTwo('./contact/conpact5/finalhcs2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact5/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact5/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip/auxiliary5.txt'):
            importationHealTwo('./auxequip/doc_equip/auxiliary5.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File auxiliary5.txt not found !")
        tk.messagebox.showinfo('INFO', 'File auxiliary5.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst5/rslt_dmst5.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst5/rslt_dmst5.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst5/rslt_dmst5.txt')
