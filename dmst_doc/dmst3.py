...
def doc_medical3(self):
    ...
    try:
        if os.path.getsize('./contact/conpact3/finalfile1.txt'):
            importationAdmin('./contact/conpact3/finalfile1.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./contact/conpact3/finaldoc1.txt'):
            importationDoc1('./contact/conpact3/finaldoc1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact3/finaldoc2.txt'):
            importationDoc2('./contact/conpact3/finaldoc2.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact3/finaldoc3.txt'):
            importationDoc3('./contact/conpact3/finaldoc3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact3/finalfam1.txt'):
            importationFam('./contact/conpact3/finalfam1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact3/finalhcs1.txt'):
            importationHealOne('./contact/conpact3/finalhcs1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact3/finalhcs2.txt'):
            importationHealTwo('./contact/conpact3/finalhcs2.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        messagebox.showinfo('INFO', 'File paramdata3.txt not found !')
    ...
    try:
        ...
        print("+ File bmi3.txt not found !")
        messagebox.showinfo('INFO', 'File bmi3.txt not found !')
    ...
    def launchfunc(ent_name, nt_birth, allertxt, transdis):
        ...
        try:
            ...
            print("+ File bmi3.txt not found !", bmi_nf)
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip/auxiliary3.txt'):
            importationHealTwo('./auxequip/doc_equip/auxiliary3.txt',
            	encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("+ File auxiliary3.txt not found !")
        messagebox.showinfo('INFO', 'File auxiliary3.txt not found !')
    ...
    def uptoserv():
        ...
        if proc.stderr == b'':
            print("+ File rslt_dmst3.txt uploaded !")
            #messagebox.showinfo("INFO", "rslt_dmst3.txt uploaded...")
        else:
            print("+ No file to upload !")
            messagebox.showerror("Error", "No rslt_dmst3.txt to upload...")
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst3/rslt_dmst3.txt"') # Linux
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst3/rslt_dmst3.txt') # Mac
        else:
            os.startfile('./dmst_doc/doc_dmst3/rslt_dmst3.txt') # Windows
