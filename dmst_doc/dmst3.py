...
import os
import platform
from dmst_doc.extdmst3.extdmstfile3 import importationAdmin
from dmst_doc.extdmst3.extdmstfile3 import importationDoc1
from dmst_doc.extdmst3.extdmstfile3 import importationDoc2
from dmst_doc.extdmst3.extdmstfile3 import importationDoc3
from dmst_doc.extdmst3.extdmstfile3 import importationFam
from dmst_doc.extdmst3.extdmstfile3 import importationHealOne
from dmst_doc.extdmst3.extdmstfile3 import importationHealThree
from dmst_doc.extdmst3.extdmstfile3 import importationFile2
from dmst_doc.extdmst3.extdmstfile3 import importationParam
from dmst_doc.extdmst3.extdmstfile3 import importationBmi
from dmst_doc.extdmst3.extdmstfile3 import launchfunc
from dmst_doc.extdmst3.extdmstfile3 import saveData
from dmst_doc.extdmst3.extdmstfile3 import copytobackup
from dmst_doc.extdmst3.extdmstfile3 import uptoserv
...
def doc_medical3(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt3/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt3/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt3/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt3/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata3.txt'):
            importationParam(self, './param/paramdata3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./calBmi/bmi3.txt'):
            importationBmi(self, './calBmi/bmi3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi3.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi3.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact3/finalfile3.txt'):
            importationAdmin(self, './contact/conpact3/finalfile3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile3.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact3/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact3/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact3/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact3/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact3/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact3/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact3/finalfam3.txt'):
            importationFam(self, './contact/conpact3/finalfam3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam3.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam3.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact3/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact3/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact3/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact3/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
