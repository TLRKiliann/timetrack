...
def launchfunc(self):
    ...
    try:
        ...
        print("[!] No rslt_dmst1.txt exist !", fnf_totry)
    ...
    try:
        with open('./contact/conpact1/finaldoc1.txt', 'r') as file_do1:
            with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', '+a') as file_dm:
    ...
    try:
        with open('./contact/conpact1/finaldoc2.txt', 'r') as file_do2:
            with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', '+a') as file_dm:
    ...
    try:
        with open('./contact/conpact1/finaldoc3.txt', 'r') as file_do3:
            with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', '+a') as file_dm:
    ...
    try:
        with open('./contact/conpact1/finalfam1.txt', 'r') as file_fam:
            with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', '+a') as file_dm:
    ...
    try:
        with open('./contact/conpact1/finalhcs1.txt', 'r') as file_hcs1:
            with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', '+a') as file_dm:
    ...
    try:
        with open('./contact/conpact1/finalhcs2.txt', 'r') as file_hcs2:
            with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', '+a') as file_dm:
    ...
    try:
        with open('./contact/conpact1/finalhcs3.txt', 'r') as file_hcs3:
            with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', '+a') as file_dm:
...
def copytobackup():
    ...
    try:
        if os.path.exists('./dmst_doc/doc_dmst1/parcours.txt'):
            ...
            print("[+] File --> parcours.txt copied into ./Backup/Files1")
    ...
    try:
        if os.path.exists('./dmst_doc/doc_dmst1/pbm.txt'):
            ...
            print("[+] File --> pbm.txt copied into ./Backup/Files1")
    ...
    try:
        if os.path.exists('./dmst_doc/doc_dmst1/project.txt'):
            ...
            print("[+] File --> project.txt copied into ./Backup/Files1")
    ...
    try:
        if os.path.exists('./dmst_doc/doc_dmst1/rslt_dmst1.txt'):
            ...
            print("[+] File --> rslt_dmst1.txt copied into ./Backup/Files1")
...
def uptoserv():
    ...
    if proc.stderr == b'':
        print("[Upload] File rslt_dmst1.txt uploaded !")
