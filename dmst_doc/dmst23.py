...
import os
import platform
from dmst_doc.extdmst23.extdmstfile23 import importationAdmin
from dmst_doc.extdmst23.extdmstfile23 import importationDoc1
from dmst_doc.extdmst23.extdmstfile23 import importationDoc2
from dmst_doc.extdmst23.extdmstfile23 import importationDoc3
from dmst_doc.extdmst23.extdmstfile23 import importationFam
from dmst_doc.extdmst23.extdmstfile23 import importationHealOne
from dmst_doc.extdmst23.extdmstfile23 import importationHealThree
from dmst_doc.extdmst23.extdmstfile23 import importationFile2
from dmst_doc.extdmst23.extdmstfile23 import importationParam
from dmst_doc.extdmst23.extdmstfile23 import importationBmi
from dmst_doc.extdmst23.extdmstfile23 import launchfunc
from dmst_doc.extdmst23.extdmstfile23 import saveData
from dmst_doc.extdmst23.extdmstfile23 import copytobackup
from dmst_doc.extdmst23.extdmstfile23 import uptoserv
...
def doc_medical23(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt23/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt23/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt23/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt23/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata23.txt'):
            importationParam(self, './param/paramdata23.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata23.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata23.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi23.txt'):
            importationBmi(self, './calBmi/bmi23.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi23.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi23.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact23/finalfile23.txt'):
            importationAdmin(self, './contact/conpact23/finalfile23.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile23.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact23/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact23/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact23/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact23/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact23/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact23/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact23/finalfam23.txt'):
            importationFam(self, './contact/conpact23/finalfam23.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam23.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam23.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact23/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact23/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact23/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact23/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File auxiliary23.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst23/rslt_dmst23.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst23/rslt_dmst23.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst23/rslt_dmst23.txt')
