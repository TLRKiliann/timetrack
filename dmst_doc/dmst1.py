...
def doc_medical1(self):
    ...
    self.labl_title = tk.Label(self.can,
        text='--- Personal Data ---',
    ...
    try:
        if os.path.getsize('./contact/conpact/finalfile1.txt'):
            importationAdmin('./contact/conpact/finalfile1.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./contact/conpact/finaldoc1.txt'):
            importationDoc1('./contact/conpact/finaldoc1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact/finaldoc2.txt'):
            importationDoc2('./contact/conpact/finaldoc2.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact/finaldoc3.txt'):
            importationDoc3('./contact/conpact/finaldoc3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact/finalfam1.txt'):
            importationFam('./contact/conpact/finalfam1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact/finalhcs1.txt'):
            importationHealOne('./contact/conpact/finalhcs1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact/finalhcs2.txt'):
            importationHealTwo('./contact/conpact/finalhcs2.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact/finalhcs3.txt'):
            importationHealThree('./contact/conpact/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt/intro_ttt.txt'):
            importationFile('./ttt/doc_ttt/intro_ttt.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt/intro_res.txt'):
            importationFile2('./ttt/doc_ttt/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File paramdata1.txt not found !')
    ...
    def launchfunc(ent_name, nt_birth, allertxt, transdis):
        ...
        print(CheckVar1.get())
        if CheckVar1.get() == 1:
            with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', 'a+') as file1:
                file1.write("\n\n--- AGGIR grid : ---\n")
                file1.write("+ Orientation = 1\n")
        elif CheckVar1.get() == 2:
            with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', 'a+') as file2:
                file2.write("\n\n--- AGGIR grid : ---\n")
                file2.write("+ Orientation = 2\n")
        elif CheckVar1.get() == 3:
            with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', 'a+') as file3:
                file3.write("\n\n--- AGGIR grid : ---\n")
                file3.write("+ Orientation = 3\n")
        elif CheckVar1.get() == 4:
            with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', 'a+') as file4:
                file4.write("\n\n--- AGGIR grid : ---\n")
                file4.write("+ Orientation = 4\n")
        else:
            with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', 'a+') as file0:
                file0.write("\n\n--- AGGIR grid : ---\n")
        ...
        try:
            with open('./dmst_doc/doc_dmst1/parcours.txt', 'r') as ftor:
                with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', 'a+') as ftocp:
        ...
        try:
            with open('./dmst_doc/doc_dmst1/pbm.txt', 'r') as fpbmtor:
                with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', 'a+') as fthreecp:
        ...
        try:
            with open('./dmst_doc/doc_dmst1/project.txt', 'r') as fprojcp:
                with open('./dmst_doc/doc_dmst1/rslt_dmst1.txt', 'a+') as fortocp:
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip/auxiliary1.txt'):
            importationHealTwo('./auxequip/doc_equip/auxiliary1.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("+ File auxiliary1.txt not found !")
        tk.messagebox.showinfo('INFO', 'File auxiliary1.txt not found !')
    ...
    def saveData():
        ...
        """
        try:
            if os.path.getsize('./dmst_doc/doc_dmst1/parcours.txt'):
                print("+ File 'parcours.txt' exist !")
                with open('./dmst_doc/doc_dmst1/parcours.txt', 'w') as parc_file:
    ...
    try:
        if os.path.getsize('./dmst_doc/doc_dmst1/parcours.txt'):
            print("+ File 'parcours.txt' exist !")
            importationFile('./dmst_doc/doc_dmst1/parcours.txt')
    ...
    try:
        if os.path.getsize('./dmst_doc/doc_dmst1/pbm.txt'):
            print("+ File 'pbm.txt' exist !")
            pbmimport('./dmst_doc/doc_dmst1/pbm.txt')
    ...
    try:
        if os.path.getsize('./dmst_doc/doc_dmst1/project.txt'):
            print("+ File 'project.txt' exist !")
            projectimport('./dmst_doc/doc_dmst1/project.txt')
    ...
    def copytobackup():
        ...
        """
        try:
            if os.path.exists('./dmst_doc/doc_dmst1/parcours.txt'):
                shutil.copy('./dmst_doc/doc_dmst1/parcours.txt',
        ...
        try:
            if os.path.exists('./dmst_doc/doc_dmst1/pbm.txt'):
                shutil.copy('./dmst_doc/doc_dmst1/pbm.txt',
        ...
        try:
            if os.path.exists('./dmst_doc/doc_dmst1/project.txt'):
                shutil.copy('./dmst_doc/doc_dmst1/project.txt',
        ...
        try:
            if os.path.exists('./dmst_doc/doc_dmst1/rslt_dmst1.txt'):
                shutil.copy('./dmst_doc/doc_dmst1/rslt_dmst1.txt',
    ...
    def uptoserv():
        ...
        """
        proc = subprocess.run(["scp", "./dmst_doc/doc_dmst1/rslt_dmst1.txt",
            "pi@192.168.18.12:~/tt_doc/doc_txt1/dmst1/rslt_dmst1.txt"],
            stderr=subprocess.PIPE)
        print("Result SCP transfert : %s" % repr(proc.stderr))
        if proc.stderr == b'':
            print("+ File rslt_dmst1.txt uploaded !")
            #tk.messagebox.showinfo("INFO", "rslt_dmst1.txt uploaded...")
        else:
            print("+ No file to upload !")
            tk.messagebox.showerror("Error", "No rslt_dmst1.txt to upload...")

        secproc = subprocess.run(["scp", "./dmst_doc/doc_dmst1/parcours.txt",
        ...
        thirdproc = subprocess.run(["scp", "./dmst_doc/doc_dmst1/pbm.txt",
        ...
        forthproc = subprocess.run(["scp", "./dmst_doc/doc_dmst1/project.txt",
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst1/rslt_dmst1.txt"') # Linux
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst1/rslt_dmst1.txt') # Mac
        else:
            os.startfile('./dmst_doc/doc_dmst1/rslt_dmst1.txt') # Windows
