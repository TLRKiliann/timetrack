...
import os
import platform
from dmst_doc.extdmst1.extdmstfile1 import importationAdmin
from dmst_doc.extdmst1.extdmstfile1 import importationDoc1
from dmst_doc.extdmst1.extdmstfile1 import importationDoc2
from dmst_doc.extdmst1.extdmstfile1 import importationDoc3
from dmst_doc.extdmst1.extdmstfile1 import importationFam
from dmst_doc.extdmst1.extdmstfile1 import importationHealOne
from dmst_doc.extdmst1.extdmstfile1 import importationHealThree
from dmst_doc.extdmst1.extdmstfile1 import importationFile2
from dmst_doc.extdmst1.extdmstfile1 import importationParam
from dmst_doc.extdmst1.extdmstfile1 import importationBmi
from dmst_doc.extdmst1.extdmstfile1 import launchfunc
from dmst_doc.extdmst1.extdmstfile1 import saveData
from dmst_doc.extdmst1.extdmstfile1 import copytobackup
from dmst_doc.extdmst1.extdmstfile1 import uptoserv
...
def doc_medical1(self):
    ...
    try:
        if os.path.getsize('./param/paramdata1.txt'):
            importationParam(self, './param/paramdata1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst1/rslt_dmst1.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst1/rslt_dmst1.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst1/rslt_dmst1.txt')
