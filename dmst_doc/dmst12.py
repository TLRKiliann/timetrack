...
import os
import platform
from dmst_doc.extdmst12.extdmstfile12 import importationAdmin
from dmst_doc.extdmst12.extdmstfile12 import importationDoc1
from dmst_doc.extdmst12.extdmstfile12 import importationDoc2
from dmst_doc.extdmst12.extdmstfile12 import importationDoc3
from dmst_doc.extdmst12.extdmstfile12 import importationFam
from dmst_doc.extdmst12.extdmstfile12 import importationHealOne
from dmst_doc.extdmst12.extdmstfile12 import importationHealThree
from dmst_doc.extdmst12.extdmstfile12 import importationFile2
from dmst_doc.extdmst12.extdmstfile12 import importationParam
from dmst_doc.extdmst12.extdmstfile12 import importationBmi
from dmst_doc.extdmst12.extdmstfile12 import launchfunc
from dmst_doc.extdmst12.extdmstfile12 import saveData
from dmst_doc.extdmst12.extdmstfile12 import copytobackup
from dmst_doc.extdmst12.extdmstfile12 import uptoserv
...
def doc_medical12(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt12/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt12/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt12/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt12/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata12.txt'):
            importationParam(self, './param/paramdata12.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata12.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata12.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi12.txt'):
            importationBmi(self, './calBmi/bmi12.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi12.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi12.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact12/finalfile12.txt'):
            importationAdmin(self, './contact/conpact12/finalfile12.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile12.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact12/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact12/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact12/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact12/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact12/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact12/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact12/finalfam12.txt'):
            importationFam(self, './contact/conpact12/finalfam12.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact12/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact12/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact12/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact12/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File auxiliary12.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst12/rslt_dmst12.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst12/rslt_dmst12.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst12/rslt_dmst12.txt')
