...
import os
import platform
from dmst_doc.extdmst20.extdmstfile20 import importationAdmin
from dmst_doc.extdmst20.extdmstfile20 import importationDoc1
from dmst_doc.extdmst20.extdmstfile20 import importationDoc2
from dmst_doc.extdmst20.extdmstfile20 import importationDoc3
from dmst_doc.extdmst20.extdmstfile20 import importationFam
from dmst_doc.extdmst20.extdmstfile20 import importationHealOne
from dmst_doc.extdmst20.extdmstfile20 import importationHealThree
from dmst_doc.extdmst20.extdmstfile20 import importationFile2
from dmst_doc.extdmst20.extdmstfile20 import importationParam
from dmst_doc.extdmst20.extdmstfile20 import importationBmi
from dmst_doc.extdmst20.extdmstfile20 import launchfunc
from dmst_doc.extdmst20.extdmstfile20 import saveData
from dmst_doc.extdmst20.extdmstfile20 import copytobackup
from dmst_doc.extdmst20.extdmstfile20 import uptoserv
...
def doc_medical20(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt20/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt20/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt20/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt20/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata20.txt'):
            importationParam(self, './param/paramdata20.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata20.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata20.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi20.txt'):
            importationBmi(self, './calBmi/bmi20.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi20.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi20.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact20/finalfile20.txt'):
            importationAdmin(self, './contact/conpact20/finalfile20.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile20.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact20/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact20/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact20/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact20/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact20/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact20/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact20/finalfam20.txt'):
            importationFam(self, './contact/conpact20/finalfam20.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam20.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam20.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact20/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact20/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact20/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact20/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File auxiliary20.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst20/rslt_dmst20.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst20/rslt_dmst20.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst20/rslt_dmst20.txt')
