...
import os
import platform
from dmst_doc.extdmst16.extdmstfile16 import importationAdmin
from dmst_doc.extdmst16.extdmstfile16 import importationDoc1
from dmst_doc.extdmst16.extdmstfile16 import importationDoc2
from dmst_doc.extdmst16.extdmstfile16 import importationDoc3
from dmst_doc.extdmst16.extdmstfile16 import importationFam
from dmst_doc.extdmst16.extdmstfile16 import importationHealOne
from dmst_doc.extdmst16.extdmstfile16 import importationHealThree
from dmst_doc.extdmst16.extdmstfile16 import importationFile2
from dmst_doc.extdmst16.extdmstfile16 import importationParam
from dmst_doc.extdmst16.extdmstfile16 import importationBmi
from dmst_doc.extdmst16.extdmstfile16 import launchfunc
from dmst_doc.extdmst16.extdmstfile16 import saveData
from dmst_doc.extdmst16.extdmstfile16 import copytobackup
from dmst_doc.extdmst16.extdmstfile16 import uptoserv
...
def doc_medical16(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt16/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt16/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt16/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt16/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata16.txt'):
            importationParam(self, './param/paramdata16.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata16.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata16.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi16.txt'):
            importationBmi(self, './calBmi/bmi16.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi16.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi16.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact16/finalfile16.txt'):
            importationAdmin(self, './contact/conpact16/finalfile16.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile16.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact16/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact16/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact16/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact16/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact16/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact16/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact16/finalfam16.txt'):
            importationFam(self, './contact/conpact16/finalfam16.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam16.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam16.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact16/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact16/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact16/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact16/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File auxiliary16.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst16/rslt_dmst16.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst16/rslt_dmst16.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst16/rslt_dmst16.txt')
