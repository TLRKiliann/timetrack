...
def launchfunc(self):
    ...
    try:
        with open('./contact/conpact4/finalfile4.txt', 'r') as file_contf1:
            with open('./dmst_doc/doc_dmst4/rslt_dmst4.txt', '+a') as file_dm:
        ...
        print("[!] File finalfile4.txt not found !", ff1_nf)
    ...
    try:
        with open('./contact/conpact4/finalfam4.txt', 'r') as file_fam:
            with open('./dmst_doc/doc_dmst4/rslt_dmst4.txt', '+a') as file_dm:
        ...
        print("[!] File finalfam4.txt not found !", ffam_nf)
