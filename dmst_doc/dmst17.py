...
import os
import platform
from dmst_doc.extdmst17.extdmstfile17 import importationAdmin
from dmst_doc.extdmst17.extdmstfile17 import importationDoc1
from dmst_doc.extdmst17.extdmstfile17 import importationDoc2
from dmst_doc.extdmst17.extdmstfile17 import importationDoc3
from dmst_doc.extdmst17.extdmstfile17 import importationFam
from dmst_doc.extdmst17.extdmstfile17 import importationHealOne
from dmst_doc.extdmst17.extdmstfile17 import importationHealThree
from dmst_doc.extdmst17.extdmstfile17 import importationFile2
from dmst_doc.extdmst17.extdmstfile17 import importationParam
from dmst_doc.extdmst17.extdmstfile17 import importationBmi
from dmst_doc.extdmst17.extdmstfile17 import launchfunc
from dmst_doc.extdmst17.extdmstfile17 import saveData
from dmst_doc.extdmst17.extdmstfile17 import copytobackup
from dmst_doc.extdmst17.extdmstfile17 import uptoserv
...
def doc_medical17(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt17/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt17/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt17/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt17/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata17.txt'):
            importationParam(self, './param/paramdata17.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata17.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata17.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi17.txt'):
            importationBmi(self, './calBmi/bmi17.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi17.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi17.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact17/finalfile17.txt'):
            importationAdmin(self, './contact/conpact17/finalfile17.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile17.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact17/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact17/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact17/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact17/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact17/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact17/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact17/finalfam17.txt'):
            importationFam(self, './contact/conpact17/finalfam17.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact17/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact17/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact17/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact17/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        ...
        tk.messagebox.showinfo('INFO', 'File auxiliary17.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst17/rslt_dmst17.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst17/rslt_dmst17.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst17/rslt_dmst17.txt')
