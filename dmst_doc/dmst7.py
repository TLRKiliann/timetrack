...
import os
import platform
from dmst_doc.extdmst7.extdmstfile7 import importationAdmin
from dmst_doc.extdmst7.extdmstfile7 import importationDoc1
from dmst_doc.extdmst7.extdmstfile7 import importationDoc2
from dmst_doc.extdmst7.extdmstfile7 import importationDoc3
from dmst_doc.extdmst7.extdmstfile7 import importationFam
from dmst_doc.extdmst7.extdmstfile7 import importationHealOne
from dmst_doc.extdmst7.extdmstfile7 import importationHealThree
from dmst_doc.extdmst7.extdmstfile7 import importationFile2
from dmst_doc.extdmst7.extdmstfile7 import importationParam
from dmst_doc.extdmst7.extdmstfile7 import importationBmi
from dmst_doc.extdmst7.extdmstfile7 import launchfunc
from dmst_doc.extdmst7.extdmstfile7 import saveData
from dmst_doc.extdmst7.extdmstfile7 import copytobackup
from dmst_doc.extdmst7.extdmstfile7 import uptoserv
...
def doc_medical7(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt7/intro_ttt.txt'):
            importationFile(self, './ttt/doc_ttt7/intro_ttt.txt',
                encodage="Utf-8")
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt7/intro_res.txt'):
            importationFile2(self, './ttt/doc_ttt7/intro_res.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./param/paramdata7.txt'):
            importationParam(self, './param/paramdata7.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File paramdata7.txt not found !")
        tk.messagebox.showinfo('INFO', 'File paramdata7.txt not found !')
    ...
    try:
        if os.path.getsize('./calBmi/bmi7.txt'):
            importationBmi(self, './calBmi/bmi7.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File bmi7.txt not found !")
        tk.messagebox.showinfo('INFO', 'File bmi7.txt not found !')
    ...
    try:
        if os.path.exists('./contact/conpact7/finalfile7.txt'):
            importationAdmin(self, './contact/conpact7/finalfile7.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfile7.txt not found !")
    ...
    try:
        if os.path.getsize('./contact/conpact7/finaldoc1.txt'):
            importationDoc1(self, './contact/conpact7/finaldoc1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact7/finaldoc2.txt'):
            importationDoc2(self, './contact/conpact7/finaldoc2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact7/finaldoc3.txt'):
            importationDoc3(self, './contact/conpact7/finaldoc3.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact7/finalfam7.txt'):
            importationFam(self, './contact/conpact7/finalfam7.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File finalfam7.txt not found !")
        tk.messagebox.showinfo('INFO', 'File finalfam7.txt not found !')
    ...
    try:
        if os.path.getsize('./contact/conpact7/finalhcs1.txt'):
            importationHealOne(self, './contact/conpact7/finalhcs1.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact7/finalhcs2.txt'):
            importationHealTwo('./contact/conpact7/finalhcs2.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./contact/conpact7/finalhcs3.txt'):
            importationHealThree(self, './contact/conpact7/finalhcs3.txt',
                encodage="Utf-8")
    except FileNotFoundError as no_file:
    ...
    try:
        if os.path.getsize('./auxequip/doc_equip/auxiliary7.txt'):
            importationHealTwo('./auxequip/doc_equip/auxiliary7.txt', encodage="Utf-8")
    except FileNotFoundError as no_file:
        print("[!] File auxiliary7.txt not found !")
        tk.messagebox.showinfo('INFO', 'File auxiliary7.txt not found !')
    ...
    def prireadfunc():
        ...
        if callplatform == 'Linux':
            os.system('gio open "./dmst_doc/doc_dmst7/rslt_dmst7.txt"')
        elif callplatform =='Darwin':
            subprocess.call('./dmst_doc/doc_dmst7/rslt_dmst7.txt')
        else:
            os.startfile('./dmst_doc/doc_dmst7/rslt_dmst7.txt')
