...
import os
import subprocess
from uploadiag6 import diagupload


root = tk.Tk()
root.title("Diagnosis and ATCD 6")
...
def retrieve_input():
    file = open('./diag/doc_diag6/diagrecap6.txt', 'w')
...
try:
    ...
    print(err_file)
    messagebox.showwarning("WARNING", "File diagrecap6.txt does "\
