...
fen = tk.Tk()
fen.title("Diagnosis and ATCD 1")
...
try:
    if os.path.getsize('./diag/doc_diag1/diagrecap1.txt'):
        importationFile('./diag/doc_diag1/diagrecap1.txt',
            encodage="Utf-8")
except FileNotFoundError as err_file:
    print(err_file)
    tk.messagebox.showwarning("WARNING", "File diagrecap1.txt "\
