...
import os
import subprocess
from uploadiag7 import diagupload


root = tk.Tk()
root.title("Diagnosis and ATCD 7")
...
def retrieve_input():
    file = open('./diag/doc_diag7/diagrecap7.txt', 'w')
...
try:
    if os.path.getsize('./diag/doc_diag7/diagrecap7.txt'):
        importationFile('./diag/doc_diag7/diagrecap7.txt', 
            encodage="Utf-8")
except FileNotFoundError as err_file:
    print(err_file)
    messagebox.showwarning("WARNING", "File diagrecap7.txt does "\
