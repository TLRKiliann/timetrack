...
import os
import subprocess
from uploadiag4 import diagupload


root = tk.Tk()
root.title("Diagnosis and ATCD 4")
...
def retrieve_input():
    file = open('./diag/doc_diag4/diagrecap4.txt', 'w')
...
try:
    ...
    print(err_file)
    messagebox.showwarning("WARNING", "File diagrecap4.txt does "\
