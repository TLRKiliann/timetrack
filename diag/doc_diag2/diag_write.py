...
import os
import subprocess
from uploadiag2 import diagupload


root = tk.Tk()
root.title("Diagnosis and ATCD 2")
...
def retrieve_input():
    file = open('./diag/doc_diag2/diagrecap2.txt', 'w')
...
try:
    if os.path.getsize('./diag/doc_diag2/diagrecap2.txt'):
        importationFile('./diag/doc_diag2/diagrecap2.txt', 
            encodage="Utf-8")
except FileNotFoundError as err_file:
    print(err_file)
    messagebox.showwarning("WARNING", "File diagrecap2.txt does "\
