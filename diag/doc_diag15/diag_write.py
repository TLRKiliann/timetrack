...
import os
import subprocess
from uploadiag15 import diagupload


root = tk.Tk()
root.title("Diagnosis and ATCD 15")
...
def retrieve_input():
    file = open('./diag/doc_diag15/diagrecap15.txt', 'w')
...
try:
    ...
    print(err_file)
    messagebox.showwarning("WARNING", "File diagrecap15.txt does "\
