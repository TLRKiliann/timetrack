...
import os
import subprocess
from uploadiag3 import diagupload


root = tk.Tk()
root.title("Diagnosis and ATCD 3")
...
def retrieve_input():
    file = open('./diag/doc_diag3/diagrecap3.txt', 'w')
...
try:
    ...
    print(err_file)
    messagebox.showwarning("WARNING", "File diagrecap3.txt does "\
        "not exist or file not found !")

def lectureFic():
    subprocess.call('./diag/doc_diag3/diag_read.py')
