...
def tttTabs():
    ...
    """
    tk.messagebox.showerror("Error", "No TREATMENT recorded for "\
        "this patient, convdose.json file missing (2)!")
...
def showTreat():
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt2/convdose.json'):
            subprocess.run('./ttt/doc_ttt2/tabs.py')
...
def noReservStory():
    ...
    """
    tk.messagebox.showerror("Error", "No RESERVE recorded for "\
        "this patient, convres.json file missing (2)!")
...
def showReserve():
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt2/convres.json'):
            subprocess.run('./ttt/doc_ttt2/tabres.py')
...
def introStoryTreat():
    ...
    """
    tk.messagebox.showerror("Error", "None stopped TREATMENT is "\
        "available, maybe no TREATMENT has been introduced (2)!")
...
def readTttStory():
    ...
    try:
        if os.path.getsize("./ttt/doc_ttt2/intro_ttt.txt"):
            subprocess.run("./ttt/doc_ttt2/readstory_ttt.py")
...
def introResStory():
    ...
    """
    tk.messagebox.showerror("Error", "None stopped RESERVE is "\
        "available, maybe no RESERVE has been introduced (2)!")
...
def readResStory():
    ...
    try:
        if os.path.getsize("./ttt/doc_ttt2/intro_res.txt"):
            subprocess.run("./ttt/doc_ttt2/readstory_res.py")
...
def readFileStory():
    ...
    try:
        if os.path.getsize("./ttt/doc_ttt2/stopped_ttt.txt"):
            subprocess.run("./ttt/doc_ttt2/readstory.py")
    except FileNotFoundError as no_storyfile:
        print("[!] Sorry, none stopped ttt is available, "\
        "maybe no ttt has been introduced (2)!", no_storyfile)
        introStoryTreat()
...
def noRecStop():
    ...
    try:
        if os.path.getsize("./ttt/doc_ttt2/ires_rs.txt"):
            subprocess.run("./ttt/doc_ttt2/stp_readstorymed.py")
    except FileNotFoundError as no_storyrestp:
        print("[!] Sorry, none RESERVE has been stopped (2)!", no_storyrestp)
        tk.messagebox.showerror("Error", "None RESERVE has been stopped (2)!")
...
def showStopMed():
    ...
    try:
        ...
        print("[!] Sorry, none TREATMENT has been stopped (2)!", no_storyttstp)
        tk.messagebox.showerror("Error", "None TREATMENT has been stopped (2)!")
        noRecStop()
