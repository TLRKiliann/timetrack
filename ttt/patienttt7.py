...
from ttt.msgmed.verifmsg7 import showTreat
from ttt.msgmed.verifmsg7 import showReserve
from ttt.msgmed.verifmsg7 import readTttStory
from ttt.msgmed.verifmsg7 import readResStory
from ttt.msgmed.verifmsg7 import readFileStory
from ttt.msgmed.verifmsg7 import showStopMed

from ttt.copymed.tttmanager7 import copyToTreat
from ttt.copymed.tttmanager7 import toCopyJsonTreat

from ttt.copyres.resmanager7 import copyToReserve
from ttt.copyres.resmanager7 import toCopyJsonRes

from ttt.stopmed.tttstop7 import stopTreatment
from ttt.stopres.resstop7 import stopReserve

from ttt.uploadtreat.t_upload7 import tttupload
from ttt.uploadres.r_upload7 import resupload

from ttt.printview.printmed7 import tttviewnprint
from ttt.printview.printmed7 import resviewnprint
from ttt.printview.printmed7 import ttt_stpview
from ttt.printview.printmed7 import res_stpview
...
def callTreatment7(self):
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt7/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt7/stopped_res.txt", "w") as creares_file:
