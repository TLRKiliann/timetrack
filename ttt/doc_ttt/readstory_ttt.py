...
try:
    if os.path.getsize('./ttt/doc_ttt/intro_ts.txt'):
        importationFile2('./ttt/doc_ttt/intro_ts.txt', encodage="Utf-8")
except FileNotFoundError as no_file2:
    print("[!] File intro_ts.txt not found !", no_file2)
    messagebox.showinfo('INFO', 'File intro_ts.txt not found !')

try:
    if os.path.getsize('./ttt/doc_ttt/stopped_ttt.txt'):
        importationFile3('./ttt/doc_ttt/stopped_ttt.txt', encodage="Utf-8")
except FileNotFoundError as no_file3:
    print("[!] File stopped_ttt.txt not found !", no_file3)
