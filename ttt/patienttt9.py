...
from ttt.msgmed.verifmsg9 import showTreat
from ttt.msgmed.verifmsg9 import showReserve
from ttt.msgmed.verifmsg9 import readTttStory
from ttt.msgmed.verifmsg9 import readResStory
from ttt.msgmed.verifmsg9 import readFileStory
from ttt.msgmed.verifmsg9 import showStopMed

from ttt.copymed.tttmanager9 import copyToTreat
from ttt.copymed.tttmanager9 import toCopyJsonTreat

from ttt.copyres.resmanager9 import copyToReserve
from ttt.copyres.resmanager9 import toCopyJsonRes

from ttt.stopmed.tttstop9 import stopTreatment
from ttt.stopres.resstop9 import stopReserve

from ttt.uploadtreat.t_upload9 import tttupload
from ttt.uploadres.r_upload9 import resupload

from ttt.printview.printmed9 import tttviewnprint
from ttt.printview.printmed9 import resviewnprint
from ttt.printview.printmed9 import ttt_stpview
from ttt.printview.printmed9 import res_stpview


def callTreatment9(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt9/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt9/stopped_res.txt", "w") as creares_file:
