...
from ttt.msgmed.verifmsg3 import showTreat
from ttt.msgmed.verifmsg3 import showReserve
from ttt.msgmed.verifmsg3 import readTttStory
from ttt.msgmed.verifmsg3 import readResStory
from ttt.msgmed.verifmsg3 import readFileStory
from ttt.msgmed.verifmsg3 import showStopMed

from ttt.copymed.tttmanager3 import copyToTreat
from ttt.copymed.tttmanager3 import toCopyJsonTreat

from ttt.copyres.resmanager3 import copyToReserve
from ttt.copyres.resmanager3 import toCopyJsonRes

from ttt.stopmed.tttstop3 import stopTreatment
from ttt.stopres.resstop3 import stopReserve

from ttt.uploadtreat.t_upload3 import tttupload
from ttt.uploadres.r_upload3 import resupload

from ttt.printview.printmed3 import tttviewnprint
from ttt.printview.printmed3 import resviewnprint
from ttt.printview.printmed3 import ttt_stpview
from ttt.printview.printmed3 import res_stpview
...
def callTreatment3(self):
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt3/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt3/stopped_res.txt", "w") as creares_file:
