...
from ttt.msgmed.verifmsg1 import showTreat
from ttt.msgmed.verifmsg1 import showReserve
from ttt.msgmed.verifmsg1 import readTttStory
from ttt.msgmed.verifmsg1 import readResStory
from ttt.msgmed.verifmsg1 import readFileStory
from ttt.msgmed.verifmsg1 import showStopMed

from ttt.copymed.tttmanager1 import copyToTreat
from ttt.copymed.tttmanager1 import toCopyJsonTreat

from ttt.copyres.resmanager1 import copyToReserve
from ttt.copyres.resmanager1 import toCopyJsonRes

from ttt.stopmed.tttstop1 import stopTreatment
from ttt.stopres.resstop1 import stopReserve

from ttt.uploadtreat.t_upload1 import tttupload
from ttt.uploadres.r_upload1 import resupload

from ttt.printview.printmed1 import tttviewnprint
from ttt.printview.printmed1 import resviewnprint
from ttt.printview.printmed1 import ttt_stpview
from ttt.printview.printmed1 import res_stpview


def callTreatment1(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt/stopped_res.txt", "w") as creares_file:
