...
from ttt.msgmed.verifmsg4 import showTreat
from ttt.msgmed.verifmsg4 import showReserve
from ttt.msgmed.verifmsg4 import readTttStory
from ttt.msgmed.verifmsg4 import readResStory
from ttt.msgmed.verifmsg4 import readFileStory
from ttt.msgmed.verifmsg4 import showStopMed

from ttt.copymed.tttmanager4 import copyToTreat
from ttt.copymed.tttmanager4 import toCopyJsonTreat

from ttt.copyres.resmanager4 import copyToReserve
from ttt.copyres.resmanager4 import toCopyJsonRes

from ttt.stopmed.tttstop4 import stopTreatment
from ttt.stopres.resstop4 import stopReserve

from ttt.uploadtreat.t_upload4 import tttupload
from ttt.uploadres.r_upload4 import resupload

from ttt.printview.printmed4 import tttviewnprint
from ttt.printview.printmed4 import resviewnprint
from ttt.printview.printmed4 import ttt_stpview
from ttt.printview.printmed4 import res_stpview
...
def callTreatment4(self):
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt4/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt4/stopped_res.txt", "w") as creares_file:
