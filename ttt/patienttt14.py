...
from ttt.msgmed.verifmsg14 import showTreat
from ttt.msgmed.verifmsg14 import showReserve
from ttt.msgmed.verifmsg14 import readTttStory
from ttt.msgmed.verifmsg14 import readResStory
from ttt.msgmed.verifmsg14 import readFileStory
from ttt.msgmed.verifmsg14 import showStopMed

from ttt.copymed.tttmanager14 import copyToTreat
from ttt.copymed.tttmanager14 import toCopyJsonTreat

from ttt.copyres.resmanager14 import copyToReserve
from ttt.copyres.resmanager14 import toCopyJsonRes

from ttt.stopmed.tttstop14 import stopTreatment
from ttt.stopres.resstop14 import stopReserve

from ttt.uploadtreat.t_upload14 import tttupload
from ttt.uploadres.r_upload14 import resupload

from ttt.printview.printmed14 import tttviewnprint
from ttt.printview.printmed14 import resviewnprint
from ttt.printview.printmed14 import ttt_stpview
from ttt.printview.printmed14 import res_stpview


def callTreatment14(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt14/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt14/stopped_res.txt", "w") as creares_file:
