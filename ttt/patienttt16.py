...
from ttt.msgmed.verifmsg16 import showTreat
from ttt.msgmed.verifmsg16 import showReserve
from ttt.msgmed.verifmsg16 import readTttStory
from ttt.msgmed.verifmsg16 import readResStory
from ttt.msgmed.verifmsg16 import readFileStory
from ttt.msgmed.verifmsg16 import showStopMed

from ttt.copymed.tttmanager16 import copyToTreat
from ttt.copymed.tttmanager16 import toCopyJsonTreat

from ttt.copyres.resmanager16 import copyToReserve
from ttt.copyres.resmanager16 import toCopyJsonRes

from ttt.stopmed.tttstop16 import stopTreatment
from ttt.stopres.resstop16 import stopReserve

from ttt.uploadtreat.t_upload16 import tttupload
from ttt.uploadres.r_upload16 import resupload

from ttt.printview.printmed16 import tttviewnprint
from ttt.printview.printmed16 import resviewnprint
from ttt.printview.printmed16 import ttt_stpview
from ttt.printview.printmed16 import res_stpview


def callTreatment16(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt16/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt16/stopped_res.txt", "w") as creares_file:
