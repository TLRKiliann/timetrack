...
def writeStopTtt(self):
    ...
    try:
        ...
        with open('./ttt/doc_ttt18/stopped_ttt.txt', 'a+') as file_stopttt:
...
def delTreatment(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt18/convdose.json'):
            ...
            with open('./ttt/doc_ttt18/convdose.json', 'r') as datafile:
            ...
            for key, value in dataDose.items():
                ...
                with open('./ttt/doc_ttt18/convdose.json', 'w') as datafile2:
...
def stopTreatment(self):
    ...
    if MSBask == 1:
        try:
            ...
            with open('./ttt/doc_ttt18/intro_ts.txt', 'a+') as creat_f:
            ...
            if os.path.getsize('./ttt/doc_ttt18/convdose.json'):
                ...
                for key, value in dataDose.items():
                    if self.deleteTreat.get() == value[0]['Treatment'] and \
                        ...
                        with open('./ttt/doc_ttt18/intro_ts.txt', 'a+') as file_j:
                    ...
                    print("+++ Ok 'TREATMENT' stopped +++")
                    with open('./ttt/doc_ttt18/convdose.json', 'w') as dataft:
