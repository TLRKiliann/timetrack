...
from ttt.msgmed.verifmsg12 import showTreat
from ttt.msgmed.verifmsg12 import showReserve
from ttt.msgmed.verifmsg12 import readTttStory
from ttt.msgmed.verifmsg12 import readResStory
from ttt.msgmed.verifmsg12 import readFileStory
from ttt.msgmed.verifmsg12 import showStopMed

from ttt.copymed.tttmanager12 import copyToTreat
from ttt.copymed.tttmanager12 import toCopyJsonTreat

from ttt.copyres.resmanager12 import copyToReserve
from ttt.copyres.resmanager12 import toCopyJsonRes

from ttt.stopmed.tttstop12 import stopTreatment
from ttt.stopres.resstop12 import stopReserve

from ttt.uploadtreat.t_upload12 import tttupload
from ttt.uploadres.r_upload12 import resupload

from ttt.printview.printmed12 import tttviewnprint
from ttt.printview.printmed12 import resviewnprint
from ttt.printview.printmed12 import ttt_stpview
from ttt.printview.printmed12 import res_stpview


def callTreatment12(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt12/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt12/stopped_res.txt", "w") as creares_file:
