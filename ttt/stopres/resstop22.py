...
def writeStoppedRes(self):
    ...
    try:
        ...
        with open('./ttt/doc_ttt22/stopped_res.txt', 'a+') as file_stopr:
...
def deleteReserve(self):
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt22/convres.json'):
            ...
            with open('./ttt/doc_ttt22/convres.json', 'r') as datar:
            ...
            for key, value in dataRes.items():
                ...
                with open('./ttt/doc_ttt22/convres.json', 'w') as datafirse:
...
def stopReserve(self):
    ...
    if MSB2asno == 1:
        try:
            ...
            with open('./ttt/doc_ttt22/ires_rs.txt', 'a+') as creat_f:
                creat_f.write(str("Stopped R :"))

        try:
            if os.path.getsize('./ttt/doc_ttt22/convres.json'):
                print("[+] File 'convres' exist !")
                with open('./ttt/doc_ttt22/convres.json', 'r') as datafiler:
                ...
                for key, value in dataRes.items():
                    if self.delRestop.get() == value[0]['Treatment'] and \
                        ...
                        with open('./ttt/doc_ttt22/ires_rs.txt', 'a+') as file_r:
