...
from ttt.msgmed.verifmsg11 import showTreat
from ttt.msgmed.verifmsg11 import showReserve
from ttt.msgmed.verifmsg11 import readTttStory
from ttt.msgmed.verifmsg11 import readResStory
from ttt.msgmed.verifmsg11 import readFileStory
from ttt.msgmed.verifmsg11 import showStopMed

from ttt.copymed.tttmanager11 import copyToTreat
from ttt.copymed.tttmanager11 import toCopyJsonTreat

from ttt.copyres.resmanager11 import copyToReserve
from ttt.copyres.resmanager11 import toCopyJsonRes

from ttt.stopmed.tttstop11 import stopTreatment
from ttt.stopres.resstop11 import stopReserve

from ttt.uploadtreat.t_upload11 import tttupload
from ttt.uploadres.r_upload11 import resupload

from ttt.printview.printmed11 import tttviewnprint
from ttt.printview.printmed11 import resviewnprint
from ttt.printview.printmed11 import ttt_stpview
from ttt.printview.printmed11 import res_stpview


def callTreatment11(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt11/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt11/stopped_res.txt", "w") as creares_file:
