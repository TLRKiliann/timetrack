...
from ttt.msgmed.verifmsg21 import showTreat
from ttt.msgmed.verifmsg21 import showReserve
from ttt.msgmed.verifmsg21 import readTttStory
from ttt.msgmed.verifmsg21 import readResStory
from ttt.msgmed.verifmsg21 import readFileStory
from ttt.msgmed.verifmsg21 import showStopMed

from ttt.copymed.tttmanager21 import copyToTreat
from ttt.copymed.tttmanager21 import toCopyJsonTreat

from ttt.copyres.resmanager21 import copyToReserve
from ttt.copyres.resmanager21 import toCopyJsonRes

from ttt.stopmed.tttstop21 import stopTreatment
from ttt.stopres.resstop21 import stopReserve

from ttt.uploadtreat.t_upload21 import tttupload
from ttt.uploadres.r_upload21 import resupload

from ttt.printview.printmed21 import tttviewnprint
from ttt.printview.printmed21 import resviewnprint
from ttt.printview.printmed21 import ttt_stpview
from ttt.printview.printmed21 import res_stpview


def callTreatment21(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt21/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt21/stopped_res.txt", "w") as creares_file:
