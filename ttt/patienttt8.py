...
from ttt.msgmed.verifmsg8 import showTreat
from ttt.msgmed.verifmsg8 import showReserve
from ttt.msgmed.verifmsg8 import readTttStory
from ttt.msgmed.verifmsg8 import readResStory
from ttt.msgmed.verifmsg8 import readFileStory
from ttt.msgmed.verifmsg8 import showStopMed

from ttt.copymed.tttmanager8 import copyToTreat
from ttt.copymed.tttmanager8 import toCopyJsonTreat

from ttt.copyres.resmanager8 import copyToReserve
from ttt.copyres.resmanager8 import toCopyJsonRes

from ttt.stopmed.tttstop8 import stopTreatment
from ttt.stopres.resstop8 import stopReserve

from ttt.uploadtreat.t_upload8 import tttupload
from ttt.uploadres.r_upload8 import resupload

from ttt.printview.printmed8 import tttviewnprint
from ttt.printview.printmed8 import resviewnprint
from ttt.printview.printmed8 import ttt_stpview
from ttt.printview.printmed8 import res_stpview


def callTreatment8(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt8/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt8/stopped_res.txt", "w") as creares_file:
