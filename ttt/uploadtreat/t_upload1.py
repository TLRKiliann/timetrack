...
def tttupload():
    ...
    """
    introtttproc = subprocess.run(["scp", "./ttt/doc_ttt/intro_ttt.txt",
    ...
    stoptttproc = subprocess.run(["scp", "./ttt/doc_ttt/stopped_ttt.txt",
    ...
    introstp_ts = subprocess.run(["scp", "./ttt/doc_ttt/intro_ts.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt1/Files1/intro_ts.txt"],
        stderr=subprocess.PIPE)
