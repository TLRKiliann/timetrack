...
def tttupload():
    ...
    """
    introtttproc = subprocess.run(["scp", "./ttt/doc_ttt13/intro_ttt.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt13/Files13/intro_ttt.txt"],
    ...
    stoptttproc = subprocess.run(["scp", "./ttt/doc_ttt13/stopped_ttt.txt",
    ...
    introstp_ts = subprocess.run(["scp", "./ttt/doc_ttt13/intro_ts.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt13/Files13/intro_ts.txt"],
        stderr=subprocess.PIPE)
    ...
    tttproc = subprocess.run(["scp", "./ttt/doc_ttt13/convdose.json",
