...
def tttupload():
    ...
    """
    introtttproc = subprocess.run(["scp", "./ttt/doc_ttt17/intro_ttt.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt17/Files17/intro_ttt.txt"],
    ...
    stoptttproc = subprocess.run(["scp", "./ttt/doc_ttt17/stopped_ttt.txt",
    ...
    introstp_ts = subprocess.run(["scp", "./ttt/doc_ttt17/intro_ts.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt17/Files17/intro_ts.txt"],
        stderr=subprocess.PIPE)
    ...
    tttproc = subprocess.run(["scp", "./ttt/doc_ttt17/convdose.json",
