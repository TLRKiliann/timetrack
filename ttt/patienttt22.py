...
from ttt.msgmed.verifmsg22 import showTreat
from ttt.msgmed.verifmsg22 import showReserve
from ttt.msgmed.verifmsg22 import readTttStory
from ttt.msgmed.verifmsg22 import readResStory
from ttt.msgmed.verifmsg22 import readFileStory
from ttt.msgmed.verifmsg22 import showStopMed

from ttt.copymed.tttmanager22 import copyToTreat
from ttt.copymed.tttmanager22 import toCopyJsonTreat

from ttt.copyres.resmanager22 import copyToReserve
from ttt.copyres.resmanager22 import toCopyJsonRes

from ttt.stopmed.tttstop22 import stopTreatment
from ttt.stopres.resstop22 import stopReserve

from ttt.uploadtreat.t_upload22 import tttupload
from ttt.uploadres.r_upload22 import resupload

from ttt.printview.printmed22 import tttviewnprint
from ttt.printview.printmed22 import resviewnprint
from ttt.printview.printmed22 import ttt_stpview
from ttt.printview.printmed22 import res_stpview


def callTreatment22(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt22/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt22/stopped_res.txt", "w") as creares_file:
