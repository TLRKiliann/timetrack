...
with open('./ttt/doc_ttt20/convres.json') as file:
    data = json.load(file)
...
with open('./ttt/doc_ttt20/data_res.json', 'a+') as datafile:
...
print("\nListe1 = ttt :")
print("--------------")
fileA = open('./ttt/doc_ttt20/data_res.json')
...
with open('./ttt/doc_ttt20/data_doser.json', 'a+') as datafile:
...
print("\nList2 = Dosage :")
print("--------------------")
fileB = open('./ttt/doc_ttt20/data_doser.json')
...
with open('./ttt/doc_ttt20/data_reason.json', 'a+') as datafile:
...
print("\nListeReas = Reason :")
print("--------------")
fileRea = open('./ttt/doc_ttt20/data_reason.json')
...
with open('./ttt/doc_ttt20/data_fl.json', 'a+') as datafile:
...
print("\nList4 = First-line :")
print("--------------------")
fileD = open('./ttt/doc_ttt20/data_fl.json')
...
with open('./ttt/doc_ttt20/data_sl.json', 'a+') as datafile:
...
print("\nList5 = Second-line :")
print("--------------------")
fileE = open('./ttt/doc_ttt20/data_sl.json')
...
with open('./ttt/doc_ttt20/data_num24.json', 'a+') as datafile:
...
print("\nList6 = Number/24h :")
print("--------------------")
fileF = open('./ttt/doc_ttt20/data_num24.json')
...
class app(Frame):
    def __init__(self, master = None):
        ...
        with open('./newpatient/entryfile20.txt', 'r') as allerfile:
...
os.remove('./ttt/doc_ttt20/data_res.json')
os.remove('./ttt/doc_ttt20/data_doser.json')
os.remove('./ttt/doc_ttt20/data_reason.json')
os.remove('./ttt/doc_ttt20/data_fl.json')
os.remove('./ttt/doc_ttt20/data_sl.json')
os.remove('./ttt/doc_ttt20/data_num24.json')
