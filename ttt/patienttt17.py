...
from ttt.msgmed.verifmsg17 import showTreat
from ttt.msgmed.verifmsg17 import showReserve
from ttt.msgmed.verifmsg17 import readTttStory
from ttt.msgmed.verifmsg17 import readResStory
from ttt.msgmed.verifmsg17 import readFileStory
from ttt.msgmed.verifmsg17 import showStopMed

from ttt.copymed.tttmanager17 import copyToTreat
from ttt.copymed.tttmanager17 import toCopyJsonTreat

from ttt.copyres.resmanager17 import copyToReserve
from ttt.copyres.resmanager17 import toCopyJsonRes

from ttt.stopmed.tttstop17 import stopTreatment
from ttt.stopres.resstop17 import stopReserve

from ttt.uploadtreat.t_upload17 import tttupload
from ttt.uploadres.r_upload17 import resupload

from ttt.printview.printmed17 import tttviewnprint
from ttt.printview.printmed17 import resviewnprint
from ttt.printview.printmed17 import ttt_stpview
from ttt.printview.printmed17 import res_stpview


def callTreatment17(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt17/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt17/stopped_res.txt", "w") as creares_file:
