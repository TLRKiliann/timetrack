...
from ttt.msgmed.verifmsg18 import showTreat
from ttt.msgmed.verifmsg18 import showReserve
from ttt.msgmed.verifmsg18 import readTttStory
from ttt.msgmed.verifmsg18 import readResStory
from ttt.msgmed.verifmsg18 import readFileStory
from ttt.msgmed.verifmsg18 import showStopMed

from ttt.copymed.tttmanager18 import copyToTreat
from ttt.copymed.tttmanager18 import toCopyJsonTreat

from ttt.copyres.resmanager18 import copyToReserve
from ttt.copyres.resmanager18 import toCopyJsonRes

from ttt.stopmed.tttstop18 import stopTreatment
from ttt.stopres.resstop18 import stopReserve

from ttt.uploadtreat.t_upload18 import tttupload
from ttt.uploadres.r_upload18 import resupload

from ttt.printview.printmed18 import tttviewnprint
from ttt.printview.printmed18 import resviewnprint
from ttt.printview.printmed18 import ttt_stpview
from ttt.printview.printmed18 import res_stpview


def callTreatment18(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt18/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt18/stopped_res.txt", "w") as creares_file:
