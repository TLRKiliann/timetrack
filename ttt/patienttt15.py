...
from ttt.msgmed.verifmsg15 import showTreat
from ttt.msgmed.verifmsg15 import showReserve
from ttt.msgmed.verifmsg15 import readTttStory
from ttt.msgmed.verifmsg15 import readResStory
from ttt.msgmed.verifmsg15 import readFileStory
from ttt.msgmed.verifmsg15 import showStopMed

from ttt.copymed.tttmanager15 import copyToTreat
from ttt.copymed.tttmanager15 import toCopyJsonTreat

from ttt.copyres.resmanager15 import copyToReserve
from ttt.copyres.resmanager15 import toCopyJsonRes

from ttt.stopmed.tttstop15 import stopTreatment
from ttt.stopres.resstop15 import stopReserve

from ttt.uploadtreat.t_upload15 import tttupload
from ttt.uploadres.r_upload15 import resupload

from ttt.printview.printmed15 import tttviewnprint
from ttt.printview.printmed15 import resviewnprint
from ttt.printview.printmed15 import ttt_stpview
from ttt.printview.printmed15 import res_stpview


def callTreatment15(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt15/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt15/stopped_res.txt", "w") as creares_file:
