...
from ttt.msgmed.verifmsg2 import showTreat
from ttt.msgmed.verifmsg2 import showReserve
from ttt.msgmed.verifmsg2 import readTttStory
from ttt.msgmed.verifmsg2 import readResStory
from ttt.msgmed.verifmsg2 import readFileStory
from ttt.msgmed.verifmsg2 import showStopMed

from ttt.copymed.tttmanager2 import copyToTreat
from ttt.copymed.tttmanager2 import toCopyJsonTreat

from ttt.copyres.resmanager2 import copyToReserve
from ttt.copyres.resmanager2 import toCopyJsonRes

from ttt.stopmed.tttstop2 import stopTreatment
from ttt.stopres.resstop2 import stopReserve

from ttt.uploadtreat.t_upload2 import tttupload
from ttt.uploadres.r_upload2 import resupload

from ttt.printview.printmed2 import tttviewnprint
from ttt.printview.printmed2 import resviewnprint
from ttt.printview.printmed2 import ttt_stpview
from ttt.printview.printmed2 import res_stpview
...
def callTreatment2(self):
    ...
    with open('./newpatient/entryfile2.txt', 'r') as filename2:
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt2/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt2/stopped_res.txt", "w") as creares_file:
