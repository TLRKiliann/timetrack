...
def resupload():
    ...
    """
    introres_proc = subprocess.run(["scp", "./ttt/doc_ttt10/intro_res.txt",
    ...
    stopres_proc = subprocess.run(["scp", "./ttt/doc_ttt10/stopped_res.txt",
    ...
    irestp_proc = subprocess.run(["scp", "./ttt/doc_ttt10/ires_rs.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt10/Files10/ires_rs.txt"],
        stderr=subprocess.PIPE)
    ...
    convdose_proc = subprocess.run(["scp", "./ttt/doc_ttt10/convres.json",
