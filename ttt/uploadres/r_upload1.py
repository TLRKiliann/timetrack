...
def resupload():
    ...
    """
    introres_proc = subprocess.run(["scp", "./ttt/doc_ttt/intro_res.txt",
    ...
    stopres_proc = subprocess.run(["scp", "./ttt/doc_ttt/stopped_res.txt",
    ...
    irestp_proc = subprocess.run(["scp", "./ttt/doc_ttt/ires_rs.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt1/Files1/ires_rs.txt"],
        stderr=subprocess.PIPE)
    ...
    convdose_proc = subprocess.run(["scp", "./ttt/doc_ttt/convres.json",
