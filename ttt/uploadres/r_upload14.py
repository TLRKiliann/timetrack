...
def resupload():
    ...
    """
    introres_proc = subprocess.run(["scp", "./ttt/doc_ttt14/intro_res.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt14/Files14/intro_res.txt"],
    ...
    stopres_proc = subprocess.run(["scp", "./ttt/doc_ttt14/stopped_res.txt",
    ...
    irestp_proc = subprocess.run(["scp", "./ttt/doc_ttt14/ires_rs.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt14/Files14/ires_rs.txt"],
        stderr=subprocess.PIPE)
    ...
    convdose_proc = subprocess.run(["scp", "./ttt/doc_ttt14/convres.json",
