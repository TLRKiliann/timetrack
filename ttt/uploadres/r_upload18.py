...
def resupload():
    ...
    """
    introres_proc = subprocess.run(["scp", "./ttt/doc_ttt18/intro_res.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt18/Files18/intro_res.txt"],
    ...
    stopres_proc = subprocess.run(["scp", "./ttt/doc_ttt18/stopped_res.txt",
    ...
    irestp_proc = subprocess.run(["scp", "./ttt/doc_ttt18/ires_rs.txt",
        "pi@192.168.18.12:~/tt_doc/doc_txt18/Files18/ires_rs.txt"],
        stderr=subprocess.PIPE)
    ...
    convdose_proc = subprocess.run(["scp", "./ttt/doc_ttt18/convres.json",
