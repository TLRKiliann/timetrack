...
from ttt.msgmed.verifmsg19 import showTreat
from ttt.msgmed.verifmsg19 import showReserve
from ttt.msgmed.verifmsg19 import readTttStory
from ttt.msgmed.verifmsg19 import readResStory
from ttt.msgmed.verifmsg19 import readFileStory
from ttt.msgmed.verifmsg19 import showStopMed

from ttt.copymed.tttmanager19 import copyToTreat
from ttt.copymed.tttmanager19 import toCopyJsonTreat

from ttt.copyres.resmanager19 import copyToReserve
from ttt.copyres.resmanager19 import toCopyJsonRes

from ttt.stopmed.tttstop19 import stopTreatment
from ttt.stopres.resstop19 import stopReserve

from ttt.uploadtreat.t_upload19 import tttupload
from ttt.uploadres.r_upload19 import resupload

from ttt.printview.printmed19 import tttviewnprint
from ttt.printview.printmed19 import resviewnprint
from ttt.printview.printmed19 import ttt_stpview
from ttt.printview.printmed19 import res_stpview


def callTreatment19(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt19/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt19/stopped_res.txt", "w") as creares_file:
