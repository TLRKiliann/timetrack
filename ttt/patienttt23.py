...
from ttt.msgmed.verifmsg23 import showTreat
from ttt.msgmed.verifmsg23 import showReserve
from ttt.msgmed.verifmsg23 import readTttStory
from ttt.msgmed.verifmsg23 import readResStory
from ttt.msgmed.verifmsg23 import readFileStory
from ttt.msgmed.verifmsg23 import showStopMed

from ttt.copymed.tttmanager23 import copyToTreat
from ttt.copymed.tttmanager23 import toCopyJsonTreat

from ttt.copyres.resmanager23 import copyToReserve
from ttt.copyres.resmanager23 import toCopyJsonRes

from ttt.stopmed.tttstop23 import stopTreatment
from ttt.stopres.resstop23 import stopReserve

from ttt.uploadtreat.t_upload23 import tttupload
from ttt.uploadres.r_upload23 import resupload

from ttt.printview.printmed23 import tttviewnprint
from ttt.printview.printmed23 import resviewnprint
from ttt.printview.printmed23 import ttt_stpview
from ttt.printview.printmed23 import res_stpview


def callTreatment23(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt23/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt23/stopped_res.txt", "w") as creares_file:
