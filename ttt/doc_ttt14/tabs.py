...
with open('./ttt/doc_ttt14/convdose.json') as file:
    data = json.load(file)
...
with open('./ttt/doc_ttt14/data_start.json', 'a+') as datafile:
...
print("--------------")
fileStart = open('./ttt/doc_ttt14/data_start.json')
...
with open('./ttt/doc_ttt14/data_end.json', 'a+') as datafile:
...
print("--------------")
filend = open('./ttt/doc_ttt14/data_end.json')
...
with open('./ttt/doc_ttt14/data_ttt.json', 'a+') as datafile:
...
print("\nListe1 = ttt :")
print("--------------")
fileA = open('./ttt/doc_ttt14/data_ttt.json')
...
with open('./ttt/doc_ttt14/data_dose.json', 'a+') as datafile:
...
print("\nList2 = Dosage :")
print("--------------------")
fileB = open('./ttt/doc_ttt14/data_dose.json')
...
data_list3 = []
for value in zip(value):
    data_list3.append(value[0]['Morning'])

with open('./ttt/doc_ttt14/data_matin.json', 'a+') as datafile:
...
print("\nList3 = Morning :")
print("--------------------")
fileC = open('./ttt/doc_ttt14/data_matin.json')
...
data_list4 = []
for value in zip(value):
    data_list4.append(value[0]['Midday'])

with open('./ttt/doc_ttt14/data_midi.json', 'a+') as datafile:
...
print("\nList4 = Midday :")
print("--------------------")
fileD = open('./ttt/doc_ttt14/data_midi.json')
...
data_list5 = []
for value in zip(value):
    data_list5.append(value[0]['Evening'])

with open('./ttt/doc_ttt14/data_soir.json', 'a+') as datafile:
...
print("\nList5 = Evening :")
print("--------------------")
fileE = open('./ttt/doc_ttt14/data_soir.json')
...
data_list6 = []
for value in zip(value):
    data_list6.append(value[0]['Night'])

with open('./ttt/doc_ttt14/data_nuit.json', 'a+') as datafile:
...
print("\nList6 = Night :")
print("--------------------")
fileF = open('./ttt/doc_ttt14/data_nuit.json')
...
class app(Frame):
    def __init__(self, master = None):
        ...
        self.labelo=Label(master, text="Treatments for : ",
            width=20, font='Times 18 bold', fg='aquamarine',
            bg='DodgerBlue2')
        self.labelo.grid(sticky='w', row=0, column=0,
            padx=30, pady=5)
        ...
        self.entryName.grid(sticky='w', row=0, column=0,
            padx=250, pady=5)
        ...
        with open('./newpatient/entryfile14.txt', 'r') as allerfile:
            lineA1=allerfile.readline()
            lineA2=allerfile.readline()
            lineA3=allerfile.readline()

        self.text_all=StringVar()
        self.Entryall=Entry(master, textvariable=self.text_all,
            width=60)
        self.text_all.set(lineA3[:-1])
        self.Entryall.grid(sticky='e', row=0, column=0,
            padx=120, pady=5)

        self.buttQuit=Button(master, text="Close",
            bg='RoyalBlue3', fg='cyan',
            activebackground='pale turquoise',
            activeforeground='navy', command=quit)
        self.buttQuit.grid(sticky='e', row=0, column=0,
            padx=10)
        self.grid()
        self.create_widgets()
    ...
    def create_widgets(self):
        ...
        try:
            ...
            print("End of medication reached, there are more tabs than ttt !", infottt)
        else:
            print("Error unknow")

os.remove('./ttt/doc_ttt14/data_ttt.json')
os.remove('./ttt/doc_ttt14/data_dose.json')
os.remove('./ttt/doc_ttt14/data_matin.json')
os.remove('./ttt/doc_ttt14/data_midi.json')
os.remove('./ttt/doc_ttt14/data_soir.json')
os.remove('./ttt/doc_ttt14/data_nuit.json')
os.remove('./ttt/doc_ttt14/data_start.json')
os.remove('./ttt/doc_ttt14/data_end.json')
