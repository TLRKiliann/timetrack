...
labelo=Label(fen, text="Stopped for : ", width=15,
...
try:
    if os.path.getsize('./ttt/doc_ttt14/stopped_ttt.txt'):
        importationFile('./ttt/doc_ttt14/stopped_ttt.txt', encodage="Utf-8")
...
try:
    if os.path.getsize('./ttt/doc_ttt14/stopped_res.txt'):
        importationFile2('./ttt/doc_ttt14/stopped_res.txt', encodage="Utf-8")
except FileNotFoundError as no_file4:
    print("+ File stopped_res.txt not found !", no_file4)
