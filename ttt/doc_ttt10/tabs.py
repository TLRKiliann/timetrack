...
with open('./ttt/doc_ttt10/convdose.json') as file:
    data = json.load(file)
...
with open('./ttt/doc_ttt10/data_start.json', 'a+') as datafile:
...
print("--------------")
fileStart = open('./ttt/doc_ttt10/data_start.json')
...
with open('./ttt/doc_ttt10/data_end.json', 'a+') as datafile:
...
print("--------------")
filend = open('./ttt/doc_ttt10/data_end.json')
...
with open('./ttt/doc_ttt10/data_ttt.json', 'a+') as datafile:
...
print("\nListe1 = ttt :")
print("--------------")
fileA = open('./ttt/doc_ttt10/data_ttt.json')
...
with open('./ttt/doc_ttt10/data_dose.json', 'a+') as datafile:
...
print("\nList2 = Dosage :")
print("--------------------")
fileB = open('./ttt/doc_ttt10/data_dose.json')
...
with open('./ttt/doc_ttt10/data_matin.json', 'a+') as datafile:
...
print("\nList3 = Morning :")
print("--------------------")
fileC = open('./ttt/doc_ttt10/data_matin.json')
...
with open('./ttt/doc_ttt10/data_midi.json', 'a+') as datafile:
...
print("\nList4 = Midday :")
print("--------------------")
fileD = open('./ttt/doc_ttt10/data_midi.json')
...
with open('./ttt/doc_ttt10/data_soir.json', 'a+') as datafile:
...
print("\nList5 = Evening :")
print("--------------------")
fileE = open('./ttt/doc_ttt10/data_soir.json')
...
with open('./ttt/doc_ttt10/data_nuit.json', 'a+') as datafile:
...
print("\nList6 = Night :")
print("--------------------")
fileF = open('./ttt/doc_ttt10/data_nuit.json')
...
class app(Frame):
    def __init__(self, master = None):
        ...
        self.labelallergy.grid(row=0, column=0,
            padx=10, pady=5)
...
os.remove('./ttt/doc_ttt10/data_ttt.json')
os.remove('./ttt/doc_ttt10/data_dose.json')
os.remove('./ttt/doc_ttt10/data_matin.json')
os.remove('./ttt/doc_ttt10/data_midi.json')
os.remove('./ttt/doc_ttt10/data_soir.json')
os.remove('./ttt/doc_ttt10/data_nuit.json')
os.remove('./ttt/doc_ttt10/data_start.json')
os.remove('./ttt/doc_ttt10/data_end.json')
