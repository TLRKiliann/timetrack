...
from ttt.msgmed.verifmsg20 import showTreat
from ttt.msgmed.verifmsg20 import showReserve
from ttt.msgmed.verifmsg20 import readTttStory
from ttt.msgmed.verifmsg20 import readResStory
from ttt.msgmed.verifmsg20 import readFileStory
from ttt.msgmed.verifmsg20 import showStopMed

from ttt.copymed.tttmanager20 import copyToTreat
from ttt.copymed.tttmanager20 import toCopyJsonTreat

from ttt.copyres.resmanager20 import copyToReserve
from ttt.copyres.resmanager20 import toCopyJsonRes

from ttt.stopmed.tttstop20 import stopTreatment
from ttt.stopres.resstop20 import stopReserve

from ttt.uploadtreat.t_upload20 import tttupload
from ttt.uploadres.r_upload20 import resupload

from ttt.printview.printmed20 import tttviewnprint
from ttt.printview.printmed20 import resviewnprint
from ttt.printview.printmed20 import ttt_stpview
from ttt.printview.printmed20 import res_stpview


def callTreatment20(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt20/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt20/stopped_res.txt", "w") as creares_file:
