...
from ttt.msgmed.verifmsg13 import showTreat
from ttt.msgmed.verifmsg13 import showReserve
from ttt.msgmed.verifmsg13 import readTttStory
from ttt.msgmed.verifmsg13 import readResStory
from ttt.msgmed.verifmsg13 import readFileStory
from ttt.msgmed.verifmsg13 import showStopMed

from ttt.copymed.tttmanager13 import copyToTreat
from ttt.copymed.tttmanager13 import toCopyJsonTreat

from ttt.copyres.resmanager13 import copyToReserve
from ttt.copyres.resmanager13 import toCopyJsonRes

from ttt.stopmed.tttstop13 import stopTreatment
from ttt.stopres.resstop13 import stopReserve

from ttt.uploadtreat.t_upload13 import tttupload
from ttt.uploadres.r_upload13 import resupload

from ttt.printview.printmed13 import tttviewnprint
from ttt.printview.printmed13 import resviewnprint
from ttt.printview.printmed13 import ttt_stpview
from ttt.printview.printmed13 import res_stpview


def callTreatment13(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt13/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt13/stopped_res.txt", "w") as creares_file:
