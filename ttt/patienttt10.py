...
from ttt.msgmed.verifmsg10 import showTreat
from ttt.msgmed.verifmsg10 import showReserve
from ttt.msgmed.verifmsg10 import readTttStory
from ttt.msgmed.verifmsg10 import readResStory
from ttt.msgmed.verifmsg10 import readFileStory
from ttt.msgmed.verifmsg10 import showStopMed

from ttt.copymed.tttmanager10 import copyToTreat
from ttt.copymed.tttmanager10 import toCopyJsonTreat

from ttt.copyres.resmanager10 import copyToReserve
from ttt.copyres.resmanager10 import toCopyJsonRes

from ttt.stopmed.tttstop10 import stopTreatment
from ttt.stopres.resstop10 import stopReserve

from ttt.uploadtreat.t_upload10 import tttupload
from ttt.uploadres.r_upload10 import resupload

from ttt.printview.printmed10 import tttviewnprint
from ttt.printview.printmed10 import resviewnprint
from ttt.printview.printmed10 import ttt_stpview
from ttt.printview.printmed10 import res_stpview


def callTreatment10(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt10/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt10/stopped_res.txt", "w") as creares_file:
