...
from ttt.msgmed.verifmsg24 import showTreat
from ttt.msgmed.verifmsg24 import showReserve
from ttt.msgmed.verifmsg24 import readTttStory
from ttt.msgmed.verifmsg24 import readResStory
from ttt.msgmed.verifmsg24 import readFileStory
from ttt.msgmed.verifmsg24 import showStopMed

from ttt.copymed.tttmanager24 import copyToTreat
from ttt.copymed.tttmanager24 import toCopyJsonTreat

from ttt.copyres.resmanager24 import copyToReserve
from ttt.copyres.resmanager24 import toCopyJsonRes

from ttt.stopmed.tttstop24 import stopTreatment
from ttt.stopres.resstop24 import stopReserve

from ttt.uploadtreat.t_upload24 import tttupload
from ttt.uploadres.r_upload24 import resupload

from ttt.printview.printmed24 import tttviewnprint
from ttt.printview.printmed24 import resviewnprint
from ttt.printview.printmed24 import ttt_stpview
from ttt.printview.printmed24 import res_stpview


def callTreatment24(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt24/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt24/stopped_res.txt", "w") as creares_file:
