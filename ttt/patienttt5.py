...
from ttt.msgmed.verifmsg5 import showTreat
from ttt.msgmed.verifmsg5 import showReserve
from ttt.msgmed.verifmsg5 import readTttStory
from ttt.msgmed.verifmsg5 import readResStory
from ttt.msgmed.verifmsg5 import readFileStory
from ttt.msgmed.verifmsg5 import showStopMed

from ttt.copymed.tttmanager5 import copyToTreat
from ttt.copymed.tttmanager5 import toCopyJsonTreat

from ttt.copyres.resmanager5 import copyToReserve
from ttt.copyres.resmanager5 import toCopyJsonRes

from ttt.stopmed.tttstop5 import stopTreatment
from ttt.stopres.resstop5 import stopReserve

from ttt.uploadtreat.t_upload5 import tttupload
from ttt.uploadres.r_upload5 import resupload

from ttt.printview.printmed5 import tttviewnprint
from ttt.printview.printmed5 import resviewnprint
from ttt.printview.printmed5 import ttt_stpview
from ttt.printview.printmed5 import res_stpview


def callTreatment5(self):
    """
    ...
    def creatttstop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt5/stopped_ttt.txt", "w") as creattt_file:
    ...
    def createrestop():
        ...
        try:
            ...
            with open("./ttt/doc_ttt5/stopped_res.txt", "w") as creares_file:
