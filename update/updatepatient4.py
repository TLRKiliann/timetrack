...
def diagRecapt(diagnosis):
    try:
        ...
        print("[!] diagrecap4.txt not found !", not_ffile)
        with open('./diag/doc_diag4/diagrecap4.txt', 'w') as filediag:
            filediag.write(diagnosis + '\n')
        tk.messagebox.showwarning("WARNING", "File diagrecap4.txt created !")
