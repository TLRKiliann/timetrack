...
def diagRecapt(diagnosis):
    try:
        ...
        print("[!] diagrecap20.txt not found !", not_ffile)
        with open('./diag/doc_diag20/diagrecap20.txt', 'w') as filediag:
            filediag.write(diagnosis + '\n')
        tk.messagebox.showwarning("WARNING", "File diagrecap20.txt created !")
