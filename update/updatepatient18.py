...
def diagRecapt(diagnosis):
    try:
        ...
        print("[!] diagrecap18.txt not found !", not_ffile)
        with open('./diag/doc_diag18/diagrecap18.txt', 'w') as filediag:
            filediag.write(diagnosis + '\n')
        tk.messagebox.showwarning("WARNING", "File diagrecap18.txt created !")
