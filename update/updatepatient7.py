...
def diagRecapt(diagnosis):
    try:
        ...
        print("[!] diagrecap7.txt not found !", not_ffile)
        with open('./diag/doc_diag7/diagrecap7.txt', 'w') as filediag:
            filediag.write(diagnosis + '\n')
        tk.messagebox.showwarning("WARNING", "File diagrecap7.txt created !")
