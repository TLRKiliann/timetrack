...
def diagRecapt(diagnosis):
    try:
        ...
        print("[!] diagrecap11.txt not found !", not_ffile)
        with open('./diag/doc_diag11/diagrecap11.txt', 'w') as filediag:
            filediag.write(diagnosis + '\n')
        tk.messagebox.showwarning("WARNING", "File diagrecap11.txt created !")
