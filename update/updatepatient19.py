...
try:
    ...
    print("[!] An error occured about pymysql - updatepatient19.py [!]", err_report)
    pass
...
def searchLineName10(firstpat, surname, birthvalue,
    ...
    """
        ...
        entryfile19.txt and display
        tk.messagebox.
    """
    MsgBox = tk.messagebox.askyesno('Save data', 'Do you want to save ?')
    if MsgBox == 1:
        with open('./newpatient/entryfile19.txt', 'w') as fullfile:
        ...
        with open('./allergy/allergyfile19.txt', 'w') as filealler:
...
def funcrecord():
    ...
    if proc.stderr == b'':
        ...
        #tk.messagebox.showinfo("INFO", "entryfile19.txt uploaded...")
    else:
        print("+ No file to upload !")
        tk.messagebox.showerror("Error", "No entryfile19.txt to upload...")
