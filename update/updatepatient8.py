...
def diagRecapt(diagnosis):
    try:
        ...
        print("[!] diagrecap8.txt not found !", not_ffile)
        with open('./diag/doc_diag8/diagrecap8.txt', 'w') as filediag:
            filediag.write(diagnosis + '\n')
        tk.messagebox.showwarning("WARNING", "File diagrecap8.txt created !")
