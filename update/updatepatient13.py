...
def diagRecapt(diagnosis):
    try:
        ...
        print("[!] diagrecap13.txt not found !", not_ffile)
        with open('./diag/doc_diag13/diagrecap13.txt', 'w') as filediag:
            filediag.write(diagnosis + '\n')
        tk.messagebox.showwarning("WARNING", "File diagrecap13.txt created !")
