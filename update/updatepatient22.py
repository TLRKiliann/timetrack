...
def diagRecapt(diagnosis):
    try:
        ...
        print("[!] diagrecap22.txt not found !", not_ffile)
        with open('./diag/doc_diag22/diagrecap22.txt', 'w') as filediag:
            filediag.write(diagnosis + '\n')
        tk.messagebox.showwarning("WARNING", "File diagrecap22.txt created !")
