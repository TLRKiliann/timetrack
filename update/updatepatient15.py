...
def diagRecapt(diagnosis):
    try:
        ...
        print("[!] diagrecap15.txt not found !", not_ffile)
        with open('./diag/doc_diag15/diagrecap15.txt', 'w') as filediag:
            filediag.write(diagnosis + '\n')
        tk.messagebox.showwarning("WARNING", "File diagrecap15.txt created !")
