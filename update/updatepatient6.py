...
def diagRecapt(diagnosis):
    try:
        ...
        print("[!] diagrecap6.txt not found !", not_ffile)
        with open('./diag/doc_diag6/diagrecap6.txt', 'w') as filediag:
            filediag.write(diagnosis + '\n')
        tk.messagebox.showwarning("WARNING", "File diagrecap6.txt created !")
